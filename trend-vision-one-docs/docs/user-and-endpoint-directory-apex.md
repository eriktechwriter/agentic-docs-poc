...
- **Users**: Contains information about any user that logs on an endpoint or that is part of the integrated Active Directory structure
  ...
  For more information, see [User Details](user-details-for-apex.md).
...
For more information, see [Using the Advanced Search](using-the-advanced-search.md) and [Custom Tags and Filters](custom-tags-filters.md).
