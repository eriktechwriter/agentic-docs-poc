...
- [Syslog forwarding](syslog-forwarding.md)
- [Syslog server profiles](syslog-server-profiles.md)
- [Content mapping between log output and CEF syslog type](cef-syslog-type-email-security.md)
