...
The Network Sensor attack simulations require that you prepare a [Deep Discovery Inspector appliance](ddi-connection-deployment.md) or a [Virtual Network Sensor](network-sensor-vmware-esxi.md) and two Windows endpoints. Refer to the **Environmental requirements** instructions provided in the simulation description.
