...
Version 10.2+ of the agent includes event aggregation logic to reduce the volume of logs when the same event occurs repeatedly. (See [Interpret aggregated security events](monitor-application-control-events.md).)
