...
Some Cloud Accounts features have limited support for Google Cloud regions. For more information, see [Google Cloud supported regions and limitations](google-supported-regions.md).
...
The January 2025 update is not available in all regions. To check which version you have, verify if you have access to the Agentless Vulnerability & Threat Detection feature. If not, see [Connect a Google Cloud project](adding-google-cloud-project.md) to connect your project.
