...
4.  [Update your AWS stack](stack-update.md).
...
1.  In the AWS console, search for all stacks deployed by Trend Vision One using the `TrendMicroProduct` tag. For a list of deployed stack resources by feature, see [Trend Vision One AWS services](resources-deployed-cloud-accounts.md).
...
To ensure support for Agentless Vulnerability & Threat Detection after the release of [the latest Cyber Risk Exposure Management pricing packages](credit-req-for-apps-services.md) on April 1, 2025, you should update your stack to the latest version if:
