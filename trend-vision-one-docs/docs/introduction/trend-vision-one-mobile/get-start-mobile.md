...
3.  If you want to receive notifications from Trend Vision One, go to [Receive notifications from the Trend Vision One console](./receive-notifications-console) to configure related settings.
