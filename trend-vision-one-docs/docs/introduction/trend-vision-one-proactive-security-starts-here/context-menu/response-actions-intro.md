...
<td><p>Compresses the selected investigation package, including <a href="https://github.com/fireeye/OpenIOC_1.1">OpenIOC</a> files describing Indicators of Compromise identified on the affected host or network, in a password-protected archive and then sends the archive to Response Management.</p>
