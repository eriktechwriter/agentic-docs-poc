...
For detailed instructions about how to properly register and configure specific products, see [Connect existing products to Product Instance](../../service-management/product-instance/connect-existing-products-to-product-instance) .
