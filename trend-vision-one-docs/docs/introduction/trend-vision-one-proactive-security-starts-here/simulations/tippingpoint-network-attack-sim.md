...
For more details on connecting a TippingPoint SMS to Trend Vision One, see [TippingPoint SMS connection guides](../../../network-security/get-started-with-network-security/tippingpoint-sms-connection-guides).
