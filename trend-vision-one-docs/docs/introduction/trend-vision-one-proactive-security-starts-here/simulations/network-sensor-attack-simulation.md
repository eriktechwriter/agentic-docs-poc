...
The Network Sensor attack simulations require that you prepare a [Deep Discovery Inspector appliance](../../../network-security/get-started-with-network-security/deep-discovery-inspector-connection-guides) or a [Virtual Network Sensor](../../../network-security/get-started-with-network-security/virtual-network-sensor-deployment-guides/deploy-a-virtual-network-sensor-with-vmware-esxi) and two Windows endpoints. Refer to the **Environmental requirements** instructions provided in the simulation description.
