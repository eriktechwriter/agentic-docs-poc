...
1.  Enable Trend Vision One Container Security
    ...
    [Learn how to enable and configure Container Security](../../../cloud-security/container-security/getting-started-with-container-security)

2.  Configure the T1552.001 ruleset

    [Learn more about configuring rulesets in Container Security](../../../cloud-security/container-security/getting-started-with-container-security/runtime-security-ruleset)
