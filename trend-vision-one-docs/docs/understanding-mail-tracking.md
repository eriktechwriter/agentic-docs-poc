...
This screen is designed for you to track email messages that passed through Cloud Email Gateway Protection, including blocked or delivered messages. Cloud Email Gateway Protection maintains up to 180 days of mail tracking logs. The sliding window for mail tracking log search is 60 continuous days that may cross calendar months.
...
- **Type**: The type of email traffic that you want to query.
  ...
  - **Blocked traffic**: The attempts to send messages that were stopped by connection-based filtering at the MTA connection level or by Cloud Email Gateway Protection incoming security filtering.
    ...
    If you select **Blocked traffic** as your search condition, you can further select a block reason. See [Blocked message details](blocked-message-details.md) for details about the block reasons. A summary of email message traffic blocked by Cloud Email Gateway Protection is displayed.
...
- [Social engineering attack log details](sea-log-details.md)
- [Business Email Compromise log details](bec-log-details.md)
- [Antispam engine scan details](antispam-engine-scan-details.md)
