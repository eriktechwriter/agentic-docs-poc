...
2.  If there is no scheduled task of type Check for Component Updates, create one (see [Schedule Server & Workload Protection to perform tasks](schedule-perform-tasks.md)).
