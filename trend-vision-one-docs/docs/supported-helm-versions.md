...
To use the previously set values, use the following option during a Helm upgrade:
...
- [Upgrade Helm chart from Trend Cloud One to Trend Vision One](upgrade-helm-cloud-one.md)
