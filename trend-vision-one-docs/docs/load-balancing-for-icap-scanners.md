...
- [AWS Network Load Balancer (NLB)](expose-icap-service-aws-nlb.md):
...
- [MetalLB](expose-icap-service-metallb.md):
...
- [Expose the ICAP service with AWS NLB](expose-icap-service-aws-nlb.md)
- [Expose ICAP Service with MetalLB](expose-icap-service-metallb.md)
