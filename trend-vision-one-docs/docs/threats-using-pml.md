...
:::note
Predictive Machine Learning is supported with version 11.0+ agents. For details on which platforms support this feature, see [Supported features by platform](supported-features-linux-platform.md).
:::

Use Predictive Machine Learning to detect unknown or low-prevalence malware. (For more information, see [Predictive Machine Learning](anti-malware.md).)
...
As with all detected malware, Predictive Machine Learning logs an event when it detects malware. (See [Events collection in Server & Workload Protection](event-logging.md).) You can also create an exception for any false positives. (See [Create anti-malware exceptions](create-anti-malware-exceptions.md).)

## Enable Predictive Machine Learning {#enable-predictive-machine-learning}

Predictive Machine Learning is configured as part of a real-time scan configuration that is applied to a policy or individual computer. (See [Configure malware scans](configure-malware-scans.md).) After you configure the scan configuration, apply it to a policy or computer.

:::note
Predictive Machine Learning protects only the files and directories that real-time scan is configured to scan. See [Configure malware scan inclusions](configure-malware-scan-inclusions.md) and [Configure malware scan exclusions](configure-malware-scan-exclusions.md).
:::
