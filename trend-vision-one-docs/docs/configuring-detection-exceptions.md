...
7.  Click **Save** to save changes to the detection exceptions list.
    ...
    :::warning[Important]
    For the exceptions to sync to connected Deep Discovery Inspector appliances, make sure you turn on **Enable central management of Deep Discovery Inspector resources** on the **Detection Exceptions** tab. Before you turn on the toggle, review [About central management of Deep Discovery Inspector](central-management-ddi.md) to understand the impacts.
