...
- [Configure custom user roles](custom-user-roles-trend-vision-one.md) with File Security permissions

## Creating an API key {#creating-an-api-key}

The File Security SDK requires a valid API key provided as a parameter to the SDK client object. Trend Vision One API keys are associated with different regions. Refer to [the region flag below](deploying-python-sdk.md) to obtain a better understanding of the valid regions associated with the API key.
...
Find out [how to use the SDK](using-sdk.md).
