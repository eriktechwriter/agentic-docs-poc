...
To learn more about query syntax and regex in custom filters, see [Query syntax](search-syntax.md) and [Use regex in custom filters](using-regex-custom-filters.md).
