...
Access Terminal in host machine and use the following commands to set up the vSwitch before applying the [recommended network settings](kvm-network-settings.md). The steps below use eth1 as an example. You can apply the settings to any network interface you require.
