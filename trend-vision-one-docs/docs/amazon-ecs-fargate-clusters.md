...
- Connect your Amazon ECS cluster that hosts the Fargate container:
  - [Connect Amazon ECS clusters using a new AWS account](ecs-clusters-new-aws-account.md)
  - [Connect Amazon ECS clusters using an existing AWS account](ecs-clusters-existing-account.md)
:::
