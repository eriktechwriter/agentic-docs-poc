...
5.  Click **Settings** to expand the details about the sending domains, sending IPs, and simulation URLs used in Phishing Simulation Assessment.
    ...
    - To set up your allow list in Trend Micro Email Security, see [Setting up a Trend Micro Email Security allow list](setup-email-allow-list.md) .

    - To set up your allow list in Microsoft 365 Defender, see [Setting up a Microsoft 365 Defender allow list](setting-up-365-defender-allow-list.md) .

    - To set up your allow list in Google Workspace, see [Setting up a Google Workspace allow list](set-up-google-workspace-allow-list.md)
