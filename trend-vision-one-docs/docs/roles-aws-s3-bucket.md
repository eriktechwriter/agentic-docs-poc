...
2.  Create a role in the AWS IAM console to allow Trend Vision One to connect to your S3 bucket.
    ...
    6.  Add a `Condition` element to the trust policy, then type `"sts:ExternalId":` and paste the [external ID](connecting-aws-s3-bucket.md) copied from the Trend Vision One console.
