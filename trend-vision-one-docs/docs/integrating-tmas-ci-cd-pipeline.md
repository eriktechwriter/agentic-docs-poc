...
- Add Code Security policies to enforce policy standards, like allowing or blocking pull request merges that meet particular parameters. .
  ...
  [Learn more](code-security-policies.md)
...
- [System requirements](sys-req-artifact-scanner.md)
- [Update to the latest version](updating-artifact-scanner-cli.md)
- [Obtain an API key](obtaining-api-key.md)
- [Download and install TMAS](install-artifact-scanner.md)
- [Add the CLI to your PATH](adding-cli-your-path.md)
