...
:::warning[Important]
The Remove from Zscaler Restricted User Group response action becomes available after you have configured [Zscaler Internet Access integration](Zscaler-internet-access.md) or [Zscaler Private Access integration](zscaler-private-access.md) in **Third-Party Integrations**, and after you have added a user account to a ZScaler restricted user group.
