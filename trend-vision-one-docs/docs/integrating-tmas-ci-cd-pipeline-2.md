...
- [System requirements](sys-req-artifact-scanner-2.md)
- [Update to the latest version](updating-artifact-scanner-cli-2.md)
- [Obtain an API key](obtaining-api-key-2.md)
