...
:::warning[Important]
Adding new AWS accounts on the Trend Vision One console is now performed in the Cloud Accounts app. Using the Cloud Accounts app allows access to the latest Cloud Security solutions. To get started, see [Get started with Cloud Accounts](getting-started-cloud-accounts.md).
...
1.  [Install the agent on Amazon EC2 and WorkSpaces](install-agent-amazon-ec2-workspaces.md).

2.  [Activate the agent](activate-agent.md).

3.  [Create policies](create-policies.md).
