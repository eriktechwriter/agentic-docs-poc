...
11. For **Schedule**, use the configuration below for the quickest alert. You can adjust the settings if you prefer. For more information, see[Configure a custom model](configuring-custom-model.md) .
