...
- *Expressions*: Data that has a certain structure.
  ...
  For details, see [Expressions](expressions-ztsa.md).

- *File attributes*: File properties such as file type and file size.

  For details, see [File attributes](file-attributes-ztsa.md).

- *Keyword lists*: A list of special words or phrases.

  For details, see [Keyword lists](keyword-lists.md).
...
- [Expressions](expressions-ztsa.md)
