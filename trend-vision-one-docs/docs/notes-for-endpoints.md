...
For more information, see [Assigning Custom Tags to Users/Endpoints](assign-custom-tags-users-endpt.md) and [Isolating Endpoints](isolate-network-endpoints.md).
