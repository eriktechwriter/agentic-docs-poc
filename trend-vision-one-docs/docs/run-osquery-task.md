...
After [creating a workspace and adding endpoints to the workspace](workspaces.md) in the **Forensics** app, you can collect detailed evidence from potentially compromised endpoints for internal investigations into critical incidents that occurred on your network and may require further attention.
...
4.  Click **Run osquery**.
    ...
    :::note
    You can also perform this response from the [context menu](context-menu.md) in **XDR Data Explorer**, Workbench, and Observed Attack Techniques.
    :::
...
5.  Configure the task.
    ...
    1.  Use the radio buttons either to select an existing SQL query or to input a new query.
        ...
        - Choose **Input a query**: Type a query and click **Validate query**.
          ...
          :::tip
          Use [Companion](companion.md) to generate osquery queries by clicking **Generate osquery Query** (![](/images/companion_icon=ebfb1301-169d-4687-b329-7c6b4e235192.webp)).
          :::
    ...
    4.  In the **Multi-factor authentication (MFA) required** window, paste the verification code and click **Submit**.
        ...
        :::tip
        For response tasks created from the [context menu](context-menu.md) in **XDR Data Explorer**, click the **View details in Forensics** icon (![](/images/export_icon=GUID-88c87c83-f1e1-465e-9d60-9ba4a60f6849.webp)) in the **Response Management** **Task List** to go directly to **Forensics → Query Results**.
        :::
