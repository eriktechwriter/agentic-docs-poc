...
- Enhanced identity management and role-based access control: Configure permissions for users, groups, and identity providers, and define custom asset visibility for users across all Trend Vision One apps and services in one centralized location.
  ...
  - Configure multiple [identity providers](identity-providers.md) to enable IdP-initiated SAML single sign-on (SSO), direct mapping to third-party IdP user groups, and mapping of multiple roles to the same user account.
...
- New centralized security capabilities: Take advantage of new security capabilities for email, cloud, network, mobile, identity, and data in the Trend Vision One platform.
  ...
  - [Endpoint Security](get-start-endpoint-security.md)

  - [Container Security](container-security.md)

  - [File Security](file-security-intro-origin.md)

  - [Email and Collaboration Security](get-start-email-collaboration.md)

  - [Cloud Accounts](cloud-accounts.md)

  - [Identity Security](identity-posture.md)

  - [Data Security Posture](data-posture.md)
