...
change_date: 2025-05-04T00:00:00Z
is_what_new: true
...
- **New features**
  ...
  - Supports installation in restricted environments where direct internet access is blocked and only proxy connections are allowed. For more information, see [Deploy Zero Trust Secure Access Module in restricted environment](secure-access-module-restr-envir.md).
