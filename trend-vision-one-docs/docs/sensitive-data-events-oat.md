...
5.  To investigate a particular result, expand the details and then do any of the following:
    ...
    - To track how the file has been transmitted or shared between endpoints, right-click the file name and select **Check Data Lineage** to view a graph depicting the file's movements. For more information, see [Data Lineage](data-lineage.md).
