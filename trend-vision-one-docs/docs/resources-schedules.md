...
Schedules are a policy resource you can configure to control when [Anti-Malware](policies-anti-malware.md) runs Scheduled Scans. You can add up to 50 schedules.
