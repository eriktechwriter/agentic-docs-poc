...
- Terminating a pod destroys evidence of the suspicious behavior and does not prevent the behavior from happening again. If possible, run the [Isolate Container](isolate-container-task.md) task before deciding to terminate a container.
:::
