...
<p>For more information, see <a href="trend-vision-one-va-config-image-source">Configure Virtual Analyzer Image Source</a>.</p>
...
<p>For more information, see <a href="trend-vision-one-va-config-image-source">Configure Virtual Analyzer Image Source</a>.</p></td>
</tr>
<tr>
...
- [Configure Virtual Analyzer Image Source](va-config-image-source.md "Configure a source SFTP server and add images to use with Virtual Analyzer image plans.")
