...
For more information, see [Suspicious Object Hub and Node Architecture](so-hub-node-arch.md).
:::
...
- [Suspicious Object Hub and Node Architecture](so-hub-node-arch.md)
