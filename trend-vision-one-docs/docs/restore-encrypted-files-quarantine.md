...
- To locate quarantined files, see [View identified malware](view-restore-identified-malware.md).

- To create an exception and restore a file to its original location, see [Restore identified files](restore-identified-files.md).

- To download and decrypt a quarantined file locally, see [Manually restore identified files](manually-restore-identified-files.md).
