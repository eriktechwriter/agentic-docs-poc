...
Define the non-monitored and monitored targets based on the transmission scope configured on the **Channel** tab. For details on how to define non-monitored and monitored targets for **All transmissions**, see [Transmission Scope: All Transmissions](transmission-scope-all.md). For details on how to define non-monitored and monitored targets for **Only transmissions outside the Local Area Network**, see [Transmission Scope: Only Transmissions Outside the Local Area Network](transmission-scope-outside-lan.md).
...
- [Transmission Scope: All Transmissions](transmission-scope-all.md)
- [Transmission Scope: Only Transmissions Outside the Local Area Network](transmission-scope-outside-lan.md)
