...
To start connecting your cloud assets to Cloud Accounts, see [Get started with Cloud Accounts](getting-started-cloud-accounts.md).

To learn about XDR for Cloud, see [About XDR for Cloud](xdr-for-cloud.md).

For information about managing your cloud connections, view the following topics:

- [AWS accounts](aws-accounts.md)

- [Azure subscriptions](azure-subscriptions.md)

- [Google Cloud projects](google-cloud-projects.md)

- [Alibaba Cloud accounts](alibaba-cloud-accounts.md)

**Related information**

- [Get started with Cloud Accounts](getting-started-cloud-accounts.md "Set up the Cloud Accounts app and connect your cloud assets to Trend Vision One.")
...
- [Oracle Cloud Infrastructure (OCI) compartments](oracle-cloud-compartments.md "Manage connections with your Oracle Cloud Infrastructure (OCI) compartments to allow Trend Vision One visibility into your cloud environment.")
- [Cloud Accounts troubleshooting and FAQs](cloud-accounts-troubleshooting-faqs.md)
