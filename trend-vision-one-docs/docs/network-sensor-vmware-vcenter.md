...
- Review the [Virtual Network Sensor system requirements](network-sensor-system-requirements.md) and ensure that you have adequate system resources.

- Add the [Virtual Network Sensor firewall exceptions](firewall-exception-requirements-for.md) to your firewall settings.
:::
...
6.  In the VMware vCenter console, [configure network settings](vsphere-st-switch-promiscuous-rspan.md) to allow the Virtual Network Sensor to monitor data in VMware vCenter.
...
21. To confirm that the Virtual Network Sensor has successfully deployed, open Network Inventory on the Trend Vision One console and view information about your deployed Virtual Network Sensor.
    ...
    :::note
    For information about troubleshooting the Virtual Network Sensor see [Virtual Network Sensor CLI commands](virtual-network-sensor-cli-commands.md).
    :::
...
- [Configure internal network traffic with the VMware vSphere Distributed Switch (promiscuous mode)](vsphere-dist-switch-promiscuous.md "Configure internal network traffic with the VMware vSphere Distributed Switch using promiscuous mode to allow Virtual Network Sensor to monitor data.")
- [Configure internal network traffic with the VMware vSphere Distributed Switch (SPAN)](vsphere-distributed-switch-span.md "Configure internal network traffic with the VMware vSphere Distributed Switch using SPAN to allow Virtual Network Sensor to monitor data.")
- [Configure internal network traffic with the VMware vSphere Standard Switch (promiscuous mode)](intertraffic-vsphere-promiscuous.md "Configure internal network traffic with the VMware vSphere Standard Switch in promiscuous mode to allow Virtual Network Sensor to monitor data.")
- [Configure external network traffic with the VMware vSphere Standard Switch (promiscuous mode/RSPAN)](vsphere-st-switch-promiscuous-rspan.md "Configure network settings in VMware vCenter to allow Virtual Network Sensor to monitor data.")
- [Configure external network traffic with the VMware vSphere Distributed Switch (RSPAN)](external-vsphere-switch-rspan.md "Configure external network traffic with the VMware vSphere Distributed Switch using RSPAN to allow Virtual Network Sensor to monitor data.")
- [Configure external network traffic with the VMware vSphere Distributed Switch (SPAN)](external-vsphere-dist-switch-span.md "Configure external network traffic with the VMware vSphere Distributed Switch using SPAN to allow Virtual Network Sensor to monitor data.")
- [Configure external network traffic with PCI passthrough (SPAN/RSPAN)](external-pci-passthrough-rspan.md "Configure external network traffic with a PCI passthrough using SPAN or RSPAN to allow Virtual Network Sensor to monitor data.")
- [Configure external inter-VM traffic with ERSPAN](external-inter-erspan.md "Configure network settings in VMware vCenter to allow Virtual Network Sensor to monitor data.")
- [Configure external inter-VM traffic with the VMware vSphere Distributed Switch (RSPAN)](vm-vsphere-switch-rspan.md "Configure network settings in VMware vCenter to allow Virtual Network Sensor to monitor data.")
