...
You can use predefined and customized keyword lists. For details, see [Predefined Keyword Lists](predefined-keyword-lists.md) and [Custom keyword lists](custom-keyword-lists.md).

**Related information**

- [Predefined Keyword Lists](predefined-keyword-lists.md)
- [How keyword lists work](how-keyword-lists-work-2.md)
- [Custom keyword lists](custom-keyword-lists-2.md)
