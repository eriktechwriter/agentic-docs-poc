...
Using a registry as an artifact source does not require a container runtime. In addition, scan results from registry artifact sources can be used for policy evaluations in [Container Security](container-security.md) and [Code Security](code-security-intro.md).
...
Learn more about [Code Security policies](code-security-policies.md)
