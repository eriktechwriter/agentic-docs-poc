...
6.  Ensure [Private Access](setup-ztsa-private-access.md) and [Internet Access](setup-ztsa-internet-access.md) services are provisioned and configured in **Zero Trust Secure Access**.
