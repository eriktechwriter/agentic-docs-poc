...
If you have lost communication with the computer, a diagnostics package can be created locally. For more information, see [Create a diagnostic package](create-diagnostic-package-logs.md).

### System Events tab {#system-events-tab}

For information about events, see [System events](system-events.md).
