...
To ensure that only authorized applications can gain access to your Trend Vision One data, you must create a user account specifically configured to allow API usage. For more information, see [Configure accounts](configure-vision-accounts.md).
