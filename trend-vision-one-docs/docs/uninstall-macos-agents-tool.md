...
7.  Run `V1ESUninstallTool.app` with the command `sudo V1ESUninstallTool.app/Contents/MacOS/V1ESUninstallTool --[parameter]`.
    ...
    <td><p>Only uninstalls the Server &amp; Workload Protection features</p></td>
    </tr>
    <tr>
