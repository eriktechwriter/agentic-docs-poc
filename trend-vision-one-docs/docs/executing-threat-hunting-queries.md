...
:::warning[Important]
- For some threat hunting queries you must have **Threat Insights** entitlement. To view threat hunting queries enhanced with threat intelligence curated by Trend Micro experts, allocate credits to [Threat Insights](threat-insights.md). Contact your sales representative for more information or to purchase additional credits.

- Threat hunting queries powered by [Cyborg Security](cyborg-security-hunter-integration.md) allow you to access related threat intelligence information on the Cyborg Security - HUNTER platform and send threat hunting queries directly to **XDR Data Explorer**.
:::
