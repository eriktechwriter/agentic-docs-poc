...
4.  Select an existing Private Access Connector group, or [create a new group](private-access-connector-config.md).
...
6.  Configure user access through the Secure Access Module.
    ...
    :::tip
    Some HTTP/HTTPS web apps require that you configure access to other internal apps to function. To find associated apps, install the [Trend Micro Web App Discovery Chrome extension](web-app-discovery-chrome.md).
    :::
