...
1.  Prepare a [VMware ESXi](sg-virtual-app-vmware-esxi.md) or [Microsoft Hyper-V](deploy-virtual-appliance-ms-hyper-v.md) Service Gateway appliance that connects to your on-premises OpenLDAP server.

2.  Go to **Zero Trust Secure Access → Secure Access Configuration → Identity and Access Management**.

3.  Connect your OpenLDAP server to Trend Vision One by [configuring OpenLDAP integration](openldap-integration.md).
