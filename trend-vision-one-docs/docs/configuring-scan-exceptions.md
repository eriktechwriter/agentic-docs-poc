...
If any other scan exception is triggered, Cloud Email Gateway Protection takes the specified actions and will not stop scanning until encountering a terminal scan action. For details about terminal actions, see [intercept actions](actions.md).
:::

**Related information**

- [Scan exception list](scan-exception-list.md)
- [Configuring "scan exceptions" actions](configuring-scan-exceptions-actions.md)
