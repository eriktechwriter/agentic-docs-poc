...
- To configure intrusion prevention settings including deploying virtual patches, see [Intrusion Prevention Configuration](intrusion-prevention-configuration.md).
