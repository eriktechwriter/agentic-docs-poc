...
For information on the rules, exceptions, and XDR enablement resources that you can apply to your cluster managed policy, see [Custom resources for cluster-managed policies](custom-resources-cluster-manag.md).
...
- **ruleID**: The Trend Micro runtime ruleID as `TM-{8 digit id}` (example: TM-00000001). [View the list of available, predefined rules](predefined-rules.md).
