...
:::note
For Server & Workload Protection agents, Trend Micro recommends that you configure a [default policy](create-policies.md) and use the [agent-initiated activation](agent-initiated-activation.md) feature before deploying agent packages to simplify the connection process.

For Standard Endpoint Protection agents and Endpoint Sensor only agents, you can set up the [agent for VDI environments](create-golden-agent-image.md) if your network includes virtual desktops.
