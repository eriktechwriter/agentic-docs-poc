...
For details, see [Predefined Expressions](predefined-express.md) and [Customized Expressions](customized-expressions-email.md).

**Related information**

- [Predefined Expressions](predefined-express.md)
- [Customized Expressions](customized-expressions-email.md)
