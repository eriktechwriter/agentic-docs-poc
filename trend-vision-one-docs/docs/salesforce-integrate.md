...
The **Salesforce** screen (**Workflow and Automation → Third-Party Integrations**) provides an overview of all your connected Salesforce tenants and the data that each tenant shares with Trend Vision One.
...
<li><p>Carry out requests at any time (refresh_token, offline_access)</p></li>
</ul></td>
<td><ul>
...
For more information on granting permissions and connecting tenants, see [Configure Salesforce tenants](salesforce-tennants.md).

**Related information**

- [Configure Salesforce tenants](salesforce-tennants.md "Connect Salesforce tenants to share Salesforce metadata and information on system misconfigurations with Trend Vision One.")
