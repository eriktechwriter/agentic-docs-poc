...
- `SystemSettings`: Defines properties for all of the available system settings. The properties are named after the system setting with which they correspond. For a list of system settings, see [System Settings](settings-reference.md) in the Settings Reference.
...
- To retrieve a setting or to reset it to the default value, create a `SystemSettingsApi` class and use the `describeSystemSetting` or `resetSystemSetting` method or function. Include the setting name as an argument. (See [System Settings](settings-reference.md) for a list of settings.)
...
Also see the [Modify a System Setting](https://automation.trendmicro.com/cloudone/workload-security/) operation in the API Reference.
...
Also see the [Modify System Settings](https://automation.trendmicro.com/cloudone/workload-security/) operation in the API Reference. For information about authenticating API calls, see \[Authenticate with Server & Workload Protection\].(../api-send-request/#authenticate)
