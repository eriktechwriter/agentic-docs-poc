...
<li><p><strong>Start Sweeping (STIX-Shifter)</strong>: Click to trigger a Manual Sweeping task to search other data sources you have configured in <strong>Third-Party Integrations</strong> for threat indicators using STIX-Shifter.</p>
<p>For more information about STIX-Shifter connection settings, see <a href="trend-vision-one-third-party-integration">Third-Party Integrations</a>.</p></li>
</ul></td>
</tr>
<tr>
