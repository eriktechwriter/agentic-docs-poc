...
For more information about API setup, see [Set up the API for the Trend Threat Intelligence Feed](./api-for-threat-intelligence-feed).
...
- [Set up the API for the Trend Threat Intelligence Feed](./api-for-threat-intelligence-feed "Integrate the Trend Threat Intelligence Feed into your security environment using the application programming interface (API) to receive the latest, continuously updated threat intelligence.")
- [Configure MISP for the Trend Threat Intelligence feed](./configure-misp-for-the-trend-threat-intelligence-feed/misp-threat-intel-feed)
- [Configure TAXII for the Trend Threat Intelligence feed](./configure-taxii-TIfeed)
- [Add the Trend Threat Intelligence feed in OpenCTI using TAXII2 connectors](./TIfeed-opencti-taxii2)
