...
- [Adding or importing suspicious objects](./add-import-suspicious-objects "You can directly add suspicious objects or import suspicious objects contained in CSV, OpenIOC, and STIX files to the Suspicious Object List.")
- [Suspicious object actions](./suspicious-object-actions "You can specify actions for connected products to take after detecting specific suspicious objects.")
