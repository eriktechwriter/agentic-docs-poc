...
- [Consolidated analysis results](./consolidated-analysis-results "Sandbox Analysis consolidates analysis results from other Trend Micro products.")
- [Submitting objects for analysis](./submitting-objects-for-analysis "Submit files and URLs to the sandbox and view the analysis results in Trend Vision One.")
- [Submission settings](./submission-settings "Configure the settings that affect all submissions to the sandbox.")
- [Supported file types](./supported-file-types "Verify if the sandbox supports the file type you want to submit.")
- [Possible reasons for analysis failure](./reasons-for-analysis-failure "Understand the possible reasons why the sandbox may not be able to analyze an object.")
