...
3.  Select the object type.
    ...
    - **File**
      ...
      1.  Click **Select** and locate a file for submission.
          ...
          :::warning[Important]
          - The sandbox only analyzes [supported file types](./supported-file-types).
...
4.  Click **Submit Object**.
    ...
    :::note
    The sandbox may not be able to analyze an object for [various reasons](./reasons-for-analysis-failure).
    :::
