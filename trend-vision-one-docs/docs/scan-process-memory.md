...
Monitor process memory in real time and perform additional checks with the Trend Micro Smart Protection network to determine whether a suspicious process is known to be malicious. If the process is malicious, Server & Workload Protection terminates the process. For more information, see [Smart Protection in Server & Workload Protection](smart-protection.md)
