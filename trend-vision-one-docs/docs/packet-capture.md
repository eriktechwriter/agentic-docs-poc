...
To enable and configure your packet capture rules, see [Configure Packet Capture](configuring-packet-capture.md).

**Related information**

- [Configure Packet Capture](configuring-packet-capture.md "Enable and configure packet capture rules.")
