...
:::note
For Standard Endpoint Protection agents, you can set up the [agent for VDI environments](create-golden-agent-image.md) if your network includes virtual desktops.
:::
