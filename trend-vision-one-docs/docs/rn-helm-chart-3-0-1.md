...
change_date: 2025-06-13T00:00:00Z
is_what_new: true
slug: trend-vision-one-rn-helm-chart-3-0-1
title: Helm Chart 3.0.1
---

June 13, 2025—The 3.0.1 Helm Chart release includes a minor update to your Helm value overrides and firewall settings required when upgrading from `cloudone-container-security-helm`. See [Upgrade Helm chart from Trend Cloud One to Trend Vision One](upgrade-helm-cloud-one.md) for more information.
