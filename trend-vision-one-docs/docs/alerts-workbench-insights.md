...
<ol>
<li><p>On the <strong>Related events</strong> panel, select a hostname to view the events when multiple hosts are available.</p>
...
<li><p>On the <strong>Observed Attack Techniques</strong> or <strong>Activities</strong> tab, click <img src="./images/add_event_to_insight=20250818030125.webp" /> to add an event to the current insight.</p></li>
<li><p>On the <strong>Add Event to Workbench Insight</strong> panel, confirm the information and click <strong>Add</strong>.</p></li>
</ol></td>
</tr>
</tbody>
</table>
