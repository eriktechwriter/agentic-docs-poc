...
1.  In the Computer or Policy editor, go to **Firewall → General**.
    ...
    :::note
    For information on enabling Firewall for containers, see [Apply your firewall settings](manage-container-protection.md).
    :::
...
- *Frame type:* IP
- *Protocol:* TCP
- *Packet Destination Port:* [Agent's listening port for heartbeats](swp-port-numbers.md)
...
For more information on how to create a Firewall rule, see [Create a Firewall rule](create-firewall-rule.md).
...
For information on how to handle reconnaissance warnings, see [Warning: Reconnaissance Detected](warning-reconnaissance-detected.md).
