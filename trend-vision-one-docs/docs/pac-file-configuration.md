...
To find out about other traffic forwarding options, see [Traffic forwarding options for Internet Access and AI Service Access](traffic-forwarding-internet-access.md).
...
6.  (Optional) Add additional proxy FQDNs to your PAC file.
    ...
    1.  Obtain the FQDNs or IP addresses of the proxy servers you want to include in your PAC file.
        ...
        - Internet Access Cloud Gateway proxy
          ...
          :::tip
          To see a list of the available cloud Internet Access Gateway proxy servers, go to [Port and FQDN/IP address requirements](port-fqdn-ip-address-requirements.md) and select your region.
          :::
...
8.  (Optional) Apply the modified PAC file to the target devices with the Secure Access Module deployed.
    ...
    You can also replace the PAC file in the Secure Access Module by individual endpoint or endpoint group in the **Secure Access Module** screen. For more information, see [PAC File replacement](pac-file-replacement.md).
...
- [Common PAC file configuration errors](pac-file-configuration-tips.md)
