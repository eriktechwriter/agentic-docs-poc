...
- [CEF detection logs](cef-detection-logs.md)
- [CEF audit logs](cef-audit-logs.md)
- [CEF mail tracking logs (accepted traffic)](cef-mail-tracking-traffic.md)
- [CEF URL click tracking logs](cef-url-click-tracking-logs.md)
