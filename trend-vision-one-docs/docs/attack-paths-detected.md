...
To learn more, see [Attack path components](attack-path-components.md).
...
:::note
If no attack paths are identified in your environment, one or more of the required components have not been detected. To learn more, see [Attack path components](attack-path-components.md).
:::
