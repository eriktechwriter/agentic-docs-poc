...
The exact scan time depends on the [AWS concurrency settings](https://docs.aws.amazon.com/lambda/latest/dg/configuration-concurrency.md) of the Lambda functions, and well as how many other Lambdas you have running at the same time in your AWS account.
