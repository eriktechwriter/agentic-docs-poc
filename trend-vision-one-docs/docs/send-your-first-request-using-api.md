...
- An SDK client library, if you choose to use one. Go to the [Python SDK page](python-sdk.md) to download the client library and learn how to add it to your development environment.
...
- For information on how to create an API key for legacy accounts, see [Create and Manage API Keys](api-keys-server-workload.md).
...
- [Run the code examples](run-code-examples.md)
- [Notes about resource property values](notes-resource-property-values.md)
- [About the overrides parameter](overrides-parameter.md)
- [Search for resources](search-for-resources.md)
