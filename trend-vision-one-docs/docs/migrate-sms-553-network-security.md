...
If you have not yet connected a TippingPoint SMS to Trend Vision One, migrate your TippingPoint SMS to the latest version and [connect directly over the internet](connect-sms-61-network-security.md) or [through a Service Gateway 2.0 appliance](sms-610-network-gateway.md).
:::
...
3.  If you do not have a Service Gateway available for connecting your TippingPoint SMS to Trend Vision One, you must install a Service Gateway appliance .
    ...
    5.  Install the Service Gateway virtual appliance.
        ...
        - [Deploy a Service Gateway virtual appliance with VMware ESXi](service-gateway-vmware-esxi.md)

        - [Deploy a Service Gateway virtual appliance with Microsoft Hyper-V](sg-appliances-hyper-v.md)

        For a complete list of Service Gateway system requirements, see [Service Gateway appliance system requirements](sys-sg-requirements.md).
...
6.  Configure a TippingPoint SMS connector in Trend Vision One.
    ...
    - For customers that have updated to the [Foundation Services release](update-foundation-services-release.md), go to **Service Management → Product Instance**.
...
8.  Verify the connection status.
    ...
    1.  In the Trend Vision One console:
        ...
        - For customers that have updated to the [Foundation Services release](update-foundation-services-release.md), go to **Point Product Connection → Product Instance**.
