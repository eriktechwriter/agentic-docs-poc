...
Follow the instructions in the [OpenShift documentation](https://docs.openshift.com/container-platform/4.13/post_installation_configuration/machine-configuration-tasks.md) to create a `kubeletconfig` custom resource and set the `streamingConnectionIdleTimeout` to the desired value. Do not set the value to 0.
