...
4.  In the **Filters** section, choose a Trend Vision One solution or feature to view a cost breakdown for.
    ...
    3.  For **Usage type**, search for and select the billing dimension of a specific offering.
        ...
        :::tip
        To see the AWS usage type for each supported Trend Vision One pay-as-you-go offering, see [AWS usage type and cost allocation tags for Trend Vision One solutions](aws-usage-type-cost-tag-ref.md).
        :::
...
6.  Under **Tag**, search for and select the tag for a specific offering.
    ...
    :::tip
    To see the AWS-generated cost allocation tag for each supported Trend Vision One pay-as-you-go offering, see [AWS usage type and cost allocation tags for Trend Vision One solutions](aws-usage-type-cost-tag-ref.md).
    :::
...
- [AWS usage type and cost allocation tags for Trend Vision One solutions](aws-usage-type-cost-tag-ref.md "View the billing dimension and AWS-generated cost allocation tag for each supported Trend Vision One pay-as-you-go offering.")
