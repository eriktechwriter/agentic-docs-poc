...
1.  Deploy a new Service Gateway 2.0 appliance to replace your existing 1.0 appliance.
    ...
    3.  Deploy the appliance.
        ...
        - [Deploy a Service Gateway virtual appliance with VMware ESXi](sg-virtual-app-vmware-esxi.md)

        - [Deploy a Service Gateway virtual appliance with Microsoft Hyper-V](deploy-virtual-appliance-ms-hyper-v.md)

        - [Deploy a Service Gateway virtual appliance with Microsoft Azure](service-gateway-azure.md)

        - [Deploy a Service Gateway virtual appliance with AWS](deploy-service-gateway-aws.md)
