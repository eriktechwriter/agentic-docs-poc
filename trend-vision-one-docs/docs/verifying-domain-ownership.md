...
You may complete the domain verification process by going to **Administration → Domain Verification**. To learn more, see [Adding and managing domains](adding-managing-domains.md).
