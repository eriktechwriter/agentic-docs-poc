...
This task can be triggered manually using the context menu in **Attack Surface Discovery** or automatically by [creating Automated High-Risk Account Response playbooks](auto-high-risk-account-response.md).
...
:::warning[Important]
The response action is available only after you have configured [Zscaler Internet Access integration](Zscaler-internet-access.md) or [Zscaler Private Access integration](zscaler-private-access.md) in **Third-Party Integrations**.
:::
