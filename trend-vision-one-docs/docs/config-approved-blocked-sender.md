...
- **Approved Senders**
  ...
  Cloud Email Gateway Protection performs connection filtering, spam filtering, and Correlated Intelligence checks on emails from approved senders according to what you specify on the [Sender Filter Settings](sender-filter-settings.md) tab.
...
- [Adding senders](adding-senders-email-security.md)
- [Deleting senders](deleting-senders.md)
- [Importing senders](importing-senders.md)
- [Exporting senders](exporting-senders.md)
