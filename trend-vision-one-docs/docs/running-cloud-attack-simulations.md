...
1.  Enable Trend Vision One Container Security
    ...
    [Learn how to enable and configure Container Security](get-started-container-security.md)

2.  Configure the T1552.001 ruleset

    [Learn more about configuring rulesets in Container Security](runtime-security-ruleset.md)
