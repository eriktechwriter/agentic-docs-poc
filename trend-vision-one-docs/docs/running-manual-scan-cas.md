...
For details, see [Manual scan](real-time-demand-scanning.md).
...
1.  Add at least one Advanced Threat Protection or Data Loss Prevention policy.
    ...
    For details, see [Adding advanced threat protection policies](adding-atp-policies.md) and [Adding Data Loss Prevention policies](adding-dlp-policies.md).
