...
8.  Configure the **Sensor Settings** for the selected priority rule.
    ...
    The first time you enable endpoint sensor detection and response, your currently deployed Trend Vision One Endpoint Security Agents install the new Network Content Inspection Engine. For more information, see [Network Content Inspection Engine for Endpoint Sensor](network-content-inspection-engine.md).
