...
2.  Add an account for the third-party auditor.
    ...
    3.  Select an **Account type**.
        ...
        :::note
        - You must configure Single Sign-on to select "SAML account" as an account type. For more information, see [Configure accounts](../user-accounts/configure-accounts).
