...
- [Obtaining API keys for third-party apps](./api-keys-third-party-apps "API keys allow third-party applications to access your Trend Vision One environment through authorized accounts.")
- [Obtaining API keys for third-party auditors](./obtain-api-keys-third-party "Authentication tokens (API keys) allow third parties to audit your Trend Vision One environment through authorized accounts.")
