...
- [Configuring SAML Assertion Encryption in Okta](./saml-assertion-encryption-okta "Configure assertion encryption to secure data transferred between Okta and Trend Vision One.")
