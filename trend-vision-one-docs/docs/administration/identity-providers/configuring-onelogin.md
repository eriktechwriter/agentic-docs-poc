...
5.  Add OneLogin as an IdP in the Trend Vision One **Identity Providers** app.
    ...
    5.  Click **Save**.
        ...
        [Added SAML users](../user-accounts/configure-accounts/adding-saml-account) receive an account verification email from Trend Vision One. After clicking **Verify Email** in the email, users can sign in to Trend Vision One using their OneLogin credentials.
