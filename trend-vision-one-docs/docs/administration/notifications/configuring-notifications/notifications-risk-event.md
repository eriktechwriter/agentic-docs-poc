...
5.  In **Risk Event Watchlist**, select the risk events for which you want to receive notifications about related instances in your environment and click **Apply**.
    ...
    To receive notifications on risk event instances associated with XDR detection, configure notifications for [new Workbench alert](./notifications-workbench-alerts).
    :::
