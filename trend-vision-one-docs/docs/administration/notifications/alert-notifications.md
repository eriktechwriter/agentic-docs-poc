...
<tr>
<td><p>Unhealthy cluster status</p></td>
<td><p>Container Security</p></td>
<td>Sends an alert when there is an unhealthy Kubernetes cluster. Alert settings can be configured for recipient groups or tags.</td>
</tr>
</tbody>
</table>
