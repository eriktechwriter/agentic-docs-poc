...
6.  On the **Data and app assets** tab, select an [asset visibility scope](../../service-management/asset-visibility-management) or create a new scope for each Trend Vision One app.
