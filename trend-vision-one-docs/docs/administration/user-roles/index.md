...
:::note
You cannot edit or delete [predefined roles](./predefined-roles-trend-vision-one).
:::
...
- [Configure custom user roles](./custom-user-roles-trend-vision-one "Add or edit a custom user role to grant custom app permissions and scope to Trend Vision One user accounts.")
- [Predefined roles](./predefined-roles-trend-vision-one "View the built-in permissions for predefined roles and the Trend Vision One user accounts the role has been assigned to.")
