...
The default period for these apps is 30 days of data retention for **XDR Data Explorer** and [Observed Attack Techniques](../../agentic-siem-xdr/observed-attack-techniques). You can extend the retention period to 90 days, 180 days, or one year with the purchase of the applicable license.
...
- [Mobile Security](../../mobile-security) including detection and activity logs: 180 days

- [Email and Collaboration Security](../../email-and-collaboration-security/get-started-with-trend-vision-one-email-and-collaboration-security) including detection and activity logs for both the [Email and Collaboration Sensor](../../email-and-collaboration-security/email-and-collaboration-sensor) and connected point products like [Cloud App Security](https://docs.trendmicro.com/en-us/documentation/article/cloud-app-security-online-help-introduction): 180 days

- [Zero Trust Secure Access](../../zero-trust-secure-access) including detection and activity logs: 180 days

- [Container Security](../../cloud-security/container-security) including detection and activity logs: 30 days
