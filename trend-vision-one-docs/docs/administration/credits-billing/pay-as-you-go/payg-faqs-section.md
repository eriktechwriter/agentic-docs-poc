...
For more information on endpoints billed as data centers, see [How does credit allocation work for Server & Workload Protection?](../../../endpoint-security/server-workload-protection/faqs/credit-allocation-swp).
