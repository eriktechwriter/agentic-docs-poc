...
- Choose or [create the network security group and subnets](network-subnets-network-sensor.md) for the Virtual Network Sensor data port and management port.
