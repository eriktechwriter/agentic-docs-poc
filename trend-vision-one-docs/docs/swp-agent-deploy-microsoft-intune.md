...
17. Configure the **Requirements** tab and click **Next**.
    ...
    - **Minimum operating system**: Refer to the [Trend Vision One Endpoint Security agent system requirements](endpoint-agent-system-requirements.md) for your agent and security environment needs.
