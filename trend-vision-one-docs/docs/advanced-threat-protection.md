...
- [Real-time and on-demand scanning](real-time-demand-scanning.md)
- [Actions available for different services](actions-different-services.md)
- [Menu controls for ATP policies](menu-controls-for-atp-policies.md)
- [Internal domains](internal-domains.md)
- [Adding advanced threat protection policies](adding-atp-policies.md)
- [Running a manual scan](running-manual-scan-cas.md)
- [Compressed file handling](compressed-file-handling.md)
