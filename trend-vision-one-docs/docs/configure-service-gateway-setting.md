...
3.  To enable or disable a service, toggle the switch next to the service name.
    ...
    <td><p>For more information on integrating third-party applications, see <a href="trend-vision-one-third-party-integration">Third-Party Integrations</a>.</p></td>
    ...
    <p>For more information, see <a href="trend-vision-one-third-party-integration">Third-Party Integrations</a>.</p></td>
