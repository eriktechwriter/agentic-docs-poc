...
- [Release notes](release-notes-outlook-addin.md)
- [Deploying the add-in for Outlook](deploying-add-for-outlook.md)
- [Configuring the add-in for Outlook](configuring-add-for-outlook.md)
- [Using the add-in for Outlook](using-add-for-outlook.md)
- [Updating the add-in for Outlook](updating-add-for-outlook.md)
- [Removing the add-in for Outlook](removing-add-for-outlook.md)
