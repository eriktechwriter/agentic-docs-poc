...
change_date: 2023-09-27T00:00:00Z
is_what_new: true
...
For details on supported Linux platforms, see [Endpoint Sensor-only system requirements](es-agent-sys-reqs.md) and [Server & Workload Protection system requirements](swp-agent-sys-requirements.md).
