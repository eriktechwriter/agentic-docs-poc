...
You may complete the domain verification process by going to **Administration → Domain Verification**. To learn more, see [Adding and managing domains](../../../administration/domain-verification/adding-managing-domains).
