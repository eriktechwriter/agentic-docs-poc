...
1.  Create the modified resource script terraform file.
    ...
    Copy the [Azure reduced resource connection script](azure-reduced-resource-script.md) and save the code to your local machine as a terraform (.TF) file.

2.  Connect or update one of your Azure subscriptions as normal.

    - To make a new connection, see [Connect an Azure subscription](adding-azure-subscription.md).

    - To update a legacy connection, see [Updating a legacy Azure connection](updating-legacy-azure-connection.md).
...
5.  Select the features and permissions you want to enable. For more information, see [Azure features and permissions](azure-features-permissions.md).
...
- [Azure reduced resource connection script](azure-reduced-resource-script.md)
