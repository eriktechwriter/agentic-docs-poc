...
:::note
For system events related to Application Control, see [System events](system-events.md).
:::
...
- [Error: There are one or more application type conflicts on this computer](error-app-type-conflicts.md)
