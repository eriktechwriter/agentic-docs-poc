...
- [Disabling Syslog Forwarding](disabling-syslog-forwarding.md)

- [Supported Log Types and Formats](supported-log-types-formats.md)
...
5.  Select the log format:
    ...
    For more information, see [Supported Log Types and Formats](supported-log-types-formats.md).
...
9.  Click **Save**.
    ...
    - To monitor the log forwarding status, go to **Administration → Command Tracking** and select **Forward Syslog** from the **Command** drop-down list.
      ...
      For more information, see [Querying and Viewing Commands](querying-viewing-commands.md).

**Related information**

- [Disabling Syslog Forwarding](disabling-syslog-forwarding-2.md)
- [Supported Log Types and Formats](supported-log-types-formats-2.md)
- [Syslog Content Mapping - CEF](syslog-content-mapping-cef-central.md)
