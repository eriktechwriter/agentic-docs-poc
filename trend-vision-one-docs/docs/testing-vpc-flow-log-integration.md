...
Enabling XDR for Cloud - AWS VPC Flow Logs requires allocating credits. For information about estimating credit usage with XDR for Cloud, see [Estimate and monitor XDR for Cloud usage](xdr-for-cloud-usage.md).
:::
...
2.  Review the [VPC Flow Logs recommendations and requirements](vpc-flow-logs-requirements.md).
...
3.  Add your AWS account to Trend Vision One cloud accounts app.
    ...
    :::note
    If you want to test integration with an AWS organization account, see [Connect an AWS Organization](adding-aws-organizations.md).
    :::
...
5.  Use one of the following demo attacks to trigger a Workbench alert.
    ...
    You can also run a [Threat Intelligence sweeping test](threat-intelligence-vpc-sweep-test.md) to generate an alert using demo data.
