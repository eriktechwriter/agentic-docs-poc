...
- [Malware subcommand](artifact-scanner-cli.md)

- [Secrets subcommand](artifact-scanner-cli.md)

- [Proxy configuration](artifact-scanner-cli.md)

### General usage {#general-usage}

For examples of commands using Trend Micro Artifact Scanner (TMAS), see [Examples](tmas-examples.md).
