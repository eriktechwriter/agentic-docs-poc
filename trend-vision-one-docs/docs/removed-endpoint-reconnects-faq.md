...
If you removed an endpoint for the purpose of connecting the endpoint to a different company, you must completely uninstall the agent package before you can install the agent package for the new company. For more information, see [Uninstall the Trend Vision One Endpoint Security agent](uninstalling-agents.md).
