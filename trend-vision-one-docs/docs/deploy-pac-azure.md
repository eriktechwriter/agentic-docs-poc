...
11. (Optional) Scale the VM instances either by [manually choosing a specific instance count](manual-scale.md) or via a [custom autoscale policy](custom-autoscale.md).
