...
4.  Adjust the general settings of the filter to your needs:
    ...
    - **Severity**
      ...
      A severity of medium, high, or critical affects the Cyber Risk Index on the [Cyber Risk Overview](executive-dashboard.md) and [Threat and Exposure Management](operations-dashboard.md). When testing or tuning a model, select low to avoid affecting indexes.
...
:::tip
You can use custom filters to [create detection models](configuring-custom-model.md) that generate Workbench alerts based on your detections.
:::
