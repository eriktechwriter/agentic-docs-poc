...
:::note
For details about intercept actions, see [intercept actions](actions.md).
:::

**Related information**

- [Sender IP match](sender-ip-match.md)
- [Sender policy framework (SPF)](sender-policy-framework-spf.md)
- [Domainkeys identified mail (DKIM)](domainkeys-identified-mail-dkim.md)
- [Domain-based message authentication, reporting & conformance (DMARC)](dmarc.md)
- [How DMARC works with SPF and DKIM](how-dmarc-works-spf-dkim.md)
