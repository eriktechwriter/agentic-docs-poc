...
sidebar_position: 2
title: Configure upstream proxy rules
---
...
:::warning[Important]
- To use the proxy settings of your Service Gateway for user web activity traffic, you must configure a proxy server for your Service Gateway virtual appliance via [Service Gateway CLI commands](../../../../../workflow-and-automation/service-gateway-management/service-gateway-troubleshooting-and-faqs/troubleshoot-service-gateway/service-gateway-cli-commands).
