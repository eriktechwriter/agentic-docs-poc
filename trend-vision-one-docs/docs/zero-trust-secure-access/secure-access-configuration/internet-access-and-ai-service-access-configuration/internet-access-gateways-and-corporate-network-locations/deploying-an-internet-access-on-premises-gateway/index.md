...
3.  Set up an Internet Access On-Premises Gateway by clicking **Go to Service Gateway Inventory**.
    ...
    1.  Select an existing Service Gateway that identifies your corporate location, or [deploy a new Service Gateway virtual appliance](../../../../../workflow-and-automation/service-gateway-management/getting-started-with-service-gateway/deployment-guides) for the Zero Trust Internet Access On-Premises Gateway service.

        :::warning[Important]
        Disable **Cloud Service Extension** on the Service Gateway when using the Internet Access On-Premises Gateway service. The cloud service extension might interfere with normal operations of the on-premises gateway. For more information, see [Configure Service Gateway settings](../../../../../workflow-and-automation/service-gateway-management/service-gateway-appliance-configuration/configure-service-gateway-settings).
        :::

    2.  Install and enable the Zero Trust Internet Access On-Premises Gateway service. For details, see [Manage services in Service Gateway](../../../../../workflow-and-automation/service-gateway-management/service-gateway-appliance-configuration/manage-services-in-service-gateway).
...
:::note
    ...
    <li><p>For details, see <a href="trend-vision-one-configuring-upstream-proxy-rules">Configure upstream proxy rules</a></p></li>
    </ul></li>
    </ul></td>
    </tr>
    <tr>
...
8.  Configure and apply PAC files to forward HTTP/HTTPS traffic to the on-premises gateway.
    ...
    1.  Add the FQDN or IP address of the on-premises gateway [to one or multiple PAC files](../../../../getting-started-with-zero-trust-secure-access/deployment-guides/setting-up-zero-trust-secure-access-internet-access-and-ai-service-access/pac-file-configuration) that you use for proxy settings.

    2.  [Apply the PAC files](../../../../getting-started-with-zero-trust-secure-access/deployment-guides/setting-up-zero-trust-secure-access-internet-access-and-ai-service-access/pac-file-deployment) to deployed Secure Access Modules.

9.  [Configure bandwidth control](./configure-bandwidth-control) to optimize network performance on the on-premises gateway.

**Related information**

- [Configure upstream proxy rules](./configuring-upstream-proxy-rules "Set up rules for user web activity traffic using upstream proxies on your Internet Access On-Premises Gateway.")
- [Configure bandwidth control](./configure-bandwidth-control "Reduce network congestion on your on-premises gateway by configuring bandwidth control.")
- [Configure reverse proxy mode](./configure-reverse-proxy-mode "Configure reverse proxy mode on an Internet Access On-Premises Gateway in order to secure the use of your private general or generative AI applications.")
- [Configure AI proxy for multiple LLMs](./configure-ai-proxy-for-multiple-llms/private-ai-service-llm-integration "AI proxy is a reverse proxy that allows you to use multiple Large Language Model (LLM) services with different API protocols.")
- [Enable FTP proxy on an Internet Access On-premises gateway](./ftp-proxy-internet-premises-gateway)
- [Syslog content mapping - CEF](./syslog-content-mapping-cef-ztsa "Understand the content mapping between Internet Access log output and CEF syslog format.")
