...
3.  Configure an application for discovery.
    ...
    3.  Select an existing Private Access Connector group, or [create a new group](../private-access-connector-configuration).
...
5.  Perform the following actions on the discovery result.
    ...
    <td><p>Click <strong>Add as internal app</strong> and follow the instructions described in <a href="trend-vision-one-add-internal-application-pac">Add an internal application to Private Access</a> to add an internal application.</p></td>
    </tr>
    </tbody>
    </table>
