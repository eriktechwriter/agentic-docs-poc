...
3.  Power on the Private Access Connector virtual machine and configure settings in the Command Line Interface (CLI).
    ...
    7.  To check the network configuration, type the `ifconfig` command.
        ...
        :::note
        The default IP assignment method is DHCP. If your company does not use a DHCP server, use the [Private Access Connector CLI commands](./private-access-connector-cli) to configure your network settings manually.
    ...
    11. Use the [Private Access Connector CLI commands](./private-access-connector-cli) to configure other settings as required.
