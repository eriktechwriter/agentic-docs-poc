...
11. (Optional) Scale the VM instances either by [manually choosing a specific instance count](./manual-scale) or via a [custom autoscale policy](./custom-autoscale).
...
- [Manual Scale](./manual-scale "Manually scale your Private Access Connector VM instances to a fixed instance count.")
- [Custom Autoscale](./custom-autoscale "Scale your Private Access Connector VM instances based on metric thresholds by creating a custom autoscale policy.")
