...
- [Deploy the Private Access connector on Nutanix AHV using ACLI](./deploy-pa-connector-nutanix-acli)
- [Create the VM using REST API (v3)](./create-vm-using-rest-api-v3)
- [Configure the connector with Trend Vision One](./configure-connector-nutanix)
