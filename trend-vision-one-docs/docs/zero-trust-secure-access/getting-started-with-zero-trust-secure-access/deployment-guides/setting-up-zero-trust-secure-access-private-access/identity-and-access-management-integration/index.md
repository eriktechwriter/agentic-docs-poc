...
- [Microsoft Entra ID](./ztsa-integration-sso)

- [Okta](./ztsa-okta-integration-sso)

- [Active Directory (on-premises)](./ad-onprem-ztsa)

- [OpenLDAP](./openldap-integration-sso-ztsa)

- [Google Cloud Identity](./gcp-integrat-sso-ztsa)
...
- [Microsoft Entra ID integration and SSO for Zero Trust Secure Access](./ztsa-integration-sso "Integrate with Microsoft Entra ID to authenticate user access attempts and take action on risky account activity.")
- [Okta integration and SSO for Zero Trust Secure Access](./ztsa-okta-integration-sso "Integrate with Okta to authenticate user access attempts and take action on risky account activity.")
- [Active Directory (on-premises) integration and SSO for Zero Trust Secure Access](./ad-onprem-ztsa "Integrate with Active Directory (on-premises) to authenticate user access attempts and take action on risky account activity.")
- [OpenLDAP integration and SSO for Zero Trust Secure Access](./openldap-integration-sso-ztsa "Integrate with OpenLDAP to authenticate user access attempts and take action on risky account activity.")
- [Google Cloud Identity integration and SSO for Zero Trust Secure Access](./gcp-integrat-sso-ztsa "Integrate with Google Cloud Identity to authenticate user access attempts and take action on risky account activity.")
