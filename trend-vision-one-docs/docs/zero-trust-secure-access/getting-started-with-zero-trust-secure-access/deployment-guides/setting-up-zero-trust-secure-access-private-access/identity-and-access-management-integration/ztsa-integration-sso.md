...
2.  To take direct action on risky accounts and authenticate Private Access and Internet Access rules, grant necessary permissions in the **Third-Party Integrations** app.
...
3.  To configure risk control rules, you must also grant data upload permission for [Configure Microsoft Entra ID](../../../../../administration/identity-providers/configuring-saml-ad) in **Threat and Exposure Management → Data source**.
    ...
    2.  If the required Microsoft Entra ID permissions are not granted yet, click **Manage permissions and integration settings in Third-Party Integration** to open the **Microsoft Entra ID** screen of the **Third-Party Integrations** app.
