...
- [Microsoft Entra ID](./integration-ztsa-sso)

- [Okta](./okta-integration-sso-ztsa)

- [Active Directory (on-premises)](./active-directory-on-premises-integration-and-sso-for-zero-trust-secure-access)

- [OpenLDAP](./openldap-sso-ztsa)

- [Google Cloud Identity](./ztsa-gcp-identity-integrate)
...
- [Microsoft Entra ID integration and SSO for Zero Trust Secure Access](./integration-ztsa-sso "Integrate with Microsoft Entra ID to authenticate user access attempts and take action on risky account activity.")
- [Okta integration and SSO for Zero Trust Secure Access](./okta-integration-sso-ztsa "Integrate with Okta to authenticate user access attempts and take action on risky account activity.")
- [Active Directory On-Premises integration and SSO for Zero Trust Secure Access](./active-directory-on-premises-integration-and-sso-for-zero-trust-secure-access "Integrate with Active Directory (on-premises) to authenticate user access attempts and take action on risky account activity.")
- [OpenLDAP integration and SSO for Zero Trust Secure Access](./openldap-sso-ztsa "Integrate with OpenLDAP to authenticate user access attempts and take action on risky account activity.")
- [Google Cloud Identity integration and SSO for Zero Trust Secure Access](./ztsa-gcp-identity-integrate "Integrate with Google Cloud Identity to authenticate user access attempts and take action on risky account activity.")
