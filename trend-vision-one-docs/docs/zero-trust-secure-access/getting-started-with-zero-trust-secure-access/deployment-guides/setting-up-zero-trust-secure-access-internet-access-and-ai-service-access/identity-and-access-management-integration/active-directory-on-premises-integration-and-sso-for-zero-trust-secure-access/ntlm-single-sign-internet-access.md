...
- [Preparing your environment for NTLM or Kerberos single sign-on](../../../../../secure-access-configuration/internet-access-and-ai-service-access-configuration/global-settings/configuring-ntlm-or-kerberos-single-sign-on-with-active-directory-on-premises/ntlm-kerberos-single-sign)

- [Configuring the authentication proxy service for corporate intranet locations](../../../../../secure-access-configuration/internet-access-and-ai-service-access-configuration/global-settings/configuring-ntlm-or-kerberos-single-sign-on-with-active-directory-on-premises/authentication-proxy-intranet)

- [Configuring the authentication proxy service for corporate intranet locations and public or home networks](../../../../../secure-access-configuration/internet-access-and-ai-service-access-configuration/global-settings/configuring-ntlm-or-kerberos-single-sign-on-with-active-directory-on-premises/authentication-proxy-service)
:::
...
3.  Choose a single on-premises gateway or multiple on-premises gateways behind a load balancer as the authentication proxy to communicate with Active Directory for authentication.
    ...
    - Multiple gateways: To ensure high service availability, users are authenticated through a load balancer to multiple on-premises gateways. You must specify the IP address or FQDN of a configured load balancer. To learn about how to assign and configure the load balancer, see [Configure load balancers to use multiple Internet Access on-premises gateways as the authentication proxy](../../../../../secure-access-configuration/internet-access-and-ai-service-access-configuration/global-settings/configuring-ntlm-or-kerberos-single-sign-on-with-active-directory-on-premises/configure-load-balancers-to-use-multiple-internet-access-on-premises-gateways-as-the-authentication-proxy).
...
6.  If desired, enable Kerberos-based single sign-on and upload the required keytab file.
    ...
    3.  From the command line, run the following command to set the new user as the SPN.
        ...
        :::note
        The `<auth proxy fqdn>` is the FQDN of the Service Gateway which hosts the Internet Access on-premises gateway. The FQDN is created when [configuring the Active Directory server](../../../../../secure-access-configuration/internet-access-and-ai-service-access-configuration/global-settings/configuring-ntlm-or-kerberos-single-sign-on-with-active-directory-on-premises/ntlm-kerberos-single-sign).
        :::
