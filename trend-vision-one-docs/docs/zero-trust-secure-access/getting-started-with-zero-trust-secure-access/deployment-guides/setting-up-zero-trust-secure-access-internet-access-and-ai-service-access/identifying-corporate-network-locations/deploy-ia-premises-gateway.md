...
8.  Configure and apply PAC files to forward HTTP/HTTPS traffic to the on-premises gateway.
    ...
    1.  Add the FQDN or IP address of the on-premises gateway [to one or multiple PAC files](../pac-file-configuration) that you use for proxy settings.

    2.  [Apply the PAC files](../pac-file-deployment) to deployed Secure Access Modules.
