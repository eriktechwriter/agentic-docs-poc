...
- [Azure AD](./integratwe-aad-sso-ztsa)

- [Okta](./integrate-okta-sso-ztsa)

- [Active Directory (on-premises)](./ad-premises-sso-ztsa)

- [OpenLDAP](./openldap-ztsa-sso)
...
- [Integrating Microsoft Entra ID and SSO for Zero Trust Secure Access](./integratwe-aad-sso-ztsa "Integrate with Microsoft Entra ID to authenticate user access attempts and take action on risky account activity.")
- [Integrating Okta and SSO for Zero Trust Secure Access](./integrate-okta-sso-ztsa "Integrate with Okta to authenticate user access attempts and take action on risky account activity.")
- [Integrating Active Directory (On-Premises) and SSO for Zero Trust Secure Access](./ad-premises-sso-ztsa "Integrate with Active Directory (on-premises) to authenticate user access attempts and take action on risky account activity.")
- [Integrating OpenLDAP and SSO for Zero Trust Secure Access](./openldap-ztsa-sso "Integrate with OpenLDAP to authenticate user access attempts and take action on risky account activity.")
