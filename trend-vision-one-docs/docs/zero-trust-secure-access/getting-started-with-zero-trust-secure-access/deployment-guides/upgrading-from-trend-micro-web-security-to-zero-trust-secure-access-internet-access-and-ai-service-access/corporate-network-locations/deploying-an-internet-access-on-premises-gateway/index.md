...
8.  Configure and apply PAC files to forward HTTP/HTTPS traffic to the on-premises gateway.
    ...
    1.  Add the FQDN or IP address of the on-premises gateway [to one or multiple PAC files](../../../setting-up-zero-trust-secure-access-internet-access-and-ai-service-access/pac-file-configuration) that you use for proxy settings.

    2.  [Apply the PAC files](../../../setting-up-zero-trust-secure-access-internet-access-and-ai-service-access/pac-file-deployment) to deployed Secure Access Modules.

9.  [Configure bandwidth control](../../../../../secure-access-configuration/internet-access-and-ai-service-access-configuration/internet-access-gateways-and-corporate-network-locations/deploying-an-internet-access-on-premises-gateway/configure-bandwidth-control) to optimize network performance on the on-premises gateway.

**Related information**

- [Internet Access On-Premises Gateway system sizing recommendations](./ia-gateway-system-sizing-2 "View recommended system sizing information for use when deploying the Internet Access On-Premises Gateway.")
