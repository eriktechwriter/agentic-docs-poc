...
- [Azure AD](./integrating-sso-for-ztsa)

- [Okta](./okta-ztsa-sso)

- [Active Directory (on-premises)](./ad-onprem-sso-ztsa)

- [OpenLDAP](./integrating-openldap-sso-ztsa)
...
- [Integrating Microsoft Entra ID and SSO for Zero Trust Secure Access](./integrating-sso-for-ztsa "Integrate with Microsoft Entra ID to authenticate user access attempts and take action on risky account activity.")
- [Integrating Okta and SSO for Zero Trust Secure Access](./okta-ztsa-sso "Integrate with Okta to authenticate user access attempts and take action on risky account activity.")
- [Integrating Active Directory (On-Premises) and SSO for Zero Trust Secure Access](./ad-onprem-sso-ztsa "Integrate with Active Directory (on-premises) to authenticate user access attempts and take action on risky account activity.")
- [Integrating OpenLDAP and SSO for Zero Trust Secure Access](./integrating-openldap-sso-ztsa "Integrate with OpenLDAP to authenticate user access attempts and take action on risky account activity.")
