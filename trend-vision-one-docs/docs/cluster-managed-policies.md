...
Use cluster-manged policies as part of you policy as code workflow. Cluster-managed policies are defined in their source code as Container Security policy and ruleset custom resources and are read-only to users in the Trend Vision One console after being created.
...
- [Enabling cluster-managed policies](enabling-cluster-managed-policies.md)
- [Custom resources for cluster-managed policies](custom-resources-cluster-manag.md)
