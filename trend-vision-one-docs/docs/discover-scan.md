...
2.  Create a new network discovery scan.
    ...
    4.  Specify up to 10,000 IPv4 addresses, ranges, or FQDNs separated by commas to scan. CIDR notation is supported.
        ...
        - The default scan targets are the top 1,000 most common TCP ports. You can also choose the top 1,000 most common UDP ports, all most common TCP/UDP ports, or all TCP ports. For a list of all top 1,000 TCP ports, [click here](https://ohc.blob.core.windows.net/o-help/manual/7d34d63c-e9ae-4328-81be-0e6081012335/top_1000_TCP_ports.csv). For a list of all top 1,000 UDP ports, [click here](https://ohc.blob.core.windows.net/o-help/manual/7d34d63c-e9ae-4328-81be-0e6081012335/udp_top_1000.csv). Broader scans may take longer.
        :::
