...
Service Gateway Management brings a wealth of improvements and new features designed to make it even easier to manage connected services and products in your security environment compared to the previous [Service Gateway Management (Legacy) version](service-gateway-management-legacy.md).
