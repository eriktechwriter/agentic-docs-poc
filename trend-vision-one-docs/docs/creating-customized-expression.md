...
7.  Choose one of the following criteria and configure additional settings for the chosen criteria (see [Criteria for custom expressions](criteria-for-custom-expressions.md)):
