...
Follow the instructions in [Creating a role for an AWS service](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles_create_for-service.md).
...
Trend Micro recommends configuring a cloud connector for each AWS account which will contain managed agents. It might also be necessary to [create a policy](../../../../../policies/create-policies/create-policies) specific to the systems which will be managed by Distributor.
