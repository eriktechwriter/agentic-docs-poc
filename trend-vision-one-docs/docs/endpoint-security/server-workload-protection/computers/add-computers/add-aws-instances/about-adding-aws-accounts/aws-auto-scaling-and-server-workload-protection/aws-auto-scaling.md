...
- If you include a pre-installed agent, instances will spin up more quickly because there is no need to download and install the agent software. The downside is that the agent software might not be the latest. To work around this issue, you can enable the [upgrade on activation](../../../../../administration/manage-agents-protected-computers/autoupgrade-agents-activation) feature.
...
:::note
For the deployment scripts to work, agent-initiated communication must be enabled in Server & Workload Protection. For details on this setting, see [Activate and protect agents using agent-initiated activation and communication](../../../../../administration/manage-agents-protected-computers/activate-and-protect-agents-using-agent-initiated-activation-and-communication/agent-initiated-activation)
:::
...
- Agent-initiated communication must be enabled in Server & Workload Protection. For details on this setting, see [Activate and protect agents using agent-initiated activation and communication](../../../../../administration/manage-agents-protected-computers/activate-and-protect-agents-using-agent-initiated-activation-and-communication/agent-initiated-activation).
