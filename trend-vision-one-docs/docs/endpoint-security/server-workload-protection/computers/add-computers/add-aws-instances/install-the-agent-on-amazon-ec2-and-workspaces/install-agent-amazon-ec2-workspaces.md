...
To update your AWS accounts, see [Update a legacy AWS connection](../../../../../../cloud-security/cloud-accounts/aws-accounts/connect-and-update-aws-accounts/updating-legacy-aws-connection).
...
- launch new Amazon EC2 instances and Amazon WorkSpaces with the agent 'baked in', see [Bake the agent into your AMI or WorkSpace bundle](../install-the-agent-on-an-ami-or-workspace-bundle/install-agent-ami-workspace).
- protect Amazon WorkSpaces after already protecting your Amazon EC2 instances, see instead [Protect Amazon WorkSpaces if you already added your AWS account](../add-amazon-workspaces/add-amazon-workspaces).
...
:::warning[Important]
AWS Accounts in Trend Vision One are now managed by the Cloud Accounts app. To add new AWS accounts, see [Connect an AWS account using CloudFormation](../../../../../../cloud-security/cloud-accounts/aws-accounts/connect-and-update-aws-accounts/adding-aws-account). You can still add accounts to Server & Workload Protection using the API functions. However, Trend Micro recommends using the Cloud Accounts app, which provides access to more advanced cloud security and XDR capabilities.
:::
...
6.  If you selected *Allow Agent-Initiated Activation*, also select *Reactivate cloned Agents*, and *Enable Reactivate unknown Agents*. See [Agent settings](../../../../administration/manage-agents-protected-computers/agent-settings) for more information.
...
- *Option 1: Use a deployment script to install, activate, and assign a policy*
  ...
  With this option, you must run a deployment script on the Amazon EC2 instances or Amazon WorkSpaces. The script installs and activates the agent and then assigns a policy. See [Use deployment scripts to add and protect computers](../../../../administration/automate/automate-using-the-console/use-deployment-scripts-to-add-and-protect-computers/deployment-scripts-add-computers) for details.
...
- *Option 2: Manually install and activate*
  ...
  a\. Get the agent software, copy it to the Amazon EC2 instance or Amazon WorkSpace, and then install it. For details, see [Get the agent software](../../../../administration/manage-agents-protected-computers/get-agent-software), and [Manually install the agent](../../../../administration/manage-agents-protected-computers/install-the-agent).

  b\. Activate the agent. You can do so on the agent (if agent-initiated activation was enabled) or in Server & Workload Protection. For details, see [Activate the agent.](../../../../administration/manage-agents-protected-computers/activate-the-agent/activate-agent)
...
To assign a policy, see [Assign a policy to a computer](../../../../policies/create-policies/create-policies).
