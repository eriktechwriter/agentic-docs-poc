...
[Update your legacy connections](../../../../../cloud-security/cloud-accounts/aws-accounts/connect-and-update-aws-accounts/updating-legacy-aws-connection) in Cloud Accounts to enable advanced Trend Vision One Cloud Security features and capabilities.

Modifying and removing AWS accounts are now handled by the Cloud Accounts app.

- To modify your AWS account, update the account in the Cloud Accounts app first. Afterwards, open [Cloud Account Settings](../../../../../cloud-security/cloud-accounts/aws-accounts/aws-account-settings) to make changes as needed..

- To remove an AWS account, go to **Service Management → Cloud Accounts → AWS**. Select the accounts to remove, and click **Remove**. For more information, see [AWS accounts](../../../../../cloud-security/cloud-accounts/aws-accounts).
