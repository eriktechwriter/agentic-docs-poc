...
:::warning[Important]
To deploy the Server & Workload Protection agent with endpoint sensor with full XDR functionality, download and deploy the agent package from Endpoint Inventory. For more information, see [Deploy agents](../../../../getting-started-with-trend-vision-one-endpoint-security/manage-your-agent-deployments/deploy-agents).
...
[Agent-initiated activation](../../../administration/manage-agents-protected-computers/activate-and-protect-agents-using-agent-initiated-activation-and-communication/agent-initiated-activation) is recommended and enabled by default. When agent-initiated activation is enabled, computers are added automatically.

## Manually add a computer {#manually-add-a-computer}

If you have [bidirectional or manager-initiated activation](../../../administration/manage-agents-protected-computers/communication-between-server-workload-protection-and-the-agent/communication-agent) configured, you can manually add an individual computer by specifying its IP address or hostname.
