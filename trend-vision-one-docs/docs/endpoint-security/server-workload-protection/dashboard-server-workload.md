...
For more information on tagging see [Apply tags to identify and group events](./events-reports/about-server-workload-protection-event-logging/apply-tags-to-identify-and-group-events/apply-tags-identify-group-events).
