...
- See [Upgrade the agent](../../administration/upgrade-server-workload-protection/upgrade-the-agent/upgrade-agent).

Next, upgrade your relays:

- See [Upgrade a relay](../../administration/upgrade-server-workload-protection/upgrade-a-relay/upgrade-relay).

## Next steps (deploy new agents and relays) {#next-steps-deploy-new-agents-and-relays}

After setting up your TLS 1.2 environment, if you decide to [Use a deployment script](../../administration/automate/automate-using-the-console/use-deployment-scripts-to-add-and-protect-computers/deployment-scripts-add-computers) (among other methods) to deploy new agents and relays, adhere to the guidelines below.
