...
- In the **Alert Status** [dashboard](../../dashboard-server-workload) widget
- On the Alerts page
- An email notification
- [Alert reports](../../events-reports/about-attack-reports/generate-reports-about-alerts-and-other-activity/reports-alerts--activity)
