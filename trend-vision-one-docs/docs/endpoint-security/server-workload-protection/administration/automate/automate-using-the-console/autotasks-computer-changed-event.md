...
- Use Java regular expression syntax (regex). Some examples of how to use regex are provided in the table below. For details on regex, see[https://docs.oracle.com/javase/6/docs/api/java/util/regex/Pattern.html](https://docs.oracle.com/javase/6/docs/api/java/util/regex/Pattern.md).
