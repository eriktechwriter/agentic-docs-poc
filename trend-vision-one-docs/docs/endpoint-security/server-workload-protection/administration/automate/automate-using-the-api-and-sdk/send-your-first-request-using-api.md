...
- An SDK client library, if you choose to use one. Go to the [Python SDK page](./sdk-guides/python-sdk/python-sdk) to download the client library and learn how to add it to your development environment.
...
- For information on how to create an API key for legacy accounts, see [Create and Manage API Keys](./sdk-guides/deploy-server-workload-protection/create-and-manage-api-keys/api-keys-server-workload).
...
- [Run the code examples](./sdk-guides/run-code-examples)
- [Notes about resource property values](./notes-resource-property-values)
- [About the overrides parameter](./overrides-parameter)
