...
You should have already verified that your environment is [set up to use the API using Bash or PowerShell](../set-up-to-use-bash-or-powershell/set-up-use-bash-or-powershell).
...
If you don't know the ID of the policy, you can use the [Search for a Policy](../search-for-a-policy-bash-and-powershell/search-for-policy-bash-powershell) recipe to obtain it.
...
- [Set up to use Bash or PowerShell](../set-up-to-use-bash-or-powershell/set-up-use-bash-or-powershell)

- [Modify a computer](https://automation.trendmicro.com/cloudone/workload-security/) (API Reference

- [Create and configure a policy](../../sdk-guides/configure-protection/create-and-configure-a-policy/create-configure-policy) (Guide) – “Assign a policy to a computer” section

- [Configure computers to override policies](../../sdk-guides/configure-protection/override-policies-on-a-computer/override-policies-computer) (Guide)

- [Search for Resources](../../search-for-resources) (Guide) - "Limit search results and paging" section
