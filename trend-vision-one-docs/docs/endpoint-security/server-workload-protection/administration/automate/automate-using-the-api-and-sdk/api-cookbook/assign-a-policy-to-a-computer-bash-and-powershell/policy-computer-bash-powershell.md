...
If you don't know the ID of the policy or the computer, you can use the [Search for a Policy](../search-for-a-policy-bash-and-powershell/search-for-policy-bash-powershell) and [Get a List of Computers](../get-list-computers-bash-powershell) recipes to obtain them.
...
- [Assign a policy to a computer](../../sdk-guides/configure-protection/create-and-configure-a-policy/create-configure-policy) (Guide)
