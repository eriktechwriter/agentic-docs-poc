...
The following code, from an [example](./sdk-guides/maintain-protection/report-on-computer-status/report-computer-status) in the [Report on Computer Status](./sdk-guides/maintain-protection/report-on-computer-status/report-computer-status) guide, obtains a list of computers that include the computer status property.
...
:::tip
For more information, see the [About the Overrides Parameter](./overrides-parameter) guide.
:::
...
As described in [Create and Configure a Policy](./sdk-guides/configure-protection/create-and-configure-a-policy/create-configure-policy), there are two ways that you can interact with policy settings:
...
Similarly, use the `PoliciesApi` class to interact directly with individual default policy settings, use the `ComputersApi` class for individual computer settings, and use the `SystemSettingsApi` class for individual system settings (see [Configure Computers to Override Policies](./sdk-guides/configure-protection/override-policies-on-a-computer/override-policies-computer) and [Configure Server & Workload Protection System Settings](./sdk-guides/deploy-server-workload-protection/configure-server-workload-protection-system-settings/configure-system-settings)).
...
For more information, see the "Limit search results and paging" section of the [Search for Resources](./search-for-resources) guide.
