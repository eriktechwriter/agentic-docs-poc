...
4.  Click on the *Role* list and select a role. *Auditor* grants read-only access to the Server & Workload Protection through the API, while *Full Access* grants both read and write access. If you need more specific roles for API key users, you can select *New* and define one. See [User Roles](../../../../../../../../../administration/user-roles) for more information on doing so.
