...
For more information about maintenance mode, see the [Turn on maintenance mode when making planned changes](../../../../../../configure-protection-modules/configuring-application-control/set-up-application-control/set-up-application-control).
