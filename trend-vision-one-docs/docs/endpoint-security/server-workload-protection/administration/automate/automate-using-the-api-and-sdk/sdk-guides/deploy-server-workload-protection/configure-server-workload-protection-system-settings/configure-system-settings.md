...
- `SystemSettings`: Defines properties for all of the available system settings. The properties are named after the system setting with which they correspond. For a list of system settings, see [System Settings](../../../settings-reference) in the Settings Reference.
...
- To retrieve a setting or to reset it to the default value, create a `SystemSettingsApi` class and use the `describeSystemSetting` or `resetSystemSetting` method or function. Include the setting name as an argument. (See [System Settings](../../../settings-reference) for a list of settings.)
