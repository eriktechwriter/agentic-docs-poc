...
:::note
For background information about roles, see [User Roles](../../../../../../../../administration/user-roles).
:::
...
See also [Obtain a role ID](../create-and-manage-api-keys/create-an-api-key-using-code/create-api-key-using-code).
...
To see the complete data structure of a `Role` object, see the response for the [Describe an Administrator Role](https://automation.trendmicro.com/cloudone/workload-security/) operation in the API Reference.
...
Also see the [Create an Administrator Role](https://automation.trendmicro.com/cloudone/workload-security/) operation in the API Reference.
