...
Also see the [Create and add new global rules](https://automation.trendmicro.com/cloudone/workload-security/) operation in the API Reference. For more information about global rules, see the [Use the API to create shared and global rulesets](../../../../../../configure-protection-modules/configuring-application-control/use-the-api-to-create-shared-and-global-rulesets/api-shared-global-rulesets) .
