...
To learn how to integrate Server & Workload Protection with a syslog or SIEM, see [Forward Server & Workload Protection events to a Syslog or SIEM server](../../../../../events-reports/about-server-workload-protection-event-logging/forward-events-to-a-syslog-or-siem-server/forward-server-workload-protection-events-to-a-syslog-or-siem-server/forward-syslog-siem-server).

To learn about events, see [Event collection in Server & Workload Protection](../../../../../events-reports/about-server-workload-protection-event-logging). See also [Generate reports about alerts and other activity](../../../../../events-reports/about-attack-reports/generate-reports-about-alerts-and-other-activity/reports-alerts--activity).
