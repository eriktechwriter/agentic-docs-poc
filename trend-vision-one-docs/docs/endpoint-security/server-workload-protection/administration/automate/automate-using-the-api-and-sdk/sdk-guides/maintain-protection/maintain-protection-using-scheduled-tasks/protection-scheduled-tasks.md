...
Scheduled tasks enable you to automatically perform specific Server & Workload Protection tasks on a schedule. You can use the Server & Workload Protection application programming interface (API) to perform all the scheduled task-related activities that you can do using Server & Workload Protection such as running [recommendation scans](../../../../../../computers/recommendation-scans), checking for security updates, and synchronizing cloud accounts. See [Schedule Server & Workload Protection to perform tasks](../../../../automate-using-the-console/schedule-perform-tasks) for more information about types of scheduled tasks.
