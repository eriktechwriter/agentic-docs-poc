...
:::tip
As mentioned in [Notes about Resource Property Values](./notes-resource-property-values), when you use the API directly, you use 0 to represent a null value. However, to search for a null value you use a Null search. You do not perform a numeric search for 0.
:::
...
:::tip
Use the `expand` parameter when you search to include only the information that you need in the returned computer objects. For more information, see "Minimize computer response size" in the [Performance Tips](./performance-tips) guide.
:::
...
Also see the [Search Intrusion Prevention Rules](https://automation.trendmicro.com/cloudone/workload-security/) operation in the API Reference. For information about authenticating API calls, see [Authenticate with Server & Workload Protection](./send-your-first-request-using-api).
...
Also see the [Search Computers](https://automation.trendmicro.com/cloudone/workload-security/) operation in the API Reference. For information about authenticating API calls, see [Authenticate with Server & Workload Protection](./send-your-first-request-using-api).
