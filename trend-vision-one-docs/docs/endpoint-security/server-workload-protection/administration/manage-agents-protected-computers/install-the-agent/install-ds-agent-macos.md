...
:::note
Mobile Device Management (MDM) helps configure your system to install and run the agent. Before you install, see [Configure Mobile Device Management on Server & Workload Protection for the macOS agent](./configure-mdm-macos-agent) for help setting up an automated or scripted installation. For specific details, including third party configuration instructions and MDM default configuration profiles, see <https://success.trendmicro.com/dcx/s/solution/000277823?language=en_US>.
:::
