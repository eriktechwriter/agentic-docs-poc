...
- For information on deployment scripts, see: [Use deployment scripts to add and protect computers](../../automate/automate-using-the-console/use-deployment-scripts-to-add-and-protect-computers/deployment-scripts-add-computers).
