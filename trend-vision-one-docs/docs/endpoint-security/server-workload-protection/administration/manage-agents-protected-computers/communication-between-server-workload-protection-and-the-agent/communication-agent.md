...
- *Bidirectional:* The agent normally initiates the heartbeat and also listens on the agent's listening port number for connections from Server & Workload Protection. (See [Server & Workload Protection port numbers](../../../troubleshooting/swp-port-numbers).) Server & Workload Protection can contact the agent to perform required operations. Server & Workload Protection can apply changes to the security configuration of the agent.
