...
For details on basic functions, see [Activity Monitoring events](../../events-reports/about-server-workload-protection-event-logging/activity-monitoring-events) and [Anti-Malware events](../../events-reports/about-server-workload-protection-event-logging/anti-malware-events).
