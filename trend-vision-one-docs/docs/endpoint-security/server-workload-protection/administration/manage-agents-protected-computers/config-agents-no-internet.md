...
To use a proxy, see [Connect agents behind a proxy.](../configure-proxies/configure-proxies-server-workload)
...
- Functionality is limited. Only the [Smart Scan](../../configure-protection-modules/configure-anti-malware/smart-protection-in-server-workload-protection/smart-protection) and [Web Reputation](../../configure-protection-modules/configure-web-reputation) features are supported with a local Smart Protection Server.
- Use the proxy solution if you need the [behavior monitoring](../../configure-protection-modules/configure-anti-malware/enhanced-anti-malware-and-ransomware-scanning-with-behavior-monitoring/ransomware-behavior-monitoring), [predictive machine learning](../../configure-protection-modules/configure-anti-malware/anti-malware), and [process memory scanning](../../configure-protection-modules/configure-anti-malware/anti-malware-set-up/configure-malware-scans) features. See Use a proxy above for details. If you decide not to use these features, you must disable them to prevent a query failure and to improve performance. For instructions on disabling these features, see Disable the features that use Trend Micro security services.
...
- if your agents or relay-enabled agents are inside AWS, install it using an AWS CloudFormation template created by Trend Micro. See [Deploy a Smart Protection Server in AWS](../../integrations/integrate-smart-protection-server) for details.
