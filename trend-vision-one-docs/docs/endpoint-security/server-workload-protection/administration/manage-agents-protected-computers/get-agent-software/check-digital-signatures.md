...
You can also validate the software's checksums and digital signatures for the security updates and agent modules. See [How Server & Workload Protection validates update integrity](../../upgrade-server-workload-protection/upgrades).
...
- Export a .zip file following the instructions in [Export the agent installer](.).
...
Use the jarsigner Java utility to check a signature on a .zip when you cannot check it through the manager. For example, you want to manually install an agent .zip package from the [Deep Security Software](https://help.deepsecurity.trendmicro.com/software.md) page. In this scenario, you would use the jarsigner utility because the manager is not involved.

### Procedure {#procedure-2}

1.  Install the latest [Java Development Kit (JDK)](https://www.oracle.com/technetwork/java/javase/downloads/index.md).

2.  Use the [jarsigner utility](https://docs.oracle.com/javase/7/docs/technotes/tools/windows/jarsigner.md) in the JDK to check the signature. The command is:
...
The procedures below describe how to manually check a digital signature on an installer file. To automate this check, include it in your [agent deployment scripts](../../automate/automate-using-the-console/use-deployment-scripts-to-add-and-protect-computers/deployment-scripts-add-computers).
...
Instead of checking the signature on the .rpm file manually, consider [using a deployment script](../../automate/automate-using-the-console/use-deployment-scripts-to-add-and-protect-computers/deployment-scripts-add-computers). Otherwise, continue with the below steps.
...
Instead of checking the signature on the .deb file manually, consider [using a deployment script](../../automate/automate-using-the-console/use-deployment-scripts-to-add-and-protect-computers/deployment-scripts-add-computers).
