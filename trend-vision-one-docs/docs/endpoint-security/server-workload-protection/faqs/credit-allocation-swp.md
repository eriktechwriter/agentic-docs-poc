...
For information on all license entitlements that are converted into credits, see [License entitlements calculated into credits](../../../administration/credits-billing/annual-credits/license-entitlements-calculated-into-credits) or [Trend Vision One Endpoint Security License to Credit Convert Rate](https://success.trendmicro.com/dcx/s/solution/000296988?language=en_US).
...
:::note
Server & Workload Protection contains a variety of [protection modules](../configure-protection-modules) that expand your security capabilities. Credits are allocated towards different Endpoint Security offerings depending on which modules you use.
...
Server & Workload Protection supports running [recommendation scans](../computers/recommendation-scans) on the Intrusion Prevention, Integrity Monitoring, and Log Inspection modules. Enabling recommendation scans causes Trend Vision One to allocate credits to both Advanced Endpoint Security (45 credits) and Advanced Server & Workload Protection (235 credits), for a total of 280 credits per deployment. For more information, see [Classic recommendation scan](../computers/recommendation-scans/classic-reco-scan).

For information on all Trend Vision One offerings requiring credits, see [Credit requirements for Trend Vision One solutions, capabilities, and features](../../../administration/credits-billing/annual-credits/credit-requirements-for-trend-vision-one-solutions-capabilities-and-features).
