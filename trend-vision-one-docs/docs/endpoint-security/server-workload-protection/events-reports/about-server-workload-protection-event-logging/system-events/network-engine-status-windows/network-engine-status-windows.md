...
:::note
Agents will display more security events for each affected network interface. See [Driver-Related Events](../agent-events) table for the list of agent events.
:::
