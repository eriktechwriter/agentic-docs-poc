...
- Firewall, IPS rules, or security groups block the heartbeat [port number](../../../../../troubleshooting/swp-port-numbers).

- Outbound (ephemeral) ports were blocked accidentally. See [Activation Failed - Blocked port](../error-activation-failed) for troubleshooting tips.
...
Telnet to [required port numbers](../../../../../troubleshooting/swp-port-numbers) on the manager to verify that a route exists, and the port is open:
