...
When the agent uses agent-initiated communication, you need to activate the agent from the agent computer. (See [Activate an agent](../../../../administration/automate/command-line-basics/command-line-basics).)
...
2.  Ensure that the ports are open between Server & Workload Protection and the agent. (See [Port numbers](../../../../troubleshooting/swp-port-numbers) and [Define a firewall rule](../../../../policies/define-rules-lists-and-other-common-objects-used-by-policies/create-firewall-rule).)
...
If you are a Server & Workload Protection customer, we recommend that you always use agent-initiated activation. To learn how to configure policy rules for agent-initiated communication and deploy agents using deployment scripts, see [Activate and protect agents using agent-initiated activation and communication](../../../../administration/manage-agents-protected-computers/activate-and-protect-agents-using-agent-initiated-activation-and-communication/agent-initiated-activation).
...
Review [Deploy agents to your EC2 instances](../../../../computers/add-computers/add-aws-instances/install-the-agent-on-amazon-ec2-and-workspaces/install-agent-amazon-ec2-workspaces).
...
For details on ports, see [Port numbers](../../../../troubleshooting/swp-port-numbers).
...
If you are using a proxy, in the console go to **Support → Deployment Scripts** and update the fields with your proxy, then reactivate the agent. For more information, see [Use deployment scripts to add and protect computers](../../../../administration/automate/automate-using-the-console/use-deployment-scripts-to-add-and-protect-computers/deployment-scripts-add-computers).

### Reinstallation required {#reinstallation-required}

If the agent is not activating, you may need to [Uninstall the agent](../../../../../endpoint-inventory/uninstall-the-trend-vision-one-endpoint-security-agent/uninstall-server-workload-protection-from-endpoints), then [reinstall the agent](../../../../administration/manage-agents-protected-computers/install-the-agent).
