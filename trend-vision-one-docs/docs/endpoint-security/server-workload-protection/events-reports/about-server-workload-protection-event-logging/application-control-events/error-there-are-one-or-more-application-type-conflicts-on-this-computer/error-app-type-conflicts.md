...
5.  Check the IPS rule 1000128.
    ...
    3.  Verify that the current inherited port list contains the [listening port number for the Server & Workload Protection console](../../../../troubleshooting/swp-port-numbers). If not, add this port to the Web Server Common port group.
