...
3.  Apply only the intrusion prevention rules that a [recommendation scan](../../computers/recommendation-scans) recommends. Remove any rules from the computer or the assigned policy that are recommended for unassignment. (See [Manage and run recommendation scans](../../computers/recommendation-scans/classic-reco-scan).)
