...
See [Integrity monitoring rules language](./integrity-monitoring-language-swp) for a general description of "include" and "exclude" for their allowed attributes and sub elements.
