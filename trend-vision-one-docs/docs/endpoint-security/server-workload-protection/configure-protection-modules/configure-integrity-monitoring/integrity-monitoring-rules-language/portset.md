...
See [Integrity monitoring rules language](./integrity-monitoring-language-swp) for a general description of Include and Exclude and their allowed attributes and sub elements. Only information specific to includes and excludes relating to this EntitySet class are included here.
