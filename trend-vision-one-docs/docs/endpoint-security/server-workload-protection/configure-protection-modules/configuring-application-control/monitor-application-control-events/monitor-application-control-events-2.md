...
To configure which Application Control events or severity levels cause an alert, go to the *Alerts* tab, click the *Configure Alerts* button, and then select an event and double-click *Properties*. For details, see [Configure alerts](../../../alerts/configure-alerts/configure-alerts).
