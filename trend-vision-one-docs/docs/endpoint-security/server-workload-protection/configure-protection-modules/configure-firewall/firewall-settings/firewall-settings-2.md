...
Select which firewall stateful configuration to apply to this policy. If you have defined multiple Interfaces for this policy (above), you can specify independent configurations for each interface. For more information on creating a stateful configuration see [Define stateful configurations](../../../policies/define-rules-lists-and-other-common-objects-used-by-policies/define-stateful-firewall-configurations/define-stateful-firewall).
...
For more information on creating firewall rules, see [Create a Firewall rule](../../../policies/define-rules-lists-and-other-common-objects-used-by-policies/create-firewall-rule).
