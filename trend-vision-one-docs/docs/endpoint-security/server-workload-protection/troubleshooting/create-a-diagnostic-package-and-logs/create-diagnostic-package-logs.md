...
For Linux-specific information on increasing or decreasing the anti-malware debug logging for the diagnostic package, see [Increase debug logging for anti-malware in protected Linux instances](../../configure-protection-modules/configure-anti-malware/handle-anti-malware/debug-antimalware-linux).
