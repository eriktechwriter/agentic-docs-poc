...
You can set up user roles and asset visibility scope by accessing the [User Roles](../../../../administration/user-roles) screen and applying roles in the [User Accounts](../../../../administration/user-accounts) screen.
