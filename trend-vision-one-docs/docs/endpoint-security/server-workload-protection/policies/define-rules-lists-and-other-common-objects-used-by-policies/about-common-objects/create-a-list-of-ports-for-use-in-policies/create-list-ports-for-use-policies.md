...
:::note
For a listing commonly accepted port number assignments, see the [Internet Assigned Numbers Authority (IANA)](http://www.iana.org/assignments/service-names-port-numbers/service-names-port-numbers.xml). For a list of port numbers used by Server & Workload Protection, relay, or agents, see [Server & Workload Protection Port numbers](../../../../troubleshooting/swp-port-numbers).
:::
