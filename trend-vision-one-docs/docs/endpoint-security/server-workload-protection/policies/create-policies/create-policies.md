...
:::tip
You can automate policy creation and configuration using the Server & Workload Protection API. For examples, see [Create and Configure Policies](../../administration/automate/automate-using-the-api-and-sdk/sdk-guides/configure-protection/create-and-configure-a-policy/create-configure-policy).
:::
...
2.  Enter a name for the policy. If you want the new policy to inherit its settings from an existing policy, select a policy from the *Inherit from* list and click *Next*.
    ...
    :::tip
    For information on inheritance, see [Policies, inheritance, and overrides](../policies-inheritance-overrides).
    :::
...
To create a new policy based on the [recommendation scan](../../computers/recommendation-scans) of a computer:
...
- Overview (the [Overview section of the policy editor](../overview-section-policy-editor) and [Overview section of the computer editor](../overview-section-computer-editor) are different)

- [Anti-Malware](../../configure-protection-modules/configure-anti-malware/anti-malware-set-up/configure-malware-scans)

- [Web Reputation](../../configure-protection-modules/configure-web-reputation)

- [Device Control](../../configure-protection-modules/configure-device-control)

- [Firewall](../define-rules-lists-and-other-common-objects-used-by-policies/firewall-settings/firewall-settings)

- [Intrusion Prevention](../../configure-protection-modules/configure-intrusion-prevention/configure-intrusion-prevention-rules/config-intrusion-prevention-rules)

- [Integrity Monitoring](../../configure-protection-modules/configure-integrity-monitoring/create-an-integrity-monitoring-rule/create-integrity-monitoring-rule)

- [Log Inspection](../../configure-protection-modules/configure-log-inspection/set-up-log-inspection/set-up-log-inspection)

- [Application Control](../../configure-protection-modules/configuring-application-control/set-up-application-control/set-up-application-control)

- [Interface Types](../detect-and-configure-the-interfaces-available-on-a-computer/detect-configure-interfaces)

- [Settings](../network-engine-settings)

- [Overrides](../policies-inheritance-overrides)
...
For more information on how child policies in a hierarchy tree can inherit or override the settings and rules of parent policies, see [Policies, inheritance, and overrides](../policies-inheritance-overrides).

After assigning a policy to a computer, you should still run periodic recommendation scans on your computer to make sure that all vulnerabilities on the computer are protected. See [Manage and run recommendation scans](../../computers/recommendation-scans/classic-reco-scan) for more information.
