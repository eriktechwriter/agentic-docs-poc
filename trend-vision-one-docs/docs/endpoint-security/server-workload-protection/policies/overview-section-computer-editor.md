...
If you have lost communication with the computer, a diagnostics package can be created locally. For more information, see [Create a diagnostic package](../troubleshooting/create-a-diagnostic-package-and-logs/create-diagnostic-package-logs).

### System Events tab {#system-events-tab}

For information about events, see [System events](../events-reports/about-server-workload-protection-event-logging/system-events).
