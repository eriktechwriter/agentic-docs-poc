...
3.  Click the **download the uninstall tool** link at the bottom of the **Agent Installer** window.
    ...
    :::note
    If you do not see the link, you might not have permission to download the uninstall tool. Contact your system administrator for assistance.
    :::
...
18. Configure the **Requirements** tab and click **Next**.
    ...
    - **Minimum operating system**: Refer to the [Trend Vision One Endpoint Security agent system requirements](../trend-vision-one-endpoint-security-agent-system-requirements) for your agent and security environment needs.
...
26. Review the settings and then click **Create**.
    ...
    Once the app runs, the agent is uninstalled from the target endpoints. Endpoint Inventory might take some time to update the information. Some endpoints might require you to manually update the endpoint lists. For more information, see [Cleaning Up Uninstalled Agents](./cleaning-up-uninstalled-agents).
