...
- If you want to use a Service Gateway as a proxy, make sure to deploy and configure a Service Gateway with the Forward Proxy Service enabled. For more information, see [Deploy a Service Gateway and Configure Firewall Exceptions](../../../getting-started-with-trend-vision-one-endpoint-security/deploy-a-service-gateway-and-configure-firewall-exceptions).
