...
Use the [Agent Installer Proxy Settings](.) tab in [Global Settings](..) to configure a custom proxy for your Protection Managers or sensor only agents to perform initial connection and registration during deployment.
