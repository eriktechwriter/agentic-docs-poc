...
- [Endpoint Settings](./sensor-settings "Configure inactive endpoint removal and agent download bandwidth settings.")
- [Agent Installer Proxy Settings](./agent-installer-proxy-settings "Configure custom proxy settings to ensure newly deployed agents can connect and register.")
- [Runtime Proxy Settings](./runtime-proxy-settings "Configure custom proxy policies for more granular control over how endpoints connect to Trend Vision One.")
