...
The following system requirements are for deploying the Trend Vision One Endpoint Security agent package with Server & Workload Protection features.

If you wish to only connect a Deep Security Agent directly to your Server & Workload Protection Manager, see [Agent platform compatibility](../../../server-workload-protection/administration/manage-agents-protected-computers/configure-agent-version-control/agent-platform-compatibility) for supported agents.
...
<tbody>
<tr>
<td><p>Windows Server 2008 R2 64-bit (x86-64)</p></td>
<td><ul>
<li><p>Standard</p></li>
...
<tr>
<td><p>Oracle Linux 10 (x86-64)</p></td>
</tr>
<tr>
<td rowspan="8"><p>Red Hat</p></td>
...
- [Linux Secure Boot support](./linux-secure-boot-support)
- [Server & Workload Protection relay requirements](./swp-relay-requirements "Review the requirements for using a Server & Workload Protection agent as a relay.")
- [Server & Workload Protection bandwidth sizing](./swp-bandwidth-sizing "Review the network usage requirements for the Server & Workload Protection agent based on your environment.")
- [Server & Workload Protection sizing for Squid Proxy](./server-workload-sizing-squid-proxy "Review bandwidth and connection details to determine the appropriate requirements for using Squid Proxy.")
