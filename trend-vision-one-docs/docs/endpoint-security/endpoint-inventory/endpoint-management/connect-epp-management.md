...
You can evaluate the new Trend Vision One Endpoint Security by moving some of your agents from your connected endpoint protection products to Standard Endpoint Protection or Server & Workload Security. For more information, see [Evaluate Trend Vision One Endpoint Security](../../getting-started-with-trend-vision-one-endpoint-security/evaluate-trend-vision-one-endpoint-security).

You can also [update your connected endpoint protection products](../../getting-started-with-trend-vision-one-endpoint-security/update-trend-micro-endpoint-solutions) to Trend Vision One Endpoint Security.
