...
- [Firewall](../endpoint-security-policies-unified-assignment/policies/policies-firewall) to define trusted programs allowed to bypass the firewall

- [Exclusions](../endpoint-security-policies-unified-assignment/policies/policies-exclusions) to define trusted programs excluded from security and anti-malware scans
