...
Schedules are a policy resource you can configure to control when [Anti-Malware](../endpoint-security-policies-unified-assignment/policies/policies-anti-malware) runs Scheduled Scans. You can add up to 50 schedules.
