...
Endpoint Security Policies combines and simplifies the endpoint security options from Standard Endpoint Protection and Server & Workload Protection to provide consistent protection across your agent deployments. To learn more about how features from Standard Endpoint Protection and Server & Workload Protection have been merged into Endpoint Security Policies, see [Endpoint protection module feature mapping](./endpoint-security-policies-troubleshooting-and-faq/protection-module-feature-mapping).

Some features have support extended across the Protection Managers to provide a consistent security experience. Support for some features is under development and might not apply to all configurations and deployment types. For more information about feature support, see [Endpoint Security Policy feature support requirements](./about-endpoint-security-policies-unified-assignment/policy-feature-support-requirements).
