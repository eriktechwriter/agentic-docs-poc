...
1.  Create and configure [policy resources](../policy-resources) to use with your policies.

2.  [Create a policy](./policies/create-endpoint-security-policy) and initial configuration.

3.  [Configure the security modules](./policies/configure-security-features).

4.  [Create an assignment](./assignments/assign-policies) and configure priorities.
