...
5.  In the **Exception List**, select custom tags or filters to exclude users or endpoints from compliance calculations.
    ...
    - For more information about creating tags or filters, see [Custom Tags and Filters](../../../../directories/userendpoint-directory/custom-tags-and-filters).
    :::
    ...
    2.  From the **Type** drop-down list, select **User** or **Endpoint** to display the available custom filters and tags by type; otherwise, select **All** to view all entries.
        ...
        For more information on custom tags and filters, see [Custom Tags and Filters](../../../../directories/userendpoint-directory/custom-tags-and-filters).
        :::
