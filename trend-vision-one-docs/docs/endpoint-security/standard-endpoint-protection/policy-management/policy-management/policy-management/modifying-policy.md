...
Administrators can modify policy targets and settings as necessary. Other accounts can only modify the policies they have created. Administrators must change the owner of the policy before editing or deploying policies created by other accounts. After a policy is modified, Standard Endpoint Protection deploys the policy to the targets.
