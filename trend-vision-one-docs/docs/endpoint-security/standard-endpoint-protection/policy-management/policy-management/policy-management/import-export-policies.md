...
- For more information, see the following topics:
  ...
  - [Creating a New Policy](./creating-a-new-policy)

  - [Inheriting Policy Settings](./inheriting-policy-settings)
:::
...
4.  To import, click **Import Settings** and then locate and load the policy file.
    ...
    For more information about reordering the policy list, see [Reordering the Policy List](./reordering-policy-list).
