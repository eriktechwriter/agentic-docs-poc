...
7.  (Optional) Review the settings that can be customized or extended and then make changes as necessary. For a list of settings to review, see [Working with Parent Policy Settings](./creating-a-new-policy/working-parent-policy-settings).
