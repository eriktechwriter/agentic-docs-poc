---
slug: trend-vision-one-adding-scheduled-reports
sidebar_position: 2
...
5.  In the **Report Content** section, select one of the following template types:
    ...
    - **Custom Templates**: Select one or more custom report templates.
      ...
      For more information about creating custom report templates, see [Adding or Editing Custom Templates](../custom-templates/adding-or-editing-custom-templates).
      :::
...
16. Click **Finish**.
    ...
    :::note
    By default, Trend Micro Apex Central enables newly added scheduled reports.
    :::

17. To view a generated report:

    1.  Click the **View** link in the *History* column for the scheduled report you want to view.
