...
- The **User Access** log query data view provides details about any user modifications related to any available custom tags or filters.
  ...
  - [Querying Logs](../../../logs-reports/logs/querying-logs)
...
- Generate custom reports for tagged users and endpoints by specifying the associated tags, filters, or importance labels as the report targets.
  ...
  - [Creating One-time Reports](../../../logs-reports/reports/one-time-reports/creating-one-time-reports)

  - [Adding Scheduled Reports](../../../logs-reports/reports/scheduled-reports/adding-scheduled-reports)

  - [Editing Scheduled Reports](../../../logs-reports/reports/scheduled-reports/editing-scheduled-reports)
:::
...
- [Filters](./filters)
- [User or Endpoint Importance](./user-or-endpoint-importance)
