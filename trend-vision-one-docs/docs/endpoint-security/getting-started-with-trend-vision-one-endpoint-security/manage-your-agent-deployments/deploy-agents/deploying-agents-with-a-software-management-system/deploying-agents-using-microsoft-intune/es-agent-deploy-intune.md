...
:::note
For Endpoint Sensor agents, you can set up the [agent for VDI environments](../../deployment-using-a-golden-image/create-golden-agent-image) if your network includes virtual desktops.
:::
