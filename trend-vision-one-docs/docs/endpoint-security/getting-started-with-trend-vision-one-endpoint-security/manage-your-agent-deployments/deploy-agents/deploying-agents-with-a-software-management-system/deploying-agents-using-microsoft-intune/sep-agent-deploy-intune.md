...
:::note
For Standard Endpoint Protection agents, you can set up the [agent for VDI environments](../../deployment-using-a-golden-image/create-golden-agent-image) if your network includes virtual desktops.
:::
...
17. Configure the **Requirements** tab and click **Next**.
    ...
    - **Minimum operating system**: Refer to the [Trend Vision One Endpoint Security agent system requirements](../../../../../endpoint-inventory/trend-vision-one-endpoint-security-agent-system-requirements) for your agent and security environment needs.
