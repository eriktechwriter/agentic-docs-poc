...
8.  Create the package.
    ...
    12. Select the specified platforms based on the [system requirements](../../../../endpoint-inventory/trend-vision-one-endpoint-security-agent-system-requirements) of the agent you are deploying and the needs of your security environment.
