...
7.  Unpack the installation package on the target endpoint.
    ...
    To check which third-party security solutions can be automatically uninstalled by the agent installer, refer to the [Standard Endpoint Protection FAQs](../../../standard-endpoint-protection/standard-endpoint-protection-faqs).
    :::
