...
- For Standard Endpoint Protection agents:
  ...
  5.  Click **Create**.
      ...
      You can also review and move agents to other groups managed by the same Endpoint Group Manager. For more information, see [Endpoint Inventory](../../endpoint-inventory).
...
- For Server & Workload Protection agents:
  ...
  5.  Click **Create**.
      ...
      You can also review and move agents to other groups managed by the same Server & Workload Manager instance. For more information, see [Endpoint Inventory](../../endpoint-inventory).
