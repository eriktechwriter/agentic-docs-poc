...
- **Virtual desktops**: After updating to Trend Vision One, you must rebuild your golden image or Sysprep image if your endpoints meet all of the following criteria:
  ...
  For more information, see [Creating a golden image with the agent software](../../manage-your-agent-deployments/deploy-agents/deployment-using-a-golden-image/create-golden-agent-image).
:::
...
10. Allow some time for the update process to complete. You can access the [Endpoint Inventory](../../../endpoint-inventory) or [Product Instance](../../../../service-management/product-instance) app to monitor the update progress of your Standard Endpoint Protection Manager (replaces the old Apex Central as a Service console).

    [Learn more about feature mapping in Trend Vision One](./apex-one-sep-feature-map)
