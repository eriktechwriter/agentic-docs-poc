...
To evaluate Trend Vision One without connecting your endpoint protection products, you can move your endpoints to Server & Workload Protection. For more information, see [Evaluate Trend Vision One Endpoint Security](evaluate-endpoint-security.md).
:::
