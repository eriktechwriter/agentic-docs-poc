...
To learn how to integrate Server & Workload Protection with a syslog or SIEM, see [Forward Server & Workload Protection events to a Syslog or SIEM server](forward-syslog-siem-server.md).

To learn about events, see [Event collection in Server & Workload Protection](event-logging.md). See also [Generate reports about alerts and other activity](reports-alerts--activity.md).
