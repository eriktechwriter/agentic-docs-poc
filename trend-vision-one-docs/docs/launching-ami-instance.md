...
- [Create security groups](aws-security-groups-network-sensor.md) for the data port and management port.
...
14. In the **Instance Type** section, select an instance type supported by Virtual Network Sensor that meets the specifications for your deployment.
    ...
    For more information about the resources required for different network throughput, see [Virtual Network Sensor system requirements](network-sensor-sys-reqs.md).
...
17. Use the **Configure storage** settings to specify the size of the root volume for your instance.
    ...
    Set the root volume size according to your throughput. For more information, see [Virtual Network Sensor system requirements](network-sensor-sys-reqs.md).
