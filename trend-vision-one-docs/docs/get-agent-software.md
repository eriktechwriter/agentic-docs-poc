...
:::tip
Installing an agent, activating it, and applying protection with a security policy can be done using a command line script. For more information, see [Use a deployment script](deployment-scripts-add-computers.md).
:::

:::tip
You can generate deployment scripts to automate the agent installation using the Server & Workload Protection API. For more information, see [Generate an agent deployment script.](api-generate-agent-deploy.md)
:::
...
For details on which agent you'll need for the version of AIX you're using, see [Agent platforms](agent-platform-compatibility.md).

**Related information**

- [Check digital signatures of software packages](check-digital-signatures.md)
