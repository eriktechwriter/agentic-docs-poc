...
If you don't know the ID of the policy or the computer, you can use the [Search for a Policy](search-for-policy-bash-powershell.md) and [Get a List of Computers](get-list-computers-bash-powershell.md) recipes to obtain them.
...
- [Assign a policy to a computer](create-configure-policy.md) (Guide)
