...
Contact your Trend Vision One administrator to [obtain an API key](platform-api-keys.md) and [enable the Automatically register cluster permission on the related user role](custom-user-roles-trend-vision-one.md).
