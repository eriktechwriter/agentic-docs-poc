...
- Generate custom reports for tagged users and endpoints by specifying the associated tags, filters, or importance labels as the report targets.
  ...
  - [Creating One-time Reports](creating-one-time-reports.md)

  - [Adding Scheduled Reports](adding-scheduled-reports.md)

  - [Editing Scheduled Reports](editing-scheduled-reports.md)
:::

**Related information**

- [Custom Tags](custom-tags.md)
- [Filters](filters-endpoint-user.md)
- [User or Endpoint Importance](user-or-endpoint-importance.md)
