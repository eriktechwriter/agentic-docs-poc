...
You can generate [Reports](rules-status-reports.md) on demand and download them in the following formats:
...
:::note
The format of download for\_ [Compliance and Cloud Risk Management Reports](compliance-reports.md) may also be dependent on the formatting guidelines of the standard or framework.
:::
