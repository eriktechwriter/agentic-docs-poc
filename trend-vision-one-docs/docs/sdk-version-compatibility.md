...
The SDK version corresponds with the version that appears in the title of the [API Reference](https://automation.trendmicro.com/cloudone/workload-security/).
