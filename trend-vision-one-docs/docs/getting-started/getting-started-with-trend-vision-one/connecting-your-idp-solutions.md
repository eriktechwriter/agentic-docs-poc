...
3.  Configure your Identity Provider (IdP) and download the IdP metadata XML file.
    ...
    - [Configure Active Directory Federation Services](../../administration/identity-providers/configuring-adfs)

    - [Configure Microsoft Entra ID](../../administration/identity-providers/configuring-saml-ad)

    - [Configure Okta](../../administration/identity-providers/configure-okta)

    - [Configure Google Cloud Identity](../../administration/identity-providers/config-google-cloud-saml)
...
7.  After the file successfully uploads, click **Save**.
    ...
    For more information, see [Configure accounts](../../administration/user-accounts/configure-accounts).
