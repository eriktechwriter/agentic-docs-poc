...
- Service Gateway installed and [cloud service extension](../../../../workflow-and-automation/service-gateway-management/service-gateway-appliance-configuration/configure-service-gateway-settings/cloud-service-extension) turned off
...
<tbody>
<tr>
<td><p>Endpoint Sensor features</p></td>
<td><ul>
...
<tr>
<td><p>Browser extension</p>

:::warning[Important]

<p>Apply these exceptions if you enable the browser extension using Endpoint Sensor or the Web Reputation module in Standard Endpoint Protection.</p>
...
<tr>
<td><p>Standard Endpoint Protection features</p>

:::warning[Important]

<p>If you enable endpoint sensor detection and response, you must also add the Endpoint Sensor features exceptions.</p>
...
<tr>
<td><p>Server &amp; Workload Protection features</p>
...
<td><ul>
<li><p>resources.prod-ap-southeast-2.irs.trendmicro.com</p></li>
</ul></td>
</tr>
</tbody>
</table>
...
<tbody>
<tr>
<td rowspan="6"><p>TippingPoint</p></td>
<td><p>Australia</p></td>
<td><ul>
...
<p>For customers with "Send to Sandbox" enabled, add the following as well:</p>
<ul>
<li><p>ctapi.trendmicro.com</p></li>
