...
- Enhanced identity management and role-based access control: Configure permissions for users, groups, and identity providers, and define custom asset visibility for users across all Trend Vision One apps and services in one centralized location.
  ...
  - The Foundation Services release supports configuring [additional user account types](../../../administration/user-accounts).
  ...
  - Configure multiple [identity providers](../../../administration/identity-providers) to enable IdP-initiated SAML single sign-on (SSO), direct mapping to third-party IdP user groups, and mapping of multiple roles to the same user account.
...
- New centralized security capabilities: Take advantage of new security capabilities for email, cloud, network, mobile, identity, and data in the Trend Vision One platform.
  ...
  - [Endpoint Security](../../../endpoint-security/getting-started-with-trend-vision-one-endpoint-security)

  - [Container Security](../../../cloud-security/container-security)

  - [File Security](../../../cloud-security/file-security)

  - [Email and Collaboration Security](../../../email-and-collaboration-security/get-started-with-trend-vision-one-email-and-collaboration-security)

  - [Cloud Accounts](../../../cloud-security/cloud-accounts)

  - [Identity Security](../../../cyber-risk-exposure-management/security-posture-management/identity-security-posture)

  - [Data Security Posture](../../../cyber-risk-exposure-management/security-posture-management/data-security-posture)
...
:::warning[Important]
Be aware of the [considerations for updating](./foundation-update-consider) to the Foundation Services release and [potential impacts on your user accounts](./foundation-services-update-impacts) before beginning the update.
:::
...
- [Foundation Services update considerations](./foundation-update-consider "Consider the impacts of updating Trend Vision One to the Foundation Services release.")
- [Impacts of migrating user accounts from other Trend Micro products](./foundation-services-update-impacts "Consider the impacts of migrating your local and SAML accounts from other Trend Micro products to Trend Vision One after updating to the Foundation Services release.")
