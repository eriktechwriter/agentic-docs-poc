...
Administrators can choose from several criteria when creating expressions. An expression must satisfy the chosen criteria before Data Loss Prevention subjects it to a DLP policy. For details about the different criteria options, see [Criteria for custom expressions](criteria-for-custom-expressions.md).
...
- [Creating a Customized Expression](creating-customized-expression.md)
- [Importing Customized Expressions](importing-customized-expressions.md)
