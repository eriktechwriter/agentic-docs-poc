---
slug: trend-vision-one-template-scanner-2
sidebar_position: 2
...
Template Scanner provides a preventative measure to ensure your cloud infrastructure for Azure, AWS and GCP remains compliant by detecting risks in your Infrastructure as Code (IaC) before it's deployed.

You can use this service to scan Cloudformation templates and terraform configuration files.

### Supported Cloud Providers {#supported-cloud-providers}

Template Scanner currently supports the following cloud providrers. For details on specific coverage support for each cloud provider, see: [Template Scanner Coverage](../../../../cyber-risk-exposure-management/security-posture-management/cloud-risk-management/template-scanner-resources/template-scanner-coverage)
...
<tr>
<td><p>Terraform (AWS, Azure and GCP)</p></td>
<td><p>✅</p>
...
1.  Install the [AWS CDK CLI](https://docs.aws.amazon.com/cdk/v2/guide/getting_started.md)
...
Please refer to [this page](https://automation.trendmicro.com/xdr/api-beta/) for an overview of the supported resources.
...
1.  Unsupported resource type or rules - Template Scanner only supports resource-level rules. Please refer to the APIs for a list of [supported rules and resource types](https://automation.trendmicro.com/xdr/api-beta/). We have plans to add support for more source types over time. If there is a specific resource type you need as a priority, please contact your account manager.
