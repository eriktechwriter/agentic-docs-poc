...
- Which [roles](../../../../../cyber-risk-exposure-management/security-posture-management/cloud-risk-management/misconfiguration-and-compliance/manage-users/roles-and-permissions/roles-permissions) are you planning to use via SSO? (Admin, Power User, Read-only, and Custom) {: .note }
