...
The Compliance and Cloud Risk Management Report scores your cloud infrastructure as PASS or FAIL for each control within [supported Standards and Frameworks](../../../../../cyber-risk-exposure-management/security-posture-management/cloud-risk-management/misconfiguration-and-compliance/compliance/compliance-and-cloud-risk-management/compliance-in-cloud-posture).
...
Each Cloud Risk Management rule that is applicable to control within the selected standard or framework is run against your selected account(s) and [Checks](../../../../../cyber-risk-exposure-management/security-posture-management/cloud-risk-management/misconfiguration-and-compliance/misconfiguration-and-compliance-rules/checks/model-check/model-check) are sent back and totaled as PASS or FAIL for each control.
...
Clicking on the [Resolve](../../../../../cyber-risk-exposure-management/security-posture-management/cloud-risk-management/misconfiguration-and-compliance/misconfiguration-and-compliance-rules/checks/failed-check-resolution/failed-check-resolution) button against the failed [Checks](../../../../../cyber-risk-exposure-management/security-posture-management/cloud-risk-management/misconfiguration-and-compliance/misconfiguration-and-compliance-rules/checks/model-check/model-check) will direct you to the related rule and remediation steps on the Cloud Risk Management Knowledge Base, which provides a step-by-step guide on how to resolve the failure.
...
1.  You can create customized views of the rules and checks on your *All accounts*, *Individual accounts*, or *Groups* using [filters](../../../../../cyber-risk-exposure-management/security-posture-management/cloud-risk-management/misconfiguration-and-compliance/misconfiguration-and-compliance-rules/search/filter-and-search/filter-search).
...
2.  Download the report result
    ...
    1.  Click on [Generate report](../../../../../cyber-risk-exposure-management/security-posture-management/cloud-risk-management/misconfiguration-and-compliance/reports/generate-download-report) to generate and download Compliance and Cloud Risk Management report ![](/images/generate-compliance-conformity-report-fhzpwd=d7051a01-d81a-40d7-a818-7df0788d8514.webp){.zoom}

3.  Download previously generated reports from the history

    1.  Click to expand *Other reports* from the [Configured reports](../../../../../cyber-risk-exposure-management/security-posture-management/cloud-risk-management/misconfiguration-and-compliance/reports/configured-reports) list
