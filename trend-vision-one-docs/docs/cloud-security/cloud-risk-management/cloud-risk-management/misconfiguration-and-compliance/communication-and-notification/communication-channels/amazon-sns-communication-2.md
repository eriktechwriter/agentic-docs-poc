...
- *lastUpdatedDate :* the timestamp of the last time Compliance scan or RTPM updated any attribute of the check.
- *lastStatusUpdateDate :* the timestamp of the last time Compliance scan or RTPM updated status attribute of the check. For new checks, this field is set to the creation date.
