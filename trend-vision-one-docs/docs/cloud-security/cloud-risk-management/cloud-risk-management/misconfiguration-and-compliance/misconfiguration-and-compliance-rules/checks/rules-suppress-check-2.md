...
Trend Vision One™ – Cloud Risk Management provides you with the ability to suppress failed [Checks](../../../../../../cyber-risk-exposure-management/security-posture-management/cloud-risk-management/misconfiguration-and-compliance/misconfiguration-and-compliance-rules/checks/model-check/model-check) - this may be useful for specific Rules that aren't relevant or are managed in a different way. Suppressed Checks will appear greyed out on the dashboard, and will display 'suppressed' counts on the [All Checks report](../../../../../../cyber-risk-exposure-management/security-posture-management/cloud-risk-management/misconfiguration-and-compliance/reports/all-checks-report). Currently, we do not support batch suppression.
...
No, Suppress is at the Check level. You have the option to [disable rules](../../../../../../cyber-risk-exposure-management/security-posture-management/cloud-risk-management/misconfiguration-and-compliance/misconfiguration-and-compliance-rules/configurations/rules-configuration).
