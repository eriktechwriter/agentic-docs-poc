...
Time to live (TTL) configuration allows you to specify the length of time a [Check](../../../../../../cyber-risk-exposure-management/security-posture-management/cloud-risk-management/misconfiguration-and-compliance/misconfiguration-and-compliance-rules/checks/model-check/model-check) will be displayed on the [All Checks Report](../../../../../../cyber-risk-exposure-management/security-posture-management/cloud-risk-management/misconfiguration-and-compliance/reports/all-checks-report). The configuration is only available for certain [Rules](../../../../../../cyber-risk-exposure-management/security-posture-management/cloud-risk-management/misconfiguration-and-compliance/misconfiguration-and-compliance-rules/introduction-to-cloud-risk-management-rules/introduction-rules) that are specific to [Real Time Posture Monitoring](../../../../../../cyber-risk-exposure-management/security-posture-management/cloud-risk-management/monitoring-real-time-posture/real-time-posture-monitoring/real-time-threat-monitoring).

For example:

1.  A user signs in without MFA. The rule [AWS IAM user has signed in without MFA](https://www.cloudconformity.com/knowledge-base=96b226c5-530f-49eb-b89e-74625f50f5f0/aws/RTPM/iam-user-sign-in-without-mfa.md) run against the resources associated with your cloud account to create an event on RTPM and a check on the [All Checks Report](../../../../../../cyber-risk-exposure-management/security-posture-management/cloud-risk-management/misconfiguration-and-compliance/reports/all-checks-report)
...
4.  However, the entire event history will still show in the [Real Time Posture Monitoring](../../../../../../cyber-risk-exposure-management/security-posture-management/cloud-risk-management/monitoring-real-time-posture/real-time-posture-monitoring/real-time-threat-monitoring) dashboard
