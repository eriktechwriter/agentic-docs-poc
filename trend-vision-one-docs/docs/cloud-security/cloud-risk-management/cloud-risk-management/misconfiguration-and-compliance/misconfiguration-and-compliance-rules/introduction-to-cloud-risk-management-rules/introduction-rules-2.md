...
Cloud Risk Management's rules cover the [6 categories](../../../../../../cyber-risk-exposure-management/security-posture-management/cloud-risk-management/misconfiguration-and-compliance/misconfiguration-and-compliance-rules/rule-categories) of security and governance best practices:
...
1.  Periodically on your [added Accounts](../../../../../../cyber-risk-exposure-management/security-posture-management/cloud-risk-management/misconfiguration-and-compliance/manage-cloud-accounts/cloud-accounts-cloud-posture-setup) by the [Compliance scan](../../../../../../cyber-risk-exposure-management/security-posture-management/cloud-risk-management/misconfiguration-and-compliance/compliance-scan-help/cloudIdentityBot), or
...
- *Is there any rule that looks for open access to all ports?* Rule: [EC2-001 (Security Group Port Range)](https://www.cloudconformity.com/knowledge-base=96b226c5-530f-49eb-b89e-74625f50f5f0/aws/EC2/security-group-port-range.md) checks for any range of open ports including all ports.
...
When an account is first added to Cloud Risk Management, a set of default rules will be run on the account by the Compliance scan.
...
See [Rule Configuration](../../../../../../cyber-risk-exposure-management/security-posture-management/cloud-risk-management/misconfiguration-and-compliance/misconfiguration-and-compliance-rules/configurations/rules-configuration).

## Rule settings {#rule-settings}

There are common rule settings (such as new rule behavior, and rule configurations) that can be managed at the [Cloud Accounts](../../../../../../cyber-risk-exposure-management/security-posture-management/cloud-risk-management/misconfiguration-and-compliance/manage-cloud-accounts/cloud-accounts-cloud-posture-setup) level.
...
Provides a count for different check statuses. See [Model: Check](../../../../../../cyber-risk-exposure-management/security-posture-management/cloud-risk-management/misconfiguration-and-compliance/misconfiguration-and-compliance-rules/checks/model-check/model-check) for more info on each status.

## Not scored {#not-scored}

Some rules are documented by Cloud Risk Management but cannot be tested against your cloud infrastructure due to not being applicable to cloud infrastructure or limitations of the data provided by the cloud provider. Rules that cannot be tested are identified as *Not Scored*. For more information see [Model Check](../../../../../../cyber-risk-exposure-management/security-posture-management/cloud-risk-management/misconfiguration-and-compliance/misconfiguration-and-compliance-rules/checks/model-check/model-check).
