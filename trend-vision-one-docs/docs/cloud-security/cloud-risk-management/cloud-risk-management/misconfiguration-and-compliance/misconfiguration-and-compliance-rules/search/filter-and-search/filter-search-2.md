...
Cloud Risk Management offers multiple filters when viewing rules and checks on available [reporting tools](../../../../../../../cyber-risk-exposure-management/security-posture-management/cloud-risk-management/misconfiguration-and-compliance/reports/rules-status-reports). You can view the filtered results by *Rule,* *Resource,* or [Standards or Frameworks](../../../../../../../cyber-risk-exposure-management/security-posture-management/cloud-risk-management/misconfiguration-and-compliance/compliance/compliance-reports).

Using the filter, you can take several actions such as configuring each rule according to your requirements, resolving failures, viewing only [suppressed](../../../../../../../cyber-risk-exposure-management/security-posture-management/cloud-risk-management/misconfiguration-and-compliance/misconfiguration-and-compliance-rules/checks/rules-suppress-check) or unsuppressed checks, Resource id, message, only show checks, generating a [report](../../../../../../../cyber-risk-exposure-management/security-posture-management/cloud-risk-management/misconfiguration-and-compliance/reports/rules-status-reports).
