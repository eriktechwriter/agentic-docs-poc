...
Profiles allow your organization to store and manage rule settings in reusable templates (e.g. rule settings for a specific environment type, security level, or application). You can apply a profile to one or more [Cloud Accounts](../../../cyber-risk-exposure-management/security-posture-management/cloud-risk-management/misconfiguration-and-compliance/manage-cloud-accounts/cloud-accounts-cloud-posture-setup) and also apply multiple profiles to an account to achieve the desired outcome for your rule settings.
...
- Custom Profile
- How Compliance scan runs Rules
- Create a Profile
...
### How Compliance scan runs Rules? {#how-compliance-scan-runs-rules}

1.  Compliance scan runs rules at the Account level first.
2.  If the rule/s is not configured at the Account level, then it will run checks at the Organisation Profile level.
3.  If a rule has not been configured either at an Account level or the Organisation Profile level, Compliance scan will run checks at the Cloud Risk Management default level.
...
3.  You can [configure every rule](../../../cyber-risk-exposure-management/security-posture-management/cloud-risk-management/misconfiguration-and-compliance/misconfiguration-and-compliance-rules/configurations/rules-configuration) within a profile as per your requirements.
...
2.  Select account(s) from the list or search for it using [name, environment](../../../cyber-risk-exposure-management/security-posture-management/cloud-risk-management/misconfiguration-and-compliance/manage-cloud-accounts/account-settings/cloud-account-general-settings), or [account tags](../../../cyber-risk-exposure-management/security-posture-management/cloud-risk-management/misconfiguration-and-compliance/manage-cloud-accounts/account-settings/manage-cloud-account-tags/cloud-account-tags).
