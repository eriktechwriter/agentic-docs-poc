...
- [Node.js API reference](./node-js-api-reference "An API reference for the Node.js SDK for Trend Vision One File Security")
- [Code example](./code-example "An example of Node.js code for the SDK for Trend Vision One File Security")
- [Common errors](./common-errors "Common errors encountered when using the Node.js SDK for Trend Vision One File Security")
...
- [Configure custom user roles](../../../../administration/user-roles/custom-user-roles-trend-vision-one) with File Security permissions

When you have all the prerequisites, continue with creating an API key.

## Create an API key {#create-an-api-key}

The File Security SDK requires a valid API key provided as a parameter to the SDK client object. Trend Vision One API keys are associated with different regions. Refer to [the region flag below](../deploy-with-python-sdk/deploying-python-sdk) to obtain a better understanding of the valid regions associated with the API key.
...
- [API reference](./node-js-api-reference)
