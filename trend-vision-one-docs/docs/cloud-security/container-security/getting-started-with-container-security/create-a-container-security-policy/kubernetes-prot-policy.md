...
:::warning[Important]
Policy configuration for Amazon ECS clusters differs greatly from a Kubernetes environment. To properly configure Amazon ECS protection policies, see [Creating an Amazon ECS policy](./creating-amazon-ecs-policy).
:::
