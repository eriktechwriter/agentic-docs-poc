...
[Learn more](./openshift-requirements).
:::
...
Learn more about [protecting OpenShift containers in SWP](../../../../../endpoint-security/server-workload-protection/computers/add-computers/protect-openshift-containers).

For more information about the recommended exclusions for OpenShift namespaces and how to add runtime security to the infrastructure and master nodes, see [OpenShift requirements](./openshift-requirements).
