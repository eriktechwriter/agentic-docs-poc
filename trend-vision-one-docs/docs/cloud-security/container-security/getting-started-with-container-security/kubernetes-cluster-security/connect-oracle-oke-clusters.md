---
slug: trend-vision-one-connect-oracle-oke-clusters
sidebar_position: 5
...
:::warning[Important]
- Ensure that your [Kubernetes environments meet the necessary requirements](./kubernetes-system-requirements-for-container-security) for Container Security.
...
12. For users deploying Container Security protection the cluster for the first time:
    ...
    2.  To enable automated cluster registration, [create an API key](../../inventoryoverview/kubernetes-clusters/obtain-apikey-auto-cluster-reg) and enter `true` for `clusterRegistrationKey`, as shown in the example below.
