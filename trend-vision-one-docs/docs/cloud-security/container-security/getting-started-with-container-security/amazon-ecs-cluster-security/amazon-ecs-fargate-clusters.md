...
- Connect your Amazon ECS cluster that hosts the Fargate container:
  - [Connect Amazon ECS clusters using a new AWS account](../../inventoryoverview/amazon-ecs-clusters/ecs-clusters-new-aws-account)
  - [Connect Amazon ECS clusters using an existing AWS account](./ecs-clusters-existing-account)
:::
