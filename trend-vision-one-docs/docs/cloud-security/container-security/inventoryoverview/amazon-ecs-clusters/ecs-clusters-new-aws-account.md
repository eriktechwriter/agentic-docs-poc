---
slug: trend-vision-one-ecs-clusters-new-aws-account
sidebar_position: 4
...
3.  Click **Add account**.
    ...
    The **Add AWS Account** screen appears.

4.  Select **CloudFormation** as the deployment method, and select **Single AWS Account**.

5.  Click **Next**.

6.  In another browser tab, sign in to your AWS account that manages the containers you want to protect.

7.  Go back to Trend Vision One and in the **Add AWS Account** screen, provide a name and description for the account, and select the region associated with your AWS account.

8.  If you have more than one Server & Workload Protection Manager configured in Endpoint Security, select the manager that you want to associate the cloud account with.

9.  Click **Next**.

10. Review each security feature and enable the features to apply to your Amazon ECS cluster.
...
12. Scroll to the bottom of the **Quick create stack** screen to the **Capabilities** section, select the acknowledgement options, and click **Create stack**.
