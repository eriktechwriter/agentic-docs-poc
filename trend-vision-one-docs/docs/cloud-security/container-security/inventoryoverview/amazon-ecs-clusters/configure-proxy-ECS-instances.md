...
:::warning[Important]
If your instance contains Fargate clusters, you must also modify the Task Definition file in your AWS account. For more information, see [Set up connected Amazon ECS Fargate clusters](./fargate-clusters-amazon-ecs).
:::
...
3.  Click **Proxy settings**.
    ...
    - If your ECS instance contains Fargate clusters, you must update the Task Definition file using the `-p` flag. For more information, see [Set up connected Amazon ECS Fargate clusters](./fargate-clusters-amazon-ecs).
