...
Contact your Trend Vision One administrator to [obtain an API key](../../../../administration/api-keys) and [enable the Automatically register cluster permission on the related user role](../../../../administration/user-roles/custom-user-roles-trend-vision-one).
