...
2.  Click the **Managed rulesets** tab.
...
3.  Create, duplicate, or modify a ruleset.
    ...
    - To duplicate an existing ruleset:
      ...
      2.  Click **Duplicate**.
          ...
          Container Security creates a copy of the existing ruleset and appends "Copy" to the ruleset name.
...
6.  For users that have applied labels to your Kubernetes clusters and want to apply the ruleset only to clusters with corresponding labels, click **Add Label**.
    ...
    2.  Choose whether pods matching the labels are included or excluded.

        :::note
        A ruleset can either exclude or include a list of labels; it cannot have a mix of included and excluded labels.
        :::

    3.  If you have multiple labels that you want to apply the ruleset to, click **Add Label** again.
