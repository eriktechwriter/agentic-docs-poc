...
:::note
To validate Trend Micro container images, see [How do I verify the authenticity of Trend Micro container images with Cosign public keys?](../../container-security-faqs).
:::
