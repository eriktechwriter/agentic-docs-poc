...
For information on configuring TMAS with AI Scanner, see [Configure AI scan settings](../../../../ai-application-security/configure-ai-scanner-scan-settings).

After integrating TMAS with AI Scanner into your continuous integration / continuous deployment (CI/CD) pipeline, you can [view the results](../../../../ai-application-security/ai-scanner-scan-results) in **Security for AI Stack → AI Scanner and AI Guard**.
