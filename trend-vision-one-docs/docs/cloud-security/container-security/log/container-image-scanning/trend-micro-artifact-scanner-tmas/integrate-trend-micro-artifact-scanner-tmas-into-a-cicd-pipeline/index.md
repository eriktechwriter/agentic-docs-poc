...
- Add Code Security policies to enforce policy standards, like allowing or blocking pull request merges that meet particular parameters. .
  ...
  [Learn more](../../../../../code-security/code-security-policies)
...
- [System requirements](./sys-req-artifact-scanner)
- [Update to the latest version](./updating-artifact-scanner-cli)
- [Obtain an API key](./obtaining-api-key)
- [Download and install TMAS](./install-artifact-scanner)
- [Add the CLI to your PATH](./adding-cli-your-path)
