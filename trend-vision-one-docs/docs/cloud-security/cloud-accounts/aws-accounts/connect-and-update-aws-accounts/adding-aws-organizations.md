...
- Due to limitations of AWS, StackSets does not deploy resources to your management account. To add your management account, see [Connect an AWS account using CloudFormation](./adding-aws-account).

  For more information, see [Why is my management account not visible after connecting my AWS organization?](../../cloud-accounts-troubleshooting-and-faqs/aws-account-connection-troubleshooting-and-faq/why--management-account-not-visible).
:::
...
6.  Specify the general information for the organization.
    ...
    3.  Select the AWS region for CloudFormation template deployment.
        ...
        Some features and permissions have limited support for some AWS regions. For more information, see [AWS supported regions and limitations](../aws-supported-regions-limitations).
        :::
...
7.  Configure the **Features and Permissions** you want to grant access to your cloud environment.
    ...
    :::warning[Important]
    - Agentless Vulnerability & Threat Detection is a pre-release feature and is not part of the existing features of an official commercial or general release. Please review the [Pre-release disclaimer](../../../../privacy-and-personal-data-collection-disclosure/pre-release-disclaimer) before using the feature.
    ...
    - Only the features and permissions listed here support deployment to organization managed accounts. If you want to enable additional features and permissions on an account, you must [connect the account individually](./adding-aws-account) before connecting the organization account.
    :::
