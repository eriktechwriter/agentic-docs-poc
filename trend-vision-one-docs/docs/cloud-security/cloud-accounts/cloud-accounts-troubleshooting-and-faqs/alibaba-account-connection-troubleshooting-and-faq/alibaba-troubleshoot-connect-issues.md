...
3.  Follow the steps in [Connect an Alibaba Cloud account](../../alibaba-cloud-accounts/connect-and-update-alibaba-cloud-accounts/adding-alibaba-cloud-account) to redeploy the Terraform script.
...
3.  Follow the steps in [Connect an Alibaba Cloud account](../../alibaba-cloud-accounts/connect-and-update-alibaba-cloud-accounts/adding-alibaba-cloud-account) to redeploy the Terraform script to the preferred region.
