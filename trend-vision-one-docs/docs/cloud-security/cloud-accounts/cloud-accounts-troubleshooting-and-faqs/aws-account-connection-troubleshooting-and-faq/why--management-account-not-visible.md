...
You can still add your management account separately by following the steps in [Connect an AWS account using CloudFormation](../../aws-accounts/connect-and-update-aws-accounts/adding-aws-account).
