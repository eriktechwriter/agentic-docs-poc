...
Enabling XDR for Cloud - AWS VPC Flow Logs requires allocating credits. For information about estimating credit usage with XDR for Cloud, see [Estimate and monitor XDR for Cloud usage](./xdr-for-cloud-usage).
:::
...
2.  Review the [VPC Flow Logs recommendations and requirements](../aws-accounts/aws-features-and-permissions/vpc-flow-logs-requirements).
...
3.  Add your AWS account to Trend Vision One cloud accounts app.
    ...
    :::note
    If you want to test integration with an AWS organization account, see [Connect an AWS Organization](../aws-accounts/connect-and-update-aws-accounts/adding-aws-organizations).
    :::
...
5.  Use one of the following demo attacks to trigger a Workbench alert.
    ...
    You can also run a [Threat Intelligence sweeping test](./threat-intelligence-vpc-sweep-test) to generate an alert using demo data.
