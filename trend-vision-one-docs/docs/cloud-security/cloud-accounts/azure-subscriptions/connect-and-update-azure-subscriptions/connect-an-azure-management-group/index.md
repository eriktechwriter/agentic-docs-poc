...
7.  Specify the general information for the Management Group.
    ...
    4.  Select the Azure region for deployment.
        ...
        Some Cloud Account features have limited support for Azure regions. For more information, see [Azure supported regions and limitations](../../azure-supported-regions-limitations).
        :::
...
9.  Configure the **Features and Permissions** you want to grant access to your cloud environment. For more information, see [Azure features and permissions](../../azure-features-and-permissions).
...
- [Azure script to change the primary subscription](./azure-change-primary-subscription)
