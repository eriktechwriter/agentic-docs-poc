...
1.  Create the modified resource script terraform file.
    ...
    Copy the [Azure reduced resource connection script](./azure-reduced-resource-script) and save the code to your local machine as a terraform (.TF) file.

2.  Connect or update one of your Azure subscriptions as normal.

    - To make a new connection, see [Connect an Azure subscription](../adding-azure-subscription).

    - To update a legacy connection, see [Updating a legacy Azure connection](../updating-legacy-azure-connection).
...
5.  Select the features and permissions you want to enable. For more information, see [Azure features and permissions](../../azure-features-and-permissions).
...
- [Azure reduced resource connection script](./azure-reduced-resource-script)
