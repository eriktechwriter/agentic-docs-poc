...
You can enable Cloud Detections for Azure Activity Logs on both new and existing Azure subscriptions in **Cloud Accounts**. For more information on XDR for Cloud, see [About XDR for Cloud](../../about-xdr-for-cloud)
...
3.  Save your changes. If you are adding a new Azure subscription, complete the steps to add the subscription. For more information, see [Connect an Azure subscription](../connect-and-update-azure-subscriptions/adding-azure-subscription).
