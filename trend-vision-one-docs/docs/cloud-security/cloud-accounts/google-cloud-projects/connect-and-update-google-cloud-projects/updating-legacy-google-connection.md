...
:::warning[Important]
If you have access to the Agentless Vulnerability and Threat Detection feature for Google Cloud, see [Update a legacy Google Cloud connection (January 2025 update)](./update-legacy-google-cloud-project) to update your Legacy Connection.
