...
:::note
The following instructions apply to resources deployed using LocalShell, or to compartments in which are you enabling Agentless Vulnerability & Threat Detection following an initial deployment with Oracle Resource Manager. To update resources deployed with Oracle Resource Manager, see [Update resources using Oracle Resource Manager](./oracle-cloud-resource-update).
:::
