...
Prior to adding an Active Directory, a data center gateway must be deployed and running. The Active Directory server hostname and port are required. For more information, see [Set up the data center gateway](set-up-data-center-gateway.md).
...
3.  If you have connected an Active Directory (on-premises) server to Trend Vision One through **Third-Party Integrations**, choose whether to add the Active Directory server using **Third-Party Integrations** information or by connecting it directly in Server & Workload Protection.
    ...
    To learn how to connect your Active Directory server in **Third-Party Integrations**, see [Active Directory (on-premises) integration](ad-premises-integration.md).
    :::
