...
3.  Create an app configuration policy for **Mobile Security for Business**.
    ...
    6.  Click **Done**.
        ...
        In the Trend Vision One console, your Ivanti-managed Android devices begin to appear in your [Mobile Inventory](../../../../use-mobile-device-director/mobile-inventory) device list after end users open the Mobile Security for Business app.
