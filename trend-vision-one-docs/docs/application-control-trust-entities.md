...
:::note
For information on how to allow or block software changes that are not being auto-authorized with the trust entities feature, see [View and change Application Control software rulesets](application-control-rulesets.md).
:::
