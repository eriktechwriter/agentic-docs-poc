...
1.  In the **General** section, verify your domain.
    ...
    To learn more about MX records, see [About mx records and Cloud Email Gateway Protection](mx-records.md).
...
3.  In the **Outbound Servers** section, complete the following configurations:
    ...
    1.  If your domain has SPF records, make sure the SPF record under the **Outbound Servers** section is also included.
        ...
        For details about adding SPF records, see [Adding SPF records](adding-spf-records.md).
...
4.  If you currently use Microsoft 365, configure Microsoft 365 connectors to allow email traffic to or from Cloud Email Gateway Protection MTAs.
    ...
    See [Adding Microsoft 365 inbound connectors](office-365-inbound-connectors.md).

    See [Adding Microsoft 365 outbound connectors](add-365-outbound-connectors.md).

**Related information**

- [Adding SPF records](adding-spf-records.md)
- [Adding Microsoft 365 inbound connectors](office-365-inbound-connectors.md)
- [Adding Microsoft 365 outbound connectors](add-365-outbound-connectors.md)
