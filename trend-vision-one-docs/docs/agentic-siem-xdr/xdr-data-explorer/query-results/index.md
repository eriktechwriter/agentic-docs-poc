...
<tbody>
<tr>
<td><p>Export query results</p></td>
<td><p>Click <img src="./images/export_button=GUID-C683DEEE-C19C-484D-A5B1-4CA9D1794756=1=en-us=Low.webp" /> and select from the drop-down menu to export the query results in CSV or JSON format.</p></td>
</tr>
<tr>
...
<li><p><strong>Field groups</strong>: Organizes fields into user-defined groups. The field group view includes the pre-configured <strong>Recommended Field Groups</strong> view.</p></li>
</ul></td>
</tr>
<tr>
...
- [Create a custom view for query results](./custom-view-search-results "Create a custom view that defines how to display data grouping and query results.")
