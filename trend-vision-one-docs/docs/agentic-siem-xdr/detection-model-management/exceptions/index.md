...
- [Custom exceptions](./adding-custom-exception): Originate from **Detection Model Management**. Custom exceptions use target, event source, and match criteria to define the objects and events to exclude from detections.

- [Context menu exceptions](./adding-exception-context-menu): Originate from the context menu in **Workbench** and **Observed Attack Techniques**. Context menu exceptions use the detection model filter and match criteria to define the objects and events to exclude from detections.
...
- [Add a custom exception](./adding-custom-exception "Create a custom exception to exclude specified objects or events from future detections.")
- [Add an exception from the context menu](./adding-exception-context-menu "During alert investigation, you can exclude objects from future detections.")
- [Edit a custom exception](./editing-custom-exception "Edit the settings of a custom exception.")
