...
For more information about sweeping tasks, see [Intelligence Reports](../../../threat-intelligence/intelligence-reports).
:::

**Related information**

- [Detection model data](./detection-model-data "Each detection model specializes in discovering a particular type of threat.")
