...
- [Configure a custom model](./configuring-custom-model "Create a custom model to define the specific events that trigger Workbench alerts.")
- [Run retro scans on custom model data](./run-retro-scans "Run retro scans on the historical data captured by existing custom detection models to identify past events that match your defined detection criteria.")
