...
2.  Specify the general settings of the filter:
    ...
    - **Severity**
      ...
      A severity of medium, high, or critical affects the Cyber Risk Index on the [Cyber Risk Overview](../../../cyber-risk-exposure-management/cyber-risk-overview) and [Threat and Exposure Management](../../../cyber-risk-exposure-management/continuous-risk-management/threat-and-exposure-management). When testing or tuning a model, select low to avoid affecting indexes.
...
3.  Specify the event settings of the filter:
    ...
    3.  Specify a query to locate the target events in the activity data.
        ...
        For more information about formatting filter queries, see [Filter query format](./custom-filter-query-format) and [Use regex in custom filters](./trend-micro-sigma-specification/using-regex-custom-filters).
...
:::tip
You can use custom filters to [create detection models](../custom-models/configuring-custom-model) that generate Workbench alerts based on your detections.
:::
