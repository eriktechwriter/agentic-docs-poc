...
To learn more about query syntax and regex in custom filters, see [Query syntax](../../xdr-data-explorer/query-syntax) and [Use regex in custom filters](./trend-micro-sigma-specification/using-regex-custom-filters).
