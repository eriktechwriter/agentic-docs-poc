...
<td><ul>
<li><p>Use the drop-down menus to filter insights by <strong>Last updated</strong> time, <strong>Event time</strong>, <strong>Case status</strong>, and <strong>Created</strong> time.</p></li>
<li><p>Click <strong>Add filter</strong> and select an option from the drop-down menu to filter by <strong>Alerts</strong>, <strong>Asset group</strong>, <strong>Custom tag</strong>, <strong>Criticality</strong>, <strong>Data source / processor</strong>, and <strong>Endpoint group</strong>.</p></li>
<li><p>Click a column heading to sort insights by score, case ID, last updated and creation time.</p></li>
...
- [Workbench insight details](./workbench-insight-details)
- [Assign owners to Workbench insights](./assigning-insights "Assign owners to your Workbench insights so your security team can track changes and receive notifications.")
