...
8.  To ensure that Container Security does not impact any of the following Kubernetes management systems, select the systems in the **Namespace Exclusions** dropdown menu.
    ...
    :::note
    Options with an asterisk (\*) represent sets of related namespaces. For details, see [Grouped namespaces](grouped-namespaces.md).
    :::
...
- [Amazon EKS Fargate system requirements](amazon-eks-fargate-sys-reqs.md)
