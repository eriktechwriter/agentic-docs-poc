...
For Linux-specific information on increasing or decreasing the anti-malware debug logging for the diagnostic package, see [Increase debug logging for anti-malware in protected Linux instances](debug-antimalware-linux.md).
