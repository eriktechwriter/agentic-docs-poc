...
Some versions of the agent for Linux are [compatible](agent-platform-compatibility.md) with [Unified Extensible Firmware Interface (UEFI) Secure Boot](https://uefi.org/sites/default/files/resources/UEFI_Secure_Boot_in_Modern_Computer_Security_Solutions_2013.pdf).
