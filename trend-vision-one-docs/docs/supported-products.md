...
For detailed instructions about how to properly register and configure specific products, see [Connect existing products to Product Instance](connect-exist-prod-instance.md) .
