...
2.  [Set automatic notifications](toggle-automatic-notifications.md)

3.  [Set manual notifications](toggle-manual-notifications.md)
...
5.  [Configure Triggers](communication-triggers.md)
...
7.  [Copy communication settings](copy-communication-settings.md)
