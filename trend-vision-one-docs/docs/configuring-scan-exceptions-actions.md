...
4.  Configure **Monitor** settings.
    ...
    3.  Select a notification message from the **Available** pane on the left side and click **Add\>**.
        ...
        The **Add**, **Edit**, **Copy** and **Delete** buttons under **Available** are provided for managing notification messages. For details about managing notifications, see [Managing notifications](managing-notifications.md).
