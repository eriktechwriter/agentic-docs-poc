...
- [Workbench alerts](workbench-alerts.md)
- [Observed Attack Techniques](oat.md)
- [Detections](udm-detections.md)
- [Audit logs](udm-audit-logs.md)
- [Container vulnerabilities](container-vulnerabilities.md)
- [Activity data](activity-data.md)
