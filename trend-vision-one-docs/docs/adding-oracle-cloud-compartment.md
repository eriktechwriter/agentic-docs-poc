...
6.  Configure the **Features and Permissions** you want to grant access to your cloud environment.
    ...
    - **Agentless Vulnerability & Threat Detection**: This feature set is not available for Oracle Resource Manager (ORM) deployments. To deploy Agentless Vulnerability & Threat Detection, you must select LocalShell deployment. For more information, see [Connect an OCI compartment using LocalShell](connect-oci-localshell.md).
