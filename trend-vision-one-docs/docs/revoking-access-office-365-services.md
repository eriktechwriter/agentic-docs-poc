...
7.  Manually clean up the remaining data.
    ...
    For details, see [Changes made under inline protection](changes-inline-protection.md) for Exchange Online (Inline Mode) or [Changes made under API-based protection](changes-api-based-protection.md) for other services.
