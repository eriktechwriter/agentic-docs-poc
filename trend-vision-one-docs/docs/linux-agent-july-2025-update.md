...
change_date: 2025-07-09T00:00:00Z
is_what_new: true
...
- **New features**
  ...
  - Add support for disabling self-protection using the authorization token (see [Authorization tokens](resources-authorization-tokens.md) in Policy Resources)
