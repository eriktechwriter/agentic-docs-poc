...
- [Connect an AWS account manually](adding-aws-account-manually.md "Learn how to connect your AWS account to Cloud Accounts if you cannot use the stack template.")
- [Use APIs to connect an AWS account](using-apis-connect-aws-account.md "Use the APIs on the Trend Vision One Automation Center to connect your AWS account.")
