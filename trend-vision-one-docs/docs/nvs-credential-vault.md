---
slug: trend-vision-one-nvs-credential-vault
...
- [Manage Credential Vault credential profiles](manage-credential-profiles.md "Create, modify, and delete stored credential profiles used to run network vulnerability scans that require authentication.")
