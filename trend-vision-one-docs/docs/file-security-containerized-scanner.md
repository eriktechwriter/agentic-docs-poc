...
- [Scaling and performance with Containerized Scanner](scaling-performance-cs.md)
- [Deploy a Containerized Scanner](fs-deploy-containerized-scanner.md)
- [ICAP Protocol and Containerized Scanner](icap-protocol-file-security-scanner.md)
- [Deploy a Containerized Scanner on a NetApp ONTAP cluster](deploy-cs-netapp-ontap-cluster.md)
- [Optional configurations](fs-cs-optional-configurations.md)
- [Uninstall Containerized Scanner Helm chart](fs-cs-uninstall-helm-chart.md)
