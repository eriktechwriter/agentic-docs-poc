...
- [Standard Endpoint Protection Agent Deployment using Microsoft Intune](sep-agent-deploy-intune.md)

- [Server & Workload Protection Agent Deployment using Microsoft Intune](swp-agent-deploy-microsoft-intune.md)
