...
Find step-by-step configmap procedures in Kubernetes documentation, and then rerun the curl statement from audit process to check for kubelet configuration changes:
