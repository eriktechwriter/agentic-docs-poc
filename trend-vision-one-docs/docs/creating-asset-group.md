...
3.  Configure the settings for the asset group.
    ...
    2.  Choose a tag value of the Asset group tag to associate with the new asset group.
        ...
        If you have [manually created tag values for the Asset group tag property](tag-library-tab.md) in Tag Management or another app, Trend Micro recommends associating each tag value with an asset group in Asset Group Management.
