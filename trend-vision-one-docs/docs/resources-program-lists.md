...
- [Firewall](policies-firewall.md) to define trusted programs allowed to bypass the firewall

- [Exclusions](policies-exclusions.md) to define trusted programs excluded from security and anti-malware scans
