...
You can set up user roles and asset visibility scope by accessing the [User Roles](user-roles-foundation-services.md) screen and applying roles in the [User Accounts](user-accounts-foundation-services.md) screen.
