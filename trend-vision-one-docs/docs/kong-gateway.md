...
Configure the integration to allow Kong Gateway to send API endpoint information directly to the APIs page in Attack Surface Discovery. For more information, see [APIs](apis.md).
