...
You can create your own templates if you have configured DLP data identifiers. You can also use predefined templates. For details, see [Custom DLP templates](custom-dlp-templates.md) and [Predefined DLP Templates](predefined-dlp-templates.md).
...
- [Predefined DLP Templates](predefined-dlp-templates.md)
