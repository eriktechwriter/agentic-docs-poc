...
:::warning[Important]
Policy configuration for Kubernetes clusters differs greatly from a Amazon ECS environment. To properly configure Kubernetes protection policies, see [Managing Kubernetes protection policies](kubernetes-protection-policies.md).
:::
