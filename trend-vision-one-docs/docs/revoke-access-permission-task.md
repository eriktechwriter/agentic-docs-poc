...
:::warning[Important]
This feature is only available for customers that have updated to the [Foundation Services release](update-foundation-services-release.md), and is only applicable to IAM users whose AWS accounts have **Cloud Response for AWS** enabled.
:::
