...
For more information on real-time scans, see [About Anti-Malware](anti-malware.md).
...
For more information on firewalls, see [About Firewall](firewall.md)
...
For more information on intrusion protection, see [About Intrusion Protection](intrusion-prevention.md).
