---
slug: trend-vision-one-ai-app-categories
title: Public AI service categories
---

Trend Vision One classifies public AI services into three categories. If the primary service of a cloud application falls into any of these categories, the application is considered a public AI service.

### ML/GenAI Service Providers {#mlgenai-service-providers}
...
### ML/GenAI Development Platforms {#mlgenai-development-platforms}
...
### AI-Powered End-User Applications {#ai-powered-end-user-applications}
