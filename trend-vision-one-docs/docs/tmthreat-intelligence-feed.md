...
For more information about API setup, see [Set up the API for the Trend Threat Intelligence Feed](api-for-threat-intelligence-feed.md).
...
- [Configure MISP for the Trend Threat Intelligence feed](misp-threat-intel-feed.md)
- [Configure TAXII for the Trend Threat Intelligence feed](configure-taxii-TIfeed.md)
- [Add the Trend Threat Intelligence feed in OpenCTI using TAXII2 connectors](TIfeed-opencti-taxii2.md)
