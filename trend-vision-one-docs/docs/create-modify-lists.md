...
Also see the [Modify a Directory List](https://cloudone.trendmicro.com/docs/workload-security/api-reference/tag/Directory-Lists) operation in the API Reference. For information about authenticating API calls, see [Authenticate with Server & Workload Protection\<](send-your-first-request-using-api.md).
