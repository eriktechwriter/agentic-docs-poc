...
- The company CA certificate is present in the Trust Store
  ...
  Check the certificates installed on android devices. A device installed with the specified certificate passes the check. For more information on certificates, see [Device posture certificate requirements](device-posture-certificatets.md).
