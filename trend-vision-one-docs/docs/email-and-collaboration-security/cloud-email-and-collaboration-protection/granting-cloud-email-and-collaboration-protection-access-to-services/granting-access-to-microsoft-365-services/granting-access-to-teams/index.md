...
3.  Create an app in Microsoft Entra ID for protecting Teams Chat.
    ...
    For details, see [Creating an Microsoft Entra ID app for Teams protection](./ms-entra-id-teams).
...
4.  Specify the app ID and secret, select the policy to enable automatically when the access grant is complete, and click Grant Permission.
    ...
    :::note
    - If for some reason the access token becomes invalid after the access grant, go to **Administration → Service Account** to create a new access token for the service account. For more information, see [Service account](../../../administration/service-account-cloud-apps).
...
- [Creating an Microsoft Entra ID app for Teams protection](./ms-entra-id-teams)
