...
7.  Manually clean up the remaining data.
    ...
    For details, see [Changes made under inline protection](../../getting-started/changes-made-by-cloud-email-and-collaboration-protection/changes-inline-protection) for Exchange Online (Inline Mode) or [Changes made under API-based protection](../../getting-started/changes-made-by-cloud-email-and-collaboration-protection/changes-api-based-protection) for other services.
