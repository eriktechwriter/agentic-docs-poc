...
6.  Manually remove the remaining data.
    ...
    For details, see [Changes made under API-based protection](../../getting-started/changes-made-by-cloud-email-and-collaboration-protection/changes-api-based-protection).
