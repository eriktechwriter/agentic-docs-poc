...
For details, see [Manual scan](./real-time-demand-scanning).
...
1.  Add at least one Advanced Threat Protection or Data Loss Prevention policy.
    ...
    For details, see [Adding advanced threat protection policies](./adding-advanced-threat-protection-policies) and [Adding Data Loss Prevention policies](../data-loss-prevention/adding-data-loss-prevention-policies).
