...
6.  Configure **Compliance Rule(s)** settings.
    ...
    1.  Add sensitivity labels and select the action.
        ...
        For details about the actions, see [Actions available for different services](../../advanced-threat-protection/actions-different-services).
...
8.  Configure **Notification** settings.
    ...
    :::note
    When specifying a notification message, include relevant tokens and edit the message content as desired. For details about tokens, see [Token list](../../advanced-threat-protection/token-list).
    :::

9.  Click the **Approved Lists** tab and configure the approved sender list.

    This approved sender list applies to Exchange Online, Exchange Online (Inline Mode), Gmail, and Gmail (Inline Mode).
