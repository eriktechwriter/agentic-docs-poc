...
2.  Add organizations if you decide to have more, for example, if you have two Microsoft Entra ID tenants to manage.
    ...
    For more information, see [Organization management](../administration/organization-management).
...
3.  Select an organization and grant access to the cloud services you manage under this organization.
    ...
    :::note
    For more information, see [Different ways to begin granting access](../granting-cloud-email-and-collaboration-protection-access-to-services/different-granting-access).
