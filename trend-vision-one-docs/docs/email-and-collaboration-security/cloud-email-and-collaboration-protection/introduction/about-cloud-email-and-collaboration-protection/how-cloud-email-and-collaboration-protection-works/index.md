...
:::note
In addition to API-based Protection, Cloud Email and Collaboration Protection also provides the option of Inline Protection for email services to block security risks before they can affect your organization. For details, see [Protection modes for email services](./protection-modes-for-email-services).
:::
...
- [Protection modes for email services](./protection-modes-for-email-services)
