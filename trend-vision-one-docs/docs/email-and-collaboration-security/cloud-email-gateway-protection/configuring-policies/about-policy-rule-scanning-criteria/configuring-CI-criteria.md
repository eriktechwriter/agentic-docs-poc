...
5.  Select the **Custom Correlated Intelligence** check box to enable anomaly detection by [custom correlation rules that you have created](../../configuring-administration-settings/policy-objects/managing-correlation-rules-and-detection-signals) for your environment.
