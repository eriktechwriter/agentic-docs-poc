...
3.  Complete web reputation security settings.
    ...
    2.  Select **Take action on messages containing URLs that have not been tested by Trend Micro** to block websites that might pose threats.
...
5.  Under **Time-of-Click Protection**, do the following:
    ...
    1.  Select **Enable Time-of-Click Protection** and click one of the following:
        ...
        Cloud Email Gateway Protection automatically bypasses Time-of-Click Protection for URLs to the following domains: **teams.microsoft.com**, **trendmicro.com**
        :::

    2.  Select **Apply to URLs in digitally signed messages** if necessary.
...
6.  Select **Enable the Web Reputation Approved List** to exclude URLs matching the specified domains or IP addresses from Web Reputation, Time-of-Click Protection, and Virtual Analyzer scanning.
    ...
    **Administration → Policy Objects → Web Reputation Approved List**
    ...
    For details, see [Managing the Web Reputation approved list](../../../configuring-administration-settings/policy-objects/managing-wrs-approved-list).
    :::

7.  Select **Enable the URL keyword exception list** if you want to exclude certain URLs that contain specified keywords from both Time-of-Click Protection and Virtual Analyzer scanning.
    ...
    **Administration → Policy Objects → URL Keyword Exception List**
    ...
    The protocol and domain parts of a URL will not be used for keyword match.

    For details, see [Managing the URL keyword exception list](../../../configuring-administration-settings/policy-objects/managing-url-keyword-exception-list).
    :::
