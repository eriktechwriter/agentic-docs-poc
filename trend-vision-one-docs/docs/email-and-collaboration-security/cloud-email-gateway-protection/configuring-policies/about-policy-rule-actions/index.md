...
- "Intercept" actions: Actions in this class intercept the message, preventing it from reaching the original recipient. Intercept actions include deleting the entire message and re-addressing the message.
  ...
  :::note
  "Intercept" actions are terminal actions. For more details about terminal actions, see [“Intercept” actions](./intercept-actions).
  :::
...
- [Specifying policy rule actions](./specifying-rule-actions)
- [intercept actions](./intercept-actions)
- [modify actions](./modify-actions)
- [monitor actions](./monitor-actions)
- [Encrypting outbound messages](./encrypting-outbound-messages)
- [About the send notification action](./about-the-send-notification-action)
