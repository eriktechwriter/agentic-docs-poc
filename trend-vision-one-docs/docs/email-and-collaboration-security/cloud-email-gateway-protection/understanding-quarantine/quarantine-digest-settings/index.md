...
- Digest of the new email messages that have been quarantined
  ...
  - Manage Messages: The links that users can click to apply actions to the quarantined message, including **Deliver**, **Deliver & Approve Sender**, **Block Sender**, **Approve Sender Domain**, **Block Sender Domain**, and **Preview**.
    ...
    - Quarantined message permissions configured on the **Quarantine → End User Quarantine Settings** screen
      ...
      For more information, see [Configuring end user quarantine settings](../configuring-euq-settings).

    - Inline action settings configured in the digest notification template

      For more information, see [Adding or editing a digest template](./adding-or-editing-digest-template).
...
For details about the “Source of Managed Accounts”, refer to [Configuring local account logon](../../configuring-administration-settings/end-user-management/logon-methods/config-local-logon-email-security) for end user management.

**Related information**

- [Adding or editing a digest rule](./adding-or-editing-digest-rule)
- [Adding or editing a digest template](./adding-or-editing-digest-template)
