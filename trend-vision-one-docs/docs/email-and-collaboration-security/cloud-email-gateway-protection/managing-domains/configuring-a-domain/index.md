...
1.  In the **General** section, verify your domain.
    ...
    To learn more about MX records, see [About mx records and Cloud Email Gateway Protection](../../faqs-and-instructions/mx-records).
...
3.  In the **Outbound Servers** section, complete the following configurations:
    ...
    1.  If your domain has SPF records, make sure the SPF record under the **Outbound Servers** section is also included.
        ...
        For details about adding SPF records, see [Adding SPF records](./adding-spf-records).
...
4.  If you currently use Microsoft 365, configure Microsoft 365 connectors to allow email traffic to or from Cloud Email Gateway Protection MTAs.
    ...
    See [Adding Microsoft 365 inbound connectors](./office-365-inbound-connectors).

    See [Adding Microsoft 365 outbound connectors](./add-365-outbound-connectors).

**Related information**

- [Adding SPF records](./adding-spf-records)
- [Adding Microsoft 365 inbound connectors](./office-365-inbound-connectors)
- [Adding Microsoft 365 outbound connectors](./add-365-outbound-connectors)
