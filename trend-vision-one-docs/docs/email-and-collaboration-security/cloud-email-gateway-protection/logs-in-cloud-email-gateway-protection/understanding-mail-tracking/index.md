...
- **Type**: The type of email traffic that you want to query.
  ...
  - **Blocked traffic**: The attempts to send messages that were stopped by connection-based filtering at the MTA connection level or by Cloud Email Gateway Protection incoming security filtering.
    ...
    If you select **Blocked traffic** as your search condition, you can further select a block reason. See [Blocked message details](../../working-with-the-dashboard/threats-tab/blocked-message-details) for details about the block reasons. A summary of email message traffic blocked by Cloud Email Gateway Protection is displayed.
...
- [Social engineering attack log details](./sea-log-details)
- [Business Email Compromise log details](./bec-log-details)
- [Antispam engine scan details](./antispam-engine-scan-details)
