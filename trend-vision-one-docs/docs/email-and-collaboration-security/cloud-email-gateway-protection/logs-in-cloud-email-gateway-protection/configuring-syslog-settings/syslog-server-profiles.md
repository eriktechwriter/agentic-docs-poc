...
4.  Specify or edit the following for a syslog server:
    ...
    - **Format**: Format in which logs are sent to the syslog server.
      ...
      - **CEF**
        ...
        For details about the Common Event Format (CEF) format, see [Content mapping between log output and CEF syslog type](./content-mapping-between-log-output-and-cef-syslog-type).
