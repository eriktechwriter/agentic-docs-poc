...
- [Syslog server profiles](./syslog-server-profiles)
- [Content mapping between log output and CEF syslog type](./content-mapping-between-log-output-and-cef-syslog-type)
