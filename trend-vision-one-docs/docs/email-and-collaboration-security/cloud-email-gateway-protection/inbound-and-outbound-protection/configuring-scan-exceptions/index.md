...
If any other scan exception is triggered, Cloud Email Gateway Protection takes the specified actions and will not stop scanning until encountering a terminal scan action. For details about terminal actions, see [intercept actions](../../configuring-policies/about-policy-rule-actions/intercept-actions).
:::

**Related information**

- [Scan exception list](./scan-exception-list)
- [Configuring "scan exceptions" actions](./configuring-scan-exceptions-actions)
