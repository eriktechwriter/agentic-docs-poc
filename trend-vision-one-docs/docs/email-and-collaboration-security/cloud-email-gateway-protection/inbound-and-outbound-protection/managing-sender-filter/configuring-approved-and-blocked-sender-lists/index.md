...
- **Approved Senders**
  ...
  Cloud Email Gateway Protection performs connection filtering, spam filtering, and Correlated Intelligence checks on emails from approved senders according to what you specify on the [Sender Filter Settings](../sender-filter-settings) tab.
...
- [Adding senders](./adding-senders-email-security)
- [Deleting senders](./deleting-senders)
- [Importing senders](./importing-senders)
- [Exporting senders](./exporting-senders)
