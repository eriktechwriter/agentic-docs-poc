...
1.  Verify migrated policy data under **Inbound Protection** and **Outbound Protection**.
    ...
    4.  Reorder policy rules.
        ...
        You can manually reorder the policy rules in each domain after migration if they do not meet your requirements. For details, see [Reordering policy rules](../../configuring-policies/reordering-policy-rules).
