...
- **Virtual desktops**: After updating to Trend Vision One, you must rebuild your golden image or Sysprep image if your endpoints meet all of the following criteria:
  ...
  For more information, see [Creating a golden image with the agent software](create-golden-agent-image.md).
:::
...
10. Allow some time for the update process to complete. You can access the [Endpoint Inventory](endpoint-inventory-intro-part.md) or [Product Instance](product-instance.md) app to monitor the update progress of your Standard Endpoint Protection Manager (replaces the old Apex Central as a Service console).

    [Learn more about feature mapping in Trend Vision One](apex-one-sep-feature-map.md)
