...
:::note
The **Network Inventory** screen and available actions may vary if you have connected your Deep Discovery Inspector appliances to **Network Inventory** using Deep Discovery Director. For more information, see [Network Inventory with Deep Discovery Director](network-inventory-ddd.md).
:::
