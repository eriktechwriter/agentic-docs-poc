...
4.  In the first list, select a property that all matching computers have, such as **Operating System**. For more information, see [Searchable properties](smart-folder-searchable-properties.md).
...
5.  Select the operator: whether to match identical, similar, or opposite computers, such as **CONTAINS**.
    ...
    Some operators are not available for all properties. For more information, see [Operators](smart-folder-operators.md).
...
9.  To verify, click your new smart folder. Verify that it contains all expected computers.
    ...
    If your account's role doesn't have the permissions, some computers won't appear, or you won't be able to edit their properties. For more information, see [Roles](user-roles-foundation-services.md).

    :::note
    To focus your search using sub-folders, see [Focus your search using sub-folders](smart-folder-subfolders.md).

    To automatically create sub-folders for AWS, Azure, or Google Cloud, see [Automatically create sub-folders](automatically-create-subfolders.md).
    :::
