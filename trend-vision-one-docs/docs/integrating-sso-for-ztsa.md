...
3.  To configure risk control rules, you must also grant data upload permission for [Configure Microsoft Entra ID](configuring-saml-ad.md) in **Threat and Exposure Management → Data source**.
