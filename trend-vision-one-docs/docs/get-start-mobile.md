...
title: Get started with Trend Vision One Mobile
---
...
3.  If you want to receive notifications from Trend Vision One, go to [Receive notifications from the Trend Vision One console](receive-notifications-console.md) to configure related settings.
