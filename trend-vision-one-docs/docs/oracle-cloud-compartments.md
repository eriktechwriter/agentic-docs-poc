...
- [Connect Oracle Cloud Infrastructure (OCI) compartments](connecting-updating-oci.md "Add your Oracle Cloud Infrastructure (OCI) compartments to provide visibility into your cloud environment.")
- [Manage compartment settings](compartment-settings.md "Manage connected Oracle Cloud Infrastructure (OCI) compartment settings and update deployed resources.")
- [Oracle Cloud Infrastructure (OCI) features and permissions](oracle-features-permissions.md)
- [Oracle Cloud Infrastructure (OCI) supported regions and limitations](oracle-supported-regions.md "Supported regions and deployment limitations for connecting your OCI compartments.")
