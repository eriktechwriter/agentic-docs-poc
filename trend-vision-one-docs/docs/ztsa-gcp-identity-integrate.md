...
3.  Grant the relevant permissions associated with **Zero Trust Secure Access** by confirming the permissions in the [Google Admin console](gcp-identity-integration.md).

4.  In the Google Admin console, [Configure Google Cloud Identity](config-google-cloud-saml.md).
