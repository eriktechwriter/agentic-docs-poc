...
title: Connect a Google Cloud project
---
...
:::warning[Important]
If you have access to the Agentless Vulnerability and Threat Detection feature for Google Cloud, see [Connect a Google Cloud project (January 2025 update)](add-google-cloud-project.md) to connect your project.
