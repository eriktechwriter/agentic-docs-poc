...
2.  In the **Enrollment** section, follow the onscreen guide to enable the Mobile Security for Business app and create an app configuration policy for Mobile Security for Business in your MDM solution.
    ...
    :::note
    - The specific operations vary from MDM to MDM. This guide uses Ivanti as an example to illustrate the operations. For details, see [Managed configuration for Ivanti (MobileIron)](managed-config-ivanti-mobileiron.md).
