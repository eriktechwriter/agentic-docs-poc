...
- [Version Control Policies](security-update-policies.md): create and configure policies to manage agent update settings, such as version control for both the agent program and detection components.
