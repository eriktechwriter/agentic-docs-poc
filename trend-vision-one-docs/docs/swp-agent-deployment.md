...
:::note
Trend Micro recommends that you configure a [default policy](create-policies.md) and use the [agent-initiated activation](agent-initiated-activation.md) feature before deploying agent packages to simplify the connection process.
:::
