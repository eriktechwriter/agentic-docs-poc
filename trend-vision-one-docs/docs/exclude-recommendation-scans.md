...
Exclude rules from recommendations for an individual computer or a group of computers by [creating policies](create-policies.md).
...
6.  Do one of the following:
    ...
    - For rules, set **Exclude from Recommendations** to **Yes** or **Inherited (Yes)** (see [policies, inheritance, and overrides](policies-inheritance-overrides.md)).
