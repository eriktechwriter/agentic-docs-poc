...
1.  Connect to an Active Directory server to synchronize the user and endpoint information.
    ...
    For more information, see [Configuring Active Directory Synchronization](configuring-synch-ad.md).

2.  Configure the compliance indicator settings.

    For more information, see the following topics:

    - [Configuring the Antivirus Pattern Compliance Indicators](antivirus-pattern-compliance.md)

    - [Configuring the Data Loss Prevention Compliance Indicator](config-dlp-compliance-indicator.md)

3.  (Optional) Customize endpoint and user grouping based on Active Directory sites and reporting lines.

    For more information, see [Endpoint and User Grouping](endpoint-user-grouping.md).
...
4.  Go to the **Dashboard** to view the compliance information.
    ...
    - [Security Posture Tab](security-posture-apex-tab.md)

    - [Working with Widgets](working-widgets.md)
    :::
