...
:::warning[Important]
Resource updates are for AWS accounts connected using terraform. If you connected your account using CloudFormation, see [AWS Stack Update](stack-update.md).
:::
