...
change_date: 2025-03-21T00:00:00Z
is_what_new: true
...
For more information, see the `WHATS-NEW.md` file included with the binary and the `--distro` flag information in [Artifact Scanner CLI](artifact-scanner-cli.md).
