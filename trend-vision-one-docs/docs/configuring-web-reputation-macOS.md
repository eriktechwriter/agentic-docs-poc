...
5.  To configure a policy for external Trend Vision One Endpoint Security agents:
    ...
    2.  Select **Enable Web Reputation policy**.
        ...
        :::note
        If an agent only has an IPv6 address, read the IPv6 limitations for Web Reputation queries in [Pure IPv6 Agent Limitations](pure-ipv6-agent-limitations.md).
        :::
