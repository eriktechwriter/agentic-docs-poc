...
If for some reason the access token becomes invalid, go to **Administration → Service Account** to create a new access token for the service account. For more information, see [Service account](service-account-cloud-apps.md).
