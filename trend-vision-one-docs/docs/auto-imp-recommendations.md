...
You can configure Server & Workload Protection to automatically implement [recommendation scan](recommendation-scans-intro.md) results except for the following rules:
...
3.  On the **General** tab, under **Recommendations**, choose one of the following:
    ...
    - **Yes**
    - **Inherited (Yes)** (See [policies, inheritance, and overrides](policies-inheritance-overrides.md).)
