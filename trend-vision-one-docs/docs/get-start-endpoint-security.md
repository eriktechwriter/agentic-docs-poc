...
2.  Configure Endpoint Security and provision your endpoint protection solutions.
    ...
    - For new Trend Micro customers, see [Setting up Endpoint Security for new Trend Micro customers](setup-endpoint-security-for-new.md).

    - For current Trend Micro customers, see [Update Trend Micro Endpoint Solutions](update-endpoint-solutions.md).

      :::tip
      If you want to experience the new Trend Vision One Endpoint Security before updating all your endpoint protection solutions, see [Evaluate Trend Vision One Endpoint Security](evaluate-endpoint-security.md).
      :::
...
4.  [Manage your agent deployments](manage-your-agent-deployments.md) by:
    ...
    - [Setting up endpoint groups](manage-endpoint-groups.md)
...
- [Update Trend Micro Endpoint Solutions](update-endpoint-solutions.md)
