...
Errors can occur if the SDK that you are using is not compatible with Server & Workload Protection, or when you use a newer version of the SDK to run scripts that were developed with an older version of the SDK. For more information, see the [SDK Version Compatibility](sdk-version-compatibility.md) guide.
