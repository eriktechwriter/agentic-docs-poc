...
8.  Under **Ignored Peers**, do any of the following:
    ...
    - To add ignored peers to skip SPF check for a specific sender, specify the sender's domain name, IP address or CIDR notation in the text box and click **Add**.
