...
:::tip
The notification email message sent to "monitor" actions can be customized using the variables shown in [Policy Rule Tokens/Variables](tokens.md).
:::

**Related information**

- [Using the bcc action](using-bcc-action.md)
