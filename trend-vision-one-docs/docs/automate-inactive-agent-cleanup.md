...
- [Ensure computers that are offline for extended periods of time remain protected with Server & Workload Protection](ensure-computers-remain-protected.md)

- [Audit logs for computers removed by inactive agent removal](audit-logs-inactive-agent-removal.md)
