...
12. In the **Trusted IP addresses** field, add the URL of your Tanium server and the Trend Vision One IP addresses for your region. See [Cyber Risk Exposure Management regional IP addresses](asrm-regional-ip-addresses.md) for your regional IP addresses.
