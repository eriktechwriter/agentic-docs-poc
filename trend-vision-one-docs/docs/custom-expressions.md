...
Administrators can choose from several criteria when creating expressions. An expression must satisfy the chosen criteria before Data loss prevention subjects it to a DLP rule. For details about the different criteria options, see [Criteria for custom expressions](criteria-for-custom-expressions.md).
...
- [Adding a custom expression](adding-custom-expression.md)
