...
- (Optional) **Antispam Engine Scan Details**: The details of the Antispam Engine scan for the message. For details, see [Antispam engine scan details](antispam-engine-scan-details.md).

**Related information**

- [Predictive Machine Learning log details](pml-log-details.md)
