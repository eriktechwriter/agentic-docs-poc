...
- [Attack Discovery Token Variables](attack-discovery-token-variables.md)
- [Advanced Threat Activity Token Variables](advthreat-activity-token-vars.md)
- [C&C Callback Token Variables](c-c-callback-token-variables.md)
- [Content Policy Violation Token Variables](content-violation-token-vars.md)
- [Data Loss Prevention Token Variables](dlp-token-variables.md)
- [Known Threat Activity Token Variables](known-threat-activity-token.md)
- [Network Access Control Token Variables](network-access-token-vars.md)
- [Web Access Policy Violation Token Variables](web-access-token-vars.md)
