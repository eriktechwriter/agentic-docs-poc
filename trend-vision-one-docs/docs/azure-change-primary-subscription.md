...
2.  Use this command instead of the one provided in the Trend Vision One console when initiating TerraForm deployment. For more information, see [Connect an Azure Management Group](adding-azure-management-group.md).
