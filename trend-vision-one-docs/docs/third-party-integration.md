...
- [Jira Cloud integration (for Case Management)](jira-cloud-integration.md)
- [Kong Gateway](kong-gateway.md)
...
- [ServiceNow CMDB integration](servicenow-cmdb-integration.md "Gain increased visibility into the relationships between and attributes of your devices by integrating ServiceNow CMDB with Trend Vision One.")
