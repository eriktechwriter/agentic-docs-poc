...
You should have already verified that your environment is [set up to use the API using Bash or PowerShell](set-up-use-bash-or-powershell.md).
...
If you don't know the ID of the policy, you can use the [Search for a Policy](search-for-policy-bash-powershell.md) recipe to obtain it.
...
- [Set up to use Bash or PowerShell](set-up-use-bash-or-powershell.md)

- [Modify a computer](https://automation.trendmicro.com/cloudone/workload-security/) (API Reference

- [Create and configure a policy](create-configure-policy.md) (Guide) – “Assign a policy to a computer” section

- [Configure computers to override policies](override-policies-computer.md) (Guide)

- [Search for Resources](search-for-resources.md) (Guide) - "Limit search results and paging" section
