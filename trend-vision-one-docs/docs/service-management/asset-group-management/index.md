...
- View the [cyber risk subindex](../../cyber-risk-exposure-management/cyber-risk-overview/risk-overview/get-started-risk-subindexes) for individual groups within your organization to identify your higher-risk asset groups in Cyber Risk Overview

- Evaluate your asset groups' pass rates based on [compliance frameworks](../../cyber-risk-exposure-management/cyber-governance-risk-compliance/compliance-management/compliance-asset-groups-tags) in Compliance Management
...
- [Create an asset group](./creating-asset-group "Define an asset group to assign an Asset group tag value to the group's assets.")
