...
To begin managing log data in a log repository, you must have one or more deployed Service Gateways with the [Third-Party Log Collection service installed](../../../../../agentic-siem-xdr/data-source-and-log-management/data-sources-and-retention/third-party-log-collection/install-tplc-service).
...
5.  [Add one or more collectors](../../../../../agentic-siem-xdr/data-source-and-log-management/data-sources-and-retention/third-party-log-collection/collectors/create-collector) to the log repository to begin ingesting and retaining log data from your third-party data sources.
