...
:::tip
For information on defining cloud projects using automated tagging rules, see [Define and manage projects](../../../cyber-risk-exposure-management/security-posture-management/cloud-risk-management/cloud-security-posture/project-centric-overview/define-manage-projects).
:::
