...
2.  If you have not yet configured Active Directory, go to **Workflow and Automation → Third-Party Integrations** to [configure Active Directory](../../../workflow-and-automation/third-party-integrations/active-directory-on-premises-integration).
...
5.  Click **Save**.
    ...
    :::warning[Important]
    If you selected the Asset group tag as the platform tag property for the mapping, Trend Micro recommends going to Asset Group Management to [create asset groups](../../asset-group-management/creating-asset-group) associated with the tag values synced from Active Directory.
