...
For further details, see [What is File Security?](what-is-file-security.md)

Like other apps in Trend Vision One, File Security requires [credit allocation](credit-req-for-apps-services.md) for access to the complete feature. Click **Credits & Pay-As-You-Go** to see credits allocated to File Security. Click ![Credit Settings](/images/credit-settings-gray=333b68c1-089e-4400-a4c4-09459f617867.webp) to manage credit settings for File Security.
...
- [Create a Workbench alert for File Security](fs-create-workbench-alert.md)
- [File Security FAQs](file-security-faqs.md)
- [Troubleshoot File Security](troubleshooting-file-security.md)
