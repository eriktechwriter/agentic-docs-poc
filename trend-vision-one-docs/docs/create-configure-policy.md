...
- [Configure Firewall](configure-firewall-sdk.md)
- [Configure Intrusion Prevention](configure-intrusion-prevention-sdk.md)
- [Configure Anti-Malware](configure-anti-malware-sdk.md)
- [Configure Web Reputation](configure-wrs-server-workload.md)
- [Configure Device Control](configure-device-control-sdk.md)
- [Configure Application Control](config-app-control-policy.md)
- [Configure Integrity Monitoring](configure-integrity-monitoring-sdk.md)
- [Configure Log Inspection](config-log-inspection-swp.md)
:::

Before you use the API, you should understand the essential concepts about policies. For background information, see [Create policies to protect your computers and other resources](create-policies.md).
...
For information about searching, see [Search for Resources](search-for-resources.md). For information about authenticating API calls, see [Authenticate with Server & Workload Protection](send-your-first-request-using-api.md).
...
:::tip
You can override a policy at the computer level. See [Configure Computers to Override Policies](override-policies-computer.md).
:::
...
For a list of policy and default policy settings, see [Default policy, policy, and computer settings](settings-reference.md) in the Settings Reference.
...
For more information about the policy hierarchy and inheritance, see [Policies, inheritance, and overrides](policies-inheritance-overrides.md).
...
The settings of the `DefaultPolicySettings` and `PolicySettings` classes are identical, with a few exceptions. (See [Default policy, policy, and computer settings](settings-reference.md) in the Settings Reference.)
...
When you retrieve a setting value, identify the setting by name. The value is returned as a `SettingValue` object. For a list of policy and default policy settings, see [Default policy, policy, and computer settings](settings-reference.md) in the Settings Reference.
...
For an example of configuring a system setting, see [Configure Server & Workload Protection System Settings](configure-system-settings.md).
...
For example, the [Set the real time Anti-Malware scan configuration](configure-anti-malware-sdk.md) example overrides the realTimeScanConfigurationID for a policy. To reset the property to inherit the value from the parent policy, set `realTimeScanConfigurationID` to `0`.
...
For example, the [Turn on Application Control](config-app-control-policy.md) example overrides the status property of the Application Control module to `on` for a policy. To reset the setting to inherit the value from the parent policy, you set the status value to `inherited`.
...
1.  Obtain all of the overrides for the policy's rule. Use the `describe` method of a module-specific rules details class with the `overrides` parameter set to `true`. Save the results. (See [About the Overrides Parameter](overrides-parameter.md).)
