...
2.  Click **Add Project** .
3.  Specify the general information for the project and click **Next**. For more details, see [Adding a Google Cloud project.](adding-google-cloud-project.md) The **Features and Permissions** screen appears.
...
2.  Click **Add Project** .
3.  Specify the general information for the project and click **Next**. For more details, see [Connect an Azure subscription](adding-azure-subscription.md) The **Features and Permissions** screen appears.
4.  In **Features and Permissions**, enable **Real-Time Posture Monitoring.** The **Launch** screen appears.
5.  Follow the instructions on the **Launch** screen.
6.  Click on **Done** to save changes.
