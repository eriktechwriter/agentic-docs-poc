...
Profiles allow your organization to store and manage rule settings in reusable templates (e.g. rule settings for a specific environment type, security level, or application). You can apply a profile to one or more [Cloud Accounts](./misconfiguration-and-compliance/manage-cloud-accounts/cloud-accounts-cloud-posture-setup) and also apply multiple profiles to an account to achieve the desired outcome for your rule settings.
...
3.  You can [configure every rule](./misconfiguration-and-compliance/misconfiguration-and-compliance-rules/configurations/rules-configuration) within a profile as per your requirements.
...
2.  Select account(s) from the list or search for it using [name, environment](./misconfiguration-and-compliance/manage-cloud-accounts/account-settings/cloud-account-general-settings), or [account tags](./misconfiguration-and-compliance/manage-cloud-accounts/account-settings/manage-cloud-account-tags/cloud-account-tags).
