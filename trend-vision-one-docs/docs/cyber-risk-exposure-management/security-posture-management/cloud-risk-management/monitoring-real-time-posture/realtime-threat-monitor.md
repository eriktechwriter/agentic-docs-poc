...
- Ensure that you have CloudTrail enabled. For help, see the Cloud Risk Management Rule [CloudTrail Enabled](https://www.trendmicro.com/cloudoneconformity/knowledge-base/aws/CloudTrail/cloudtrail-enabled.md).
...
2.  Click **Add Project** .
3.  Specify the general information for the project and click **Next**. For more details, see [Adding a Google Cloud project.](../../../../cloud-security/cloud-accounts/google-cloud-projects/connect-and-update-google-cloud-projects/adding-google-cloud-project) The **Features and Permissions** screen appears.
...
2.  Click **Add Project** .
3.  Specify the general information for the project and click **Next**. For more details, see [Connect an Azure subscription](../../../../cloud-security/cloud-accounts/azure-subscriptions/connect-and-update-azure-subscriptions/adding-azure-subscription) The **Features and Permissions** screen appears.
4.  In **Features and Permissions**, enable **Real-Time Posture Monitoring.** The **Launch** screen appears.
5.  Follow the instructions on the **Launch** screen.
6.  Click on **Done** to save changes.
