...
1.  [Activity Dashboard](../activity-dashboard) - identify unusual user activities

2.  [Monitoring Dashboard](../monitoring-dashboard) - get an in-depth record of all events in an AWS account
...
1.  Follow the instructions on [setting up Real-Time Posture Monitoring](../realtime-threat-monitor)
