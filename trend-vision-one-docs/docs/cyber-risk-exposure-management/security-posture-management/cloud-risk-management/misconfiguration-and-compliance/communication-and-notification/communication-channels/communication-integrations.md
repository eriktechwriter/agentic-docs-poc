...
1.  In **Misconfiguration and Compliance → Settings → Communication Settings**, Click **Update communication settings** and configure the communication channel you want to update.
    ...
    - [PagerDuty Communication](./pagerduty-communication)
    - [Jira Communication](./jira-communication/jira-integration)
    - [Zendesk Communication](./zendesk-communication)
    - [ServiceNow Communication](./servicenow-communication)
    - [Amazon SNS Communication](./amazon-sns-communication)
    - [Microsoft Teams](./microsoft-teams-communication)
    - [Webhook Communication](./webhook-communication)
