...
- [Cloud Posture Report](./cloud-posture-report)
- [CIS AWS Foundations](../compliance/compliance-and-cloud-risk-management/compliance-in-cloud-posture)
...
Expanding all the reports displays a history of the configured report. Users can also download reports from the list available in [All Generated Reports](./generate-download-report) or [Generate](./generate-download-report) reports on demand.
...
5.  [Filter checks](../misconfiguration-and-compliance-rules/search/filter-and-search/filter-search)

6.  *Save Configuration* - the newly created report will be added to the Reports list

7.  You can also [Generate](./generate-download-report) reports on demand without saving the configuration
