...
You can generate [Reports](./rules-status-reports) on demand and download them in the following formats:
...
:::note
The format of download for\_ [Compliance and Cloud Risk Management Reports](../compliance/compliance-reports) may also be dependent on the formatting guidelines of the standard or framework.
:::
