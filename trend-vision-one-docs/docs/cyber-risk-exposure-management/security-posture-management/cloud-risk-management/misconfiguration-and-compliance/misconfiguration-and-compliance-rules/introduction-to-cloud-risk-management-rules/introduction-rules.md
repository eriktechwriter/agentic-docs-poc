...
Cloud Risk Management's rules cover the [6 categories](../rule-categories) of security and governance best practices:
...
1.  Periodically on your [added Accounts](../../manage-cloud-accounts/cloud-accounts-cloud-posture-setup) by the [Compliance scan](../../compliance-scan-help/cloudIdentityBot), or
...
See [Rule Configuration](../configurations/rules-configuration).

## Rule settings {#rule-settings}

There are common rule settings (such as new rule behavior, and rule configurations) that can be managed at the [Cloud Accounts](../../manage-cloud-accounts/cloud-accounts-cloud-posture-setup) level.
...
Cloud Risk Management runs [Checks](../checks/model-check/model-check) for each Rule against the Service and or Service resources, the Rule belongs to. Checks can *fail* or *succeed* and are captured by Cloud Risk Management's numerous [reporting tools](../../reports/rules-status-reports).
...
Provides a count for different check statuses. See [Model: Check](../checks/model-check/model-check) for more info on each status.

## Not scored {#not-scored}

Some rules are documented by Cloud Risk Management but cannot be tested against your cloud infrastructure due to not being applicable to cloud infrastructure or limitations of the data provided by the cloud provider. Rules that cannot be tested are identified as *Not Scored*. For more information see [Model Check](../checks/model-check/model-check).
