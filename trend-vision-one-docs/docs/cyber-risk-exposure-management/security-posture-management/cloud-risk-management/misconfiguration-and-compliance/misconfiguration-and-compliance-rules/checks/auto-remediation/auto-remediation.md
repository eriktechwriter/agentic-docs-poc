...
2.  Create a working copy of Auto-remediation repository:
    ...
    :::note
    !!! note "" For self-healing capabilities, we recommend deploying auto-remediation in the same region as your AWS account. Detection of Check failures is independent of the region of deployment as it is performed by [RTM](../../../../monitoring-real-time-posture/real-time-posture-monitoring/real-time-threat-monitoring) and [Cloud Risk Management Bot](../../../compliance-scan-help/cloudIdentityBot).
    ...
    10\. Integrate [Amazon SNS Communication](../../../communication-and-notification/communication-channels/amazon-sns-communication) channel on the Cloud Risk Management platform and select the notifications you wish to enable:
...
1.  Verify that the [Communication trigger](../../../communication-and-notification/communication-settings/communication-triggers) that you selected while configuring an [Amazon SNS channel](../../../communication-and-notification/communication-channels/amazon-sns-communication) is:
...
4.  Click *Create Security Group*
    ...
    - If you have enabled [Real-Time Threat Monitoring](../../../../monitoring-real-time-posture/real-time-posture-monitoring/real-time-threat-monitoring) you will instantly see an entry in the [Activity Dashboard](../../../../monitoring-real-time-posture/activity-dashboard) and [Monitoring Dashboard](../../../../monitoring-real-time-posture/monitoring-dashboard) when Auto-remediation kicks in.
    - If you have only enabled [Automatic notifications](../../../communication-and-notification/communication-settings/toggle-automatic-notifications), the Check failure will be automatically resolved.

## Resolution using Manual notifications {#resolution-using-manual-notifications}

If you have only enabled [Manual notifications](../../../communication-and-notification/communication-settings/toggle-manual-notifications), follow the steps below to resolve the failure:

### Procedure {#procedure-4}

1.  Go to [All Checks report](../../../reports/all-checks-report) and filter rules by:
