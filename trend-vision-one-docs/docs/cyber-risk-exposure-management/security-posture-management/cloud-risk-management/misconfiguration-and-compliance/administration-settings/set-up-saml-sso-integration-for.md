---
slug: trend-vision-one-set-up-saml-sso-integration-for
sidebar_position: 3
...
- Which [roles](../manage-users/roles-and-permissions/roles-permissions) are you planning to use via SSO? (Admin, Power User, Read-only, and Custom) {: .note }
