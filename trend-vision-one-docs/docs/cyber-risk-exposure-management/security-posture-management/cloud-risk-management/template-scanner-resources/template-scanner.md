...
Template Scanner currently supports the following cloud providrers. For details on specific coverage support for each cloud provider, see: [Template Scanner Coverage](./template-scanner-coverage)
