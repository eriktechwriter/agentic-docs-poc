...
- Service Gateways used for scanning must be deployed to a public cloud platform such as AWS or Microsoft Azure and running in order to successfully scan external assets. To learn more, see [Deploy a Service Gateway virtual appliance with AWS](../../../../workflow-and-automation/service-gateway-management/getting-started-with-service-gateway/deployment-guides/deploy-service-gateway-aws) and [Deploy a Service Gateway virtual appliance with Microsoft Azure](../../../../workflow-and-automation/service-gateway-management/getting-started-with-service-gateway/deployment-guides/service-gateway-azure).
