...
To learn more, see [Attack path components](./attack-path-components).
...
:::note
If no attack paths are identified in your environment, one or more of the required components have not been detected. To learn more, see [Attack path components](./attack-path-components).
:::
...
- [Key attack path components](./attack-path-components "Learn about the types of components found in potential attack paths and common component characteristics.")
