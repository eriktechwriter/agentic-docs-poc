...
3.  If you are deploying a Server & Workload Protection agent, configure **Agent-Initiated Activation**.
    ...
    3.  Select **Allow Trend Vision One Virtual Desktop Infrastructure (VDI) support and cloned virtual machines**.
        ...
        :::warning[Important]
        Enabling this feature locks other Agent-Initiated Activation settings. For more information, see [Agent settings](agent-settings.md).
        :::
...
5.  Download the Agent Installer package you want to use and install the agent on the source desktop.
    ...
    - [Deploy agents with Standard Endpoint Protection features](sep-agent-deployment.md)

    - [Deploy agents with Server & Workload Protection features](swp-agent-deployment.md)

    - [Deploy agents with only Endpoint Sensor features](endpoint-sensor-agent-deployment.md)
