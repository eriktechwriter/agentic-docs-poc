...
See [Integrity monitoring rules language](integrity-monitoring-language-swp.md) for a general description of include for their allowed attributes and sub elements.
