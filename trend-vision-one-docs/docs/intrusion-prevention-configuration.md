...
- [Deploy Virtual Patch filter policies to TippingPoint SMS](deploy-virtual-patch-filters-sms.md "Mitigate your CVE risks directly from the Network Security app by setting and deploying filter policies on TippingPoint SMS profiles.")
