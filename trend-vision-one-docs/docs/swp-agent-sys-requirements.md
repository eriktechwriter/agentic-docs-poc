...
If you wish to only connect a Deep Security Agent directly to your Server & Workload Protection Manager, see [Agent platform compatibility](agent-platform-compatibility.md) for supported agents.
...
- [Linux Secure Boot support](linux-secure-boot-support.md)
