...
- *Modify access rights:* Modify the role that is associated with the API key or associate the API key with a different role. (See also [Control Access Using Roles](control-access-using-roles.md).)
