...
To learn about the policy rule used to encrypt outbound messages, see [Encrypting outbound messages](encrypting-outbound-messages.md). To learn more about how to enable outbound protection for a managed domain, see step 5 in [Adding a domain](adding-domain.md).

Cloud Email Gateway Protection evaluates outgoing messages against regulatory compliance templates defined in DLP policies to prevent data leakage. For details about DLP, see [Data Loss Prevention](data-loss-prevention-email-security.md).
