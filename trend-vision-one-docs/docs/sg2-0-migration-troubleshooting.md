...
Manually unregister the source Service Gateway 1.0 appliance and use the [Command Line Interface](service-gateway-cli-commands.md) to modify the IP address in the Service Gateway 2.0 appliance.
...
Use the [Command Line Interface](service-gateway-cli-commands.md) to modify the IP address in the Service Gateway 2.0 appliance.
