...
- **Scenario 1:** AWS cloud deployment
  ...
  For more information on AWS deployment, see [Deploy a Service Gateway virtual appliance with AWS](deploy-service-gateway-aws.md).
...
- **Scenario 2:** Azure cloud deployment
  ...
  For more information on Azure deployment, see [Deploy a Service Gateway virtual appliance with Microsoft Azure](service-gateway-azure.md).
...
- **Scenario 3:** Google Cloud Platform (GCP) deployment
  ...
  For more information on GCP deployment, see [Deploy a Service Gateway virtual appliance with GCP](sg-virtual-app-gcp.md).
