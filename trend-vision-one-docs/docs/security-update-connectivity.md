...
1.  To verify that both a route exists and that the [relay port number](swp-port-numbers.md) is open, enter the command:
...
3.  If you use a proxy server, in Server & Workload Protection, confirm that the [proxy settings](configure-proxies-server-workload.md) are correct.
