...
- See [Upgrade the agent](upgrade-agent.md).

Next, upgrade your relays:

- See [Upgrade a relay](upgrade-relay.md).

## Next steps (deploy new agents and relays) {#next-steps-deploy-new-agents-and-relays}

After setting up your TLS 1.2 environment, if you decide to [Use a deployment script](deployment-scripts-add-computers.md) (among other methods) to deploy new agents and relays, adhere to the guidelines below.
