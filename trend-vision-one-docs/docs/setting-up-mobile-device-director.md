...
4.  On the **Enrollment Settings** screen, configure Android or iOS/iPadOS device enrollment.
    ...
    - Click the **Android Enrollment** tab and [enroll Android devices](enrolling-android-devices.md).

    - Click the **iOS/iPadOS** tab and [enroll iOS/iPadOS devices](enrolling-ios-ipados-devices.md).
...
5.  Grant **Mobile Security** permissions on your Microsoft Entra ID data.
    ...
    4.  Review the permissions required and click **Accept**.
        ...
        **Mobile Security** can access your Microsoft Entra ID data in the target tenant and send device enrollment invitations to the end users.
        ...
        :::note
        **Mobile Security** can access your Microsoft Entra ID data in one tenant only. To allow **Mobile Security** to access Microsoft Entra ID data in another tenant, block permissions on the current tenant and grant permissions on a new tenant in the **Microsoft Entra ID** section of the **Third-Party Integrations** app.
        :::
...
- [Enroll Android devices](enrolling-android-devices.md "Enroll Android devices in Mobile Device Director by connecting to managed Google Play and configuring enrollment settings.")
- [Enroll iOS/iPadOS devices](enrolling-ios-ipados-devices.md "To enroll iOS/iPadOS devices in Mobile Device Director, upload an Apple MDM push certificate and then email users enrollment instructions.")
