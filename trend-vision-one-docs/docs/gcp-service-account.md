...
:::tip
For information on why you might want to create a GCP service account to use with Server & Workload Protection, see [What are the benefits of adding a GCP account?](add-google-cloud-platform-account.md)
:::
...
You are now ready to add the GCP account you just created to Server & Workload Protection. Proceed to [Add a Google Cloud Platform account](add-google-cloud-platform-account.md).
...
5.  After creating the GCP service accounts, add them to Server & Workload Protection one by one, following the instructions [Add a Google Cloud Platform account](add-google-cloud-platform-account.md).
