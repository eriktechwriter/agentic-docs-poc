...
For general best practices related to events, see [Events in Server & Workload Protection](event-logging.md).
...
:::note
For system events related to log inspection, see [System events](system-events.md).
:::
...
- [Syslog message formats](syslog-message-formats-2.md)
- [Error: Log Inspection Rules Require Log Files](error-log-inspection-rules-files.md)
