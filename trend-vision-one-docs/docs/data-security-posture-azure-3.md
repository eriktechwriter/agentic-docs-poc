...
You can enable Data Security Posture on both new and existing Azure subscriptions in **Cloud Accounts**. For more information on Data Security Posture, see [Data Security Posture](data-posture.md).
