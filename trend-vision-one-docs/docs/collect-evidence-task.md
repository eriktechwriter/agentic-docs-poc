...
After [creating a workspace and adding endpoints to the workspace](workspaces.md) in **Forensics**, you can collect detailed evidence from potentially compromised endpoints for internal investigations into critical incidents that occurred on your network and may require further attention.
...
3.  Collect evidence from the desired endpoints.
    ...
    3.  Specify the [evidence types](windows-evidence-types.md) you want to collect.
