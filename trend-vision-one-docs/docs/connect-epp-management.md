...
You can evaluate the new Trend Vision One Endpoint Security by moving some of your agents from your connected endpoint protection products to Standard Endpoint Protection or Server & Workload Security. For more information, see [Evaluate Trend Vision One Endpoint Security](evaluate-endpoint-security.md).

You can also [update your connected endpoint protection products](update-endpoint-solutions.md) to Trend Vision One Endpoint Security.
