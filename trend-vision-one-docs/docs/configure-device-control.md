...
[Exceptions](overview-section-computer-editor.md) can be added to a policy or a computer (in the computer's *Device Control* tab \> *Exceptions*) to allow for full access for the device even when the action is set to "Read-Only" or "Block".
