...
- A [deployed Service Gateway virtual appliance](deployment-guides.md) with the Network Vulnerability Scanner service version 1.1.0 or later installed
...
- [Discovery scan](discover-scan.md):
...
- [Vulnerability scan](vuln-scan.md):
  ...
  - Requires credentials such as SSH authentication private keys or passwords
    ...
    - You can configure and securely store authentication information for reuse in scans in the [Credential Vault](nvs-credential-vault.md).

- [External attack surface scan](easm-scan.md):
...
Results from scans can be downloaded from **Scan reports** or viewed and managed in asset profile screens in **Attack Surface Discovery** or on risk event lists in **Threat and Exposure Management**.You can find vulnerabilities and misconfigurations found during scans by filtering for **Data source: Trend Vision One Network Vulnerability Scanner**.
