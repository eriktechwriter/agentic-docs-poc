...
For more information on how to set up a VPC and subnet, refer to the [Amazon documentation](https://docs.aws.amazon.com/index.md).
:::
...
16. Click **Create security group**.
    ...
    Your environment should now be ready to [launch the Virtual Network Sensor instance](launching-ami-instance.md).
