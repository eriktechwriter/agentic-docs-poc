...
After completing a scan, [File Security displays scan results](scans-tags-aws.md) immediately so you can take action right away to reduce risk and fulfill compliance requirements. Scan results include custom information that is passed to the SDK so you can take further action.
