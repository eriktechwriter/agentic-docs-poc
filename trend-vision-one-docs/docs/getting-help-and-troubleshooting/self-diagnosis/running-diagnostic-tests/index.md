...
3.  Run the diagnostic test on the desired endpoints.
    ...
    1.  Use the search field to locate the endpoints to diagnose.
        ...
        You can search endpoints by name, IP address or [agent GUID](./finding-endpoint-information).
    ...
    :::tip
    You can monitor diagnostic tests in the [Test Results](../test-results-tab) tab.
    :::

**Related information**

- [Finding endpoint information](./finding-endpoint-information "Locate the endpoint information required to run a diagnostic test in the Self-Diagnosis app.")
