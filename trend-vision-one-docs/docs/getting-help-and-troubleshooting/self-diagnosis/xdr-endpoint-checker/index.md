...
- [Using XDR Endpoint Checker from a web browser](./use-xdr-checker-browser "Determine why a Windows endpoint does not connect to Trend Vision One using the XDR endpoint checker tool.")
- [Using XDR Endpoint Checker from the command line](./use-xdr-checker-cli "Use the XDR endpoint checker tool in endpoints that do not have a supported web browser.")
