...
4.  Under **Compliance Settings**, specify the compliance policy criteria and click **Next**.
    ...
    - [Android compliance policy criteria (user-owned devices with a work profile)](android-compliance-user-owned.md)

    - [Android compliance policy criteria (company-owned, fully managed, and dedicated devices)](android-compliance-policy-dedicated.md)

    - [iOS compliance policy criteria](ios-compliance-criteria.md)
