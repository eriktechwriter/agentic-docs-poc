...
3.  Follow the steps in [Connect an Alibaba Cloud account](adding-alibaba-cloud-account.md) to redeploy the Terraform script.
...
3.  Follow the steps in [Connect an Alibaba Cloud account](adding-alibaba-cloud-account.md) to redeploy the Terraform script to the preferred region.
