...
5.  Select the **Custom Correlated Intelligence** check box to enable anomaly detection by [custom correlation rules that you have created](managing-correlation-rules.md) for your environment.
