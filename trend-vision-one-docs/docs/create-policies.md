...
:::tip
You can automate policy creation and configuration using the Server & Workload Protection API. For examples, see [Create and Configure Policies](create-configure-policy.md).
:::
...
2.  Enter a name for the policy. If you want the new policy to inherit its settings from an existing policy, select a policy from the *Inherit from* list and click *Next*.
    ...
    :::tip
    For information on inheritance, see [Policies, inheritance, and overrides](policies-inheritance-overrides.md).
    :::
...
To create a new policy based on the [recommendation scan](recommendation-scans-intro.md) of a computer:
...
- Overview (the [Overview section of the policy editor](overview-section-policy-editor.md) and [Overview section of the computer editor](overview-section-computer-editor.md) are different)

- [Anti-Malware](configure-malware-scans.md)

- [Web Reputation](configure-web-reputation.md)

- [Device Control](configure-device-control.md)

- [Firewall](firewall-settings.md)

- [Intrusion Prevention](config-intrusion-prevention-rules.md)

- [Integrity Monitoring](create-integrity-monitoring-rule.md)

- [Log Inspection](set-up-log-inspection.md)

- [Application Control](set-up-application-control.md)

- [Interface Types](detect-configure-interfaces.md)

- [Settings](network-engine-settings.md)

- [Overrides](policies-inheritance-overrides.md)
...
For more information on how child policies in a hierarchy tree can inherit or override the settings and rules of parent policies, see [Policies, inheritance, and overrides](policies-inheritance-overrides.md).

After assigning a policy to a computer, you should still run periodic recommendation scans on your computer to make sure that all vulnerabilities on the computer are protected. See [Manage and run recommendation scans](classic-reco-scan.md) for more information.
