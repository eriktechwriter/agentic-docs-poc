...
4.  Configure the allow list settings on your provider's console.
    ...
    - [Trend Micro Email Security](setup-email-security-allow-list.md)

    - [Microsoft Defender for Office 365](setup-365-defender-allow-list.md)

    - [Google Workspace](setup-google-workspace-allow-list.md)
...
- [Set up a Microsoft Defender allow list](setup-365-defender-allow-list.md "Configure the allow list settings for Microsoft Defender to ensure the delivery of Security Awareness Training training campaign invitations and reminders, and simulated phishing emails to employees in your organization.")
