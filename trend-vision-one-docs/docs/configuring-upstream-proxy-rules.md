...
:::warning[Important]
- To use the proxy settings of your Service Gateway for user web activity traffic, you must configure a proxy server for your Service Gateway virtual appliance via [Service Gateway CLI commands](service-gateway-cli-commands.md).
