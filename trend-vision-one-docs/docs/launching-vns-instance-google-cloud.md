...
13. Configure the **Machine Type**.
    ...
    The follow steps detail the configuration Trend Micro recommends. If you wish to use an alternative setup, review the [system requirements](network-sensor-sys-reqs.md) to ensure adequate system performance.
    ...
    3.  Select the **Machine type**.
        ...
        The Virtual Network Sensor has been tested with the following recommended instance types. For more information, see [Virtual Network Sensor system requirements](network-sensor-sys-reqs.md).
...
17. Click **Deploy**.
    ...
    After deployment successfully finishes, you must set up traffic mirroring in your Google Cloud environment. You can use your own mirroring solution, or, to follow the steps recommended by Trend Micro, see [Configure traffic mirroring on Google Cloud](traffic-mirroring-google-cloud.md).
