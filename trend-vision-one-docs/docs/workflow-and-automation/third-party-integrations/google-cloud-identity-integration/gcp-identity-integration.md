...
1.  Open the **Google Cloud Identity** screen from **Workflow and Automation → Third-Party Integrations** or from a Trend Vision One app that requires Google Cloud Identity permissions.

2.  Locate the permissions required by the desired associated app.

    :::note
    - For more on associated apps requiring Google Cloud Identity data access, see [Google Cloud Identity data usage in associated apps](./gcp-id-usage-associated-apps).
