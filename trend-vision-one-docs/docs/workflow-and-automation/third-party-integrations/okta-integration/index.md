...
The **Okta** screen (**Workflow and Automation → Third-Party Integrations**) provides an overview of all your [configured Okta tenants](./configuring-okta-tenants) and the data each tenant shares with Trend Vision One.
...
- [Configuring Okta tenants](./configuring-okta-tenants "Set up data sharing from Okta for risk assessments and remediation actions.")
- [Obtaining your Okta URL domain and API token](./okta-url-api-token)
