...
:::warning[Important]
- Before you begin, you must have at least one [Service Gateway virtual appliance](../../../service-gateway-management) deployed and configured.

- To integrate AWS Managed Microsoft AD, you must have at least one [Service Gateway virtual appliance deployed to AWS](../../../service-gateway-management/getting-started-with-service-gateway/deployment-guides/deploy-service-gateway-aws).

- Ensure you configure the Active Directory server connection using an [Active Directory account with sufficient permissions](./active-directory-permissions).
:::

### Procedure {#procedure}

1.  Go to **Workflow and Automation → Third-Party Integrations → Active Directory (on-premises)**.
...
- [Active Directory permissions](./active-directory-permissions "Grant sufficient permissions in Active Directory to enable user access control in Trend Vision One.")
