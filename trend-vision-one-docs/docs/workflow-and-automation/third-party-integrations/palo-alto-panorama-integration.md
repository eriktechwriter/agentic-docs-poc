...
:::note
Integration requires configuring at least one [Service Gateway](../service-gateway-management/getting-started-with-service-gateway/deployment-guides) with the Suspicious Object Exchange Service.
