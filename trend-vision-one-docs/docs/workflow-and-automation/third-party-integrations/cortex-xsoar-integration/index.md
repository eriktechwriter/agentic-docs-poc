...
For more information, see [Creating a User Role for Cortex XSOAR Integration](./user-role-cortex-xsoar).
:::
...
4.  Go to **Workflow and Automation → Third-Party Integrations** and click **Cortex XSOAR**.
...
- [Creating a user role for Cortex XSOAR integration](./user-role-cortex-xsoar "Create a custom user role to generate Authentication keys and enable integration with the Trend Micro Vision One for Cortex XSOAR app.")
