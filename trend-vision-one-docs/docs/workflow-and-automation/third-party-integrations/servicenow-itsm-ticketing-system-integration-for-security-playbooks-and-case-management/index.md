...
sidebar_position: 1
title: ServiceNow ITSM ticketing system integration (for Security Playbooks and Case Management)
---
...
:::note
To learn how to manage Trend Vision One Workbench alerts in ServiceNow, see [ServiceNow ITSM integration (for Workbench)](../servicenow-itsm-integration).
:::

The following table outlines the available actions in the main screen of the **ServiceNow Ticketing System** integration (**Workflow and Automation → Third-Party Integrations → Trend Vision One for ServiceNow Ticketing System**).
...
- [Configure ServiceNow ITSM to enable Trend Vision One for ServiceNow ticketing system](./config-case-management-ticket "Configure ticket profiles to use when synchronizing tickets between ServiceNow ITSM and Trend Vision One apps.")
