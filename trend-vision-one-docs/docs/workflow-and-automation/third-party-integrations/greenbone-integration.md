...
For more information, see [Service Gateway Management](../service-gateway-management).
...
2.  In Trend Vision One, go to **Workflow and Automation → Third-Party Integrations**.

3.  In the **Integration** column, click **Greenbone**.

    The **Greenbone** integration screen appears.

4.  If no Service Gateway is available, click the **Service Gateway Management** link to [deploy a Service Gateway](../service-gateway-management/getting-started-with-service-gateway/deployment-guides) or enable the Greenbone Connector service on an existing Service Gateway.
