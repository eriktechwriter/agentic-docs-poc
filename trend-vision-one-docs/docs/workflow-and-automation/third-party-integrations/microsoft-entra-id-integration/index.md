...
The **Microsoft Entra ID** screen (**Workflow and Automation → Third-Party Integrations**) provides [an overview of permissions](./access-permissions-data) that Trend Vision One apps require to access Microsoft Entra ID data or trigger policy enforcement actions in Microsoft Entra ID. Each app or group of apps is associated with a set of permissions that must be enabled within Microsoft Entra ID to facilitate integration with Trend Vision One.
...
<td><p>The <strong>Third-Party Integrations</strong> app regularly synchronizes permission-related data in all tenants from your Microsoft Entra ID.</p>
...
- [Overview of access permissions to Microsoft Entra ID data](./access-permissions-data "View a list of permissions that must be enabled within Microsoft Entra ID to facilitate integration with Trend Vision One.")
- [Microsoft Entra ID data usage in associated apps](./data-usage-associated-apps "Understand how Microsoft Entra ID data is used in associated apps after you grant access permissions.")
- [Configure Microsoft Entra ID integration](./configuring-integration "Grant Trend Micro permission to access your Microsoft Entra ID data in one or multiple tenants for use in Trend Vision One apps.")
- [Migrate from Azure AD Graph APIs to Microsoft Graph APIs](./updating-permissions "Migrate from Azure AD Graph APIs to Microsoft Graph APIs by updating permissions granted to an app or group of apps.")
- [Block Microsoft Entra ID permissions](./blocking-permissions "Disconnect Microsoft Entra ID from Trend Vision One apps by blocking permissions granted to an app or group of apps.")
- [Assign the Password Administrator role](./assigning-password-admin-role "Assign the Password Administrator role on the Microsoft Azure portal to Trend Vision One.")
- [Assign the Global Reader role](./assign-global-reader-role "Assign the Global Reader role on the Microsoft Azure portal to Trend Vision One.")
- [Troubleshoot Microsoft Entra ID connections](./troubleshooting-connections "Resolve Microsoft Entra ID connection problems related to error messages displayed in the Microsoft Entra ID screen.")
