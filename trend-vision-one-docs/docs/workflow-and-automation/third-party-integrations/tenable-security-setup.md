...
2.  Configure a Service Gateway with the Tenable Security Center Connector service.
    ...
    - To install and use a new Service Gateway:
      ...
      6.  Install the Service Gateway virtual appliance.
          ...
          1.  [Deploy a Service Gateway virtual appliance with VMware ESXi](../service-gateway-management/getting-started-with-service-gateway/deployment-guides/sg-virtual-app-vmware-esxi)

          2.  [Deploy a Service Gateway virtual appliance with Microsoft Hyper-V](../service-gateway-management/getting-started-with-service-gateway/deployment-guides/deploy-virtual-appliance-ms-hyper-v)
