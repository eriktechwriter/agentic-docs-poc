...
2.  Add the appropriate Trend Vision One [regional IP addresses](../../cyber-risk-exposure-management/continuous-risk-management/threat-and-exposure-management/configure-cyber-risk-exposure-management-data-sources/asrm-regional-ip-addresses) to the list of trusted IP addresses in the Rescana console.
...
6.  In the Trend Vision One console, access the Rescana data source settings through one of the following methods:
    ...
    - Go to **Workflow and Automation → Third-Party Integrations** and click **Rescana**.
