...
For more information on granting permissions and connecting tenants, see [Configure Salesforce tenants](./salesforce-tennants).

**Related information**

- [Configure Salesforce tenants](./salesforce-tennants "Connect Salesforce tenants to share Salesforce metadata and information on system misconfigurations with Trend Vision One.")
