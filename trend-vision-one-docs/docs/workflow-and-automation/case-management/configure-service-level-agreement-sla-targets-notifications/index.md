...
4.  Define the SLA targets.
    ...
    5.  To change the TTR calculation for **Workbench** cases, click **Change calculation** and select from the options then click **Save**. This change affects all cases and corresponding [widget](../../../dashboards-and-reports/dashboards/customizing-security-dashboard) data.
...
5.  Set reminders for specified recipients at designated times. These notifications can arrive via automatic emails, case log entries, and [webhooks](../../../administration/notifications/managing-webhooks).
...
- [Customize TTR/TTI calculation](./customize-ttr-calculation)
