...
Ensure you [configured ServiceNow ITSM to enable Trend Vision One for ServiceNow Ticketing System](../../../third-party-integrations/servicenow-itsm-ticketing-system-integration-for-security-playbooks-and-case-management/config-case-management-ticket).
...
:::note
- [You must install the Trend Vision One connector](../../../third-party-integrations/servicenow-itsm-ticketing-system-integration-for-security-playbooks-and-case-management/config-case-management-ticket) in your ServiceNow console to use third-party ticketing.
...
5.  On the **General** tab of **Ticket Profile Settings**, configure general ticket profile settings as shown in the following table.
    ...
    <ul>
    <li><p>Cyber Risk Exposure Management case</p></li>
    ...
    <ul>
    <li><p>Cyber Risk Exposure Management cases: Incident or Problem</p></li>
    <li><p>Workbench cases: Case or Incident</p></li>
    <li><p>MDR cases: Incident only</p></li>
    </ul>
...
7.  On the **Advanced** tab, you can configure advanced ticket profile settings.
    ...
    For the description of each field in the advanced settings, see the [ServiceNow documentation](https://www.servicenow.com/docs/).
