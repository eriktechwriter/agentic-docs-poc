...
:::warning[Important]
The Remove from Zscaler Restricted User Group response action becomes available after you have configured [Zscaler Internet Access integration](../../third-party-integrations/Zscaler-internet-access) or [Zscaler Private Access integration](../../third-party-integrations/zscaler-private-access) in **Third-Party Integrations**, and after you have added a user account to a ZScaler restricted user group.
