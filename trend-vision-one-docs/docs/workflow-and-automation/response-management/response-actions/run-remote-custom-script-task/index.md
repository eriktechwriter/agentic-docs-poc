...
- The script file must not include interactive functions. Because scripts run in silent mode, interactive functions will cause scripts to time out.
  ...
  For an example of a signed script, see [Sample signed PowerShell script](./sample-signed-powershell-script).
...
- [Sample signed PowerShell script](./sample-signed-powershell-script "Refer to the following sample signed PowerShell script for the Run Remote Custom Script response action.")
