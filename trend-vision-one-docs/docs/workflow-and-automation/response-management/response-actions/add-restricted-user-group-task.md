...
This task can be triggered manually using the context menu in **Attack Surface Discovery** or automatically by [creating Automated High-Risk Account Response playbooks](../../security-playbooks/user-defined-playbooks/auto-high-risk-account-response).
...
:::warning[Important]
The response action is available only after you have configured [Zscaler Internet Access integration](../../third-party-integrations/Zscaler-internet-access) or [Zscaler Private Access integration](../../third-party-integrations/zscaler-private-access) in **Third-Party Integrations**.
:::
