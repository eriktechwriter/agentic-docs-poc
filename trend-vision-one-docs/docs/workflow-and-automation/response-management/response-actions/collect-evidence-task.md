...
After [creating a workspace and adding endpoints to the workspace](../../../agentic-siem-xdr/forensics/war-room/workspaces) in **Forensics**, you can collect detailed evidence from potentially compromised endpoints for internal investigations into critical incidents that occurred on your network and may require further attention.
...
3.  Collect evidence from the desired endpoints.
    ...
    3.  Specify the [evidence types](../../../agentic-siem-xdr/forensics/evidence-archive/evidence-collection/supported-evidence-types/windows-evidence-types) you want to collect.
