...
In the **Actions** section of the [Execution details](.) screen, clicking **Check details** in a listed node opens the **Action Details** screen, which tallies and lists the status of the action for each target of the selected node.
