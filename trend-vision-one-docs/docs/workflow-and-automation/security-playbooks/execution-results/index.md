...
<tr>
<td><p>Export execution results</p></td>
<td><p>Export playbook execution results based on the current filters.</p>
<p>A maximum of 100,000 records can be exported.</p></td>
</tr>
<tr>
...
- [Execution details](./execution-details "View the details of a playbook execution.")
