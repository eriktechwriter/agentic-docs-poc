...
:::warning[Important]
To create Automated High-Risk Account Response playbooks, ensure the Attack Surface Risk Management entitlement is enabled. Additionally, complete [Zscaler Internet Access integration](../../third-party-integrations/Zscaler-internet-access) or [Zscaler Private Access integration](../../third-party-integrations/zscaler-private-access) in **Third-Party Integrations**, or configure one of the following required data sources:
...
5.  On the **Target Settings** panel, select and configure the **Target** for the playbook and click **Apply**.
    ...
    :::warning[Important]
    To enable **Security Playbooks** to respond to accounts with high risk scores, configure [Zscaler Internet Access integration](../../third-party-integrations/Zscaler-internet-access) in **Third-Party Integrations** or grant permission to access your Microsoft Entra ID data and Active Directory data in **Cyber Risk Overview → Data sources**.
    :::
...
7.  Configure actions by adding an **Action** node.
    ...
    2.  On the **Action Settings** panel, select **Generate CSV file** or a "RESPONSE" action from the **Action** drop-down list.
        ...
        To configure the following action, you must configure [Zscaler Internet Access integration](../../third-party-integrations/Zscaler-internet-access) or [Zscaler Private Access integration](../../third-party-integrations/zscaler-private-access) in **Third-Party Integrations**.
