...
Firewall requirements for Service Gateway virtual appliance outbound traffic differ depending on your Trend Vision One environment. Refer to [Firewall exception requirements for Trend Vision One](../../../../getting-started/getting-started-with-trend-vision-one/firewall-exception-requirements-for-trend-vision-one) to ensure you configure the correct "Allow" rules.

:::note
Port 443 (HTTPS) is the only outbound port required for the Service Gateway exceptions listed in [Firewall exception requirements for Trend Vision One](../../../../getting-started/getting-started-with-trend-vision-one/firewall-exception-requirements-for-trend-vision-one).
:::
