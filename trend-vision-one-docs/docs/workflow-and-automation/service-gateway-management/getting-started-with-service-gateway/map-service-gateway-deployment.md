...
The following maps provide an overview of several typical Service Gateway appliance deployment scenarios. Use these maps to help guide your deployment plans to best meet the needs of your network. View the [Deployment guides](./deployment-guides) when you are ready to set up your Service Gateway appliance.
...
- **Scenario 1:** AWS cloud deployment
  ...
  For more information on AWS deployment, see [Deploy a Service Gateway virtual appliance with AWS](./deployment-guides/deploy-service-gateway-aws).
...
- **Scenario 2:** Azure cloud deployment
  ...
  For more information on Azure deployment, see [Deploy a Service Gateway virtual appliance with Microsoft Azure](./deployment-guides/service-gateway-azure).
...
- **Scenario 3:** Google Cloud Platform (GCP) deployment
  ...
  For more information on GCP deployment, see [Deploy a Service Gateway virtual appliance with GCP](./deployment-guides/sg-virtual-app-gcp).
