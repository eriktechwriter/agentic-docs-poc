...
8.  In the **Instance Type** section, select an instance that meets the specifications for your deployment.
    ...
    For more information, see [Service Gateway appliance system requirements](../service-gateway-appliance-system-requirements).
    :::
