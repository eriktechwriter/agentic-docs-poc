...
For customers using the previous Service Gateway 1.0 version, check the [Service Gateway 1.0 CLI commands](./service-gateway-1-0-cli-commands).
...
- [Service Gateway 1.0 CLI commands](./service-gateway-1-0-cli-commands "A list of available CLI commands for managing the Service Gateway 1.0 virtual appliance.")
