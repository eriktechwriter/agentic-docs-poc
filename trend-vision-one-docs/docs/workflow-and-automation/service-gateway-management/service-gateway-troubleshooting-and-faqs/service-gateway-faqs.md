...
## How many network interface cards (NICs) can a Service Gateway appliance support? {#how-many-network-interface-cards-nics-can-a-service-gateway-appliance-support}

Each Service Gateway appliance supports up to two NICs, enabling flexible network segmentation and traffic routing.
...
Service Gateway provides HTTP and HTTPS ports for integration with other on-premises products. For more information, see [Service Gateway virtual appliance communication ports](../getting-started-with-service-gateway/service-gateway-appliance-system-requirements/sg-ports-used)

## What deployment options does Service Gateway support? {#what-deployment-options-does-service-gateway-support}

Service Gateway supports installation on a range of different network virtualization platforms. For virtual machine deployments with a hypervisor, Service Gateway supports [VMware ESXi](../getting-started-with-service-gateway/deployment-guides/sg-virtual-app-vmware-esxi) and [Microsoft Hyper-V](../getting-started-with-service-gateway/deployment-guides/deploy-virtual-appliance-ms-hyper-v).

Service Gateway supports cloud deployments with [Amazon Web Services](../getting-started-with-service-gateway/deployment-guides/deploy-service-gateway-aws) and [Microsoft Azure](../getting-started-with-service-gateway/deployment-guides/service-gateway-azure).
