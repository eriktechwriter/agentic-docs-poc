...
1.  Deploy a new Service Gateway 3.0 appliance to replace your existing 1.0 appliance.
    ...
    3.  Deploy the appliance.
        ...
        - [Deploy a Service Gateway virtual appliance with VMware ESXi](../../getting-started-with-service-gateway/deployment-guides/sg-virtual-app-vmware-esxi)

        - [Deploy a Service Gateway virtual appliance with Microsoft Hyper-V](../../getting-started-with-service-gateway/deployment-guides/deploy-virtual-appliance-ms-hyper-v)

        - [Deploy a Service Gateway virtual appliance with Microsoft Azure](../../getting-started-with-service-gateway/deployment-guides/service-gateway-azure)

        - [Deploy a Service Gateway virtual appliance with AWS](../../getting-started-with-service-gateway/deployment-guides/deploy-service-gateway-aws)
