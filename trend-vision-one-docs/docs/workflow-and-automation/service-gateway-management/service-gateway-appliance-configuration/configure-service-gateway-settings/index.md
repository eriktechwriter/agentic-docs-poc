...
- [Cloud service extension](./cloud-service-extension "Reduce your firewall requirements and filter Trend Vision One traffic with the cloud service extension for Service Gateway.")
- [SNMP trap messages defined for Service Gateway](./snmp-defined-trap-messages "View a list of trap messages defined for Service Gateway.")
