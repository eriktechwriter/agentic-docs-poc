...
If you want to create a role, see [Control Access Using Roles](control-access-using-roles.md).

Use the following general steps to search for a role and obtain the ID. For more information about searching, see [Search for Resources](search-for-resources.md).
