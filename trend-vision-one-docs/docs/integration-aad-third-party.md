...
The **Microsoft Entra ID** screen (**Workflow and Automation → Third-Party Integrations**) provides [an overview of permissions](access-permissions-data.md) that Trend Vision One apps require to access Microsoft Entra ID data or trigger policy enforcement actions in Microsoft Entra ID. Each app or group of apps is associated with a set of permissions that must be enabled within Microsoft Entra ID to facilitate integration with Trend Vision One.
