...
:::warning[Important]
- Policies, Threat Prevention, and the Intrusion Prevention module are "Pre-release" features and are not considered an official release. Please review the [Pre-Release Disclaimer](pre-release-disclaimer.md) before using the feature.
...
- Intrusion Prevention uses IP lists for configuring IP address exclusions. Configure [IP lists](resources-ip-lists.md) in policy resources before configuring Intrusion Prevention.
...
5.  To exclude trusted IP addresses from Intrusion Prevention scans and monitoring, select an IP list for **IP address exclusions**.
    ...
    You can create and configure IP lists in Policy Resources. For more information, see [IP lists](resources-ip-lists.md).
