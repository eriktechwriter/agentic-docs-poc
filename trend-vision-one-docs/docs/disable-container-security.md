...
Disabling Container Security on Kubernetes and Amazon ECS clusters is a straightforward task. For Kubernetes clusters, you can also [uninstall the Helm chart](removing-kubernetes-helm-chart.md) to remove Container Security. For Amazon ECS clusters, there are other methods available if you want to [remove protection at the account level](remove-container-aws-account.md).
...
- [Removing Container Security by uninstalling the Kubernetes Helm chart](removing-kubernetes-helm-chart.md)
