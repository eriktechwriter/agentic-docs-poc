...
For an overview of the Device Control module, see [Device Control](configure-device-control.md).
...
4.  Deactivate and uninstall the agent before reinstalling and re-activating it. See [Uninstall Server & Workload Protection from endpoints](uninstall-swp-agent.md) and [Activate the agent](activate-agent.md) for more information.
