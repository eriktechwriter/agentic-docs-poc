...
- [Configure a Network Resource profile](configuring-resource-profile.md "Create profiles to apply different sets of Network Resource lists to your Network Sensors.")
