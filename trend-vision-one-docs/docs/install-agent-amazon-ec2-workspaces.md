...
To update your AWS accounts, see [Update a legacy AWS connection](updating-legacy-aws-connection.md).
...
- launch new Amazon EC2 instances and Amazon WorkSpaces with the agent 'baked in', see [Bake the agent into your AMI or WorkSpace bundle](install-agent-ami-workspace.md).
- protect Amazon WorkSpaces after already protecting your Amazon EC2 instances, see instead [Protect Amazon WorkSpaces if you already added your AWS account](add-amazon-workspaces.md).
...
6.  If you selected *Allow Agent-Initiated Activation*, also select *Reactivate cloned Agents*, and *Enable Reactivate unknown Agents*. See [Agent settings](agent-settings.md) for more information.
...
- *Option 1: Use a deployment script to install, activate, and assign a policy*
  ...
  With this option, you must run a deployment script on the Amazon EC2 instances or Amazon WorkSpaces. The script installs and activates the agent and then assigns a policy. See [Use deployment scripts to add and protect computers](deployment-scripts-add-computers.md) for details.
...
- *Option 2: Manually install and activate*
  ...
  a\. Get the agent software, copy it to the Amazon EC2 instance or Amazon WorkSpace, and then install it. For details, see [Get the agent software](get-agent-software.md), and [Manually install the agent](install-agent.md).

  b\. Activate the agent. You can do so on the agent (if agent-initiated activation was enabled) or in Server & Workload Protection. For details, see [Activate the agent.](activate-agent.md)
...
To assign a policy, see [Assign a policy to a computer](create-policies.md).
