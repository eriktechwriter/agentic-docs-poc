...
The default period for these apps is 30 days of data retention for **XDR Data Explorer** and [Observed Attack Techniques](observed-attack-techniques.md). You can extend the retention period to 90 days, 180 days, or one year with the purchase of the applicable license.
...
- [Mobile Security](mobile-security.md) including detection and activity logs: 180 days

- [Email and Collaboration Security](get-start-email-collaboration.md) including detection and activity logs for both the [Email and Collaboration Sensor](email-sensor.md) and connected point products like [Cloud App Security](https://docs.trendmicro.com/en-us/documentation/article/cloud-app-security-online-help-introduction): 180 days

- [Zero Trust Secure Access](zero-trust-secure-access-overview.md) including detection and activity logs: 180 days

- [Container Security](container-security.md) including detection and activity logs: 30 days
