...
sidebar_position: 5
title: Configure Deep Discovery Inspector connections
---
...
6.  Click **Test Connection**.
    ...
    :::warning[Important]
    Network Inventory can only perform the connection test on Deep Discovery Inspector version 6.7 or later. You can confirm if the settings were applied successfully to earlier versions in the [Appliance Details](../../network-inventory/deep-discovery-inspector-appliances/appliance-details) screen.
    :::
