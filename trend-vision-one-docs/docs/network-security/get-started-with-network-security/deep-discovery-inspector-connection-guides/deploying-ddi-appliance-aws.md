...
sidebar_position: 4
title: Deploy a Deep Discovery Inspector virtual appliance on AWS
---
...
14. Connect the Deep Discovery Inspector appliance to Trend Vision One.
    ...
    - To connect directly, see [Connect a Deep Discovery Inspector appliance directly](./connecting-ddi-directly).

    - To connect using a Service Gateway as a proxy, see [Connect a Deep Discovery Inspector appliance using Service Gateway as a proxy](./ddi-connect-service-gateway).
...
15. Configure the Deep Discovery Inspector virtual appliance.
    ...
    - Review [sandbox options](./sandbox-options-for-connected-deep-discovery-inspector-appliances) for collecting and analyzing suspicious objects.

    - [Manage settings from Network Inventory](../../network-inventory/deep-discovery-inspector-appliances) such as enabling the Network Sensor and connecting to a Service Gateway.
