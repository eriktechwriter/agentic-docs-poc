...
15. In the Create VM dialog, configure the virtual machine.
    ...
    2.  For Compute Details, refer to [Virtual Network Sensor system requirements](../../../network-inventory/virtual-network-sensor/network-sensor-sys-reqs) to specify adequate throughput values.
    ...
    5.  For Network Adapters (NIC), click **Add New NIC** to specify your management port first.
        ...
        Your Virtual Network Sensor must be able to connect to Trend Vision One through the management port. To configure your firewall, see [Ports and firewall exceptions for Virtual Network Sensor](../../../network-inventory/virtual-network-sensor/ports-urls-used-network-sensor).
    ...
    8.  To adjust the sizes of the disks you added, right-click your Virtual Network Sensor and select **Update**.
        ...
        Click the pencil icon next to the disk you want to edit, adjust the size according to [Virtual Network Sensor system requirements](../../../network-inventory/virtual-network-sensor/network-sensor-sys-reqs), and click **Update**.
...
- [Configure traffic mirroring for Nutanix AHV](./config-mirroring-nutanix-ahv "Learn how to configure traffic mirroring for your own Virtual Network Sensor on Nutanix AHV.")
