...
6.  In the VMware ESXi console, [configure network settings](./exttraffic-vsphere-st-promiscuous) to allow Virtual Network Sensor to monitor data in VMware ESXi.
...
- [Configure External Network Traffic with the VMware vSphere Standard Switch (Promiscuous Mode)](./exttraffic-vsphere-st-promiscuous "Configure network settings in VMware ESXi to allow Virtual Network Sensor to monitor data.")
