...
- **Open vSwitch (SPAN)**
  ...
  To configure your network using this scenario, see [Configure internal network traffic with Open vSwitch (SPAN)](./internal-traffic-open-vswitch-span).
...
- **ERSPAN**
  ...
  To configure your network using this scenario, see [Configure external inter-VM traffic with ERSPAN (KVM host)](./inter-vm-traffic-erspan-kvm).
...
- **Open vSwitch (RSPAN)**
  ...
  To configure your network using this scenario, see [Configure external network traffic with Open vSwitch (RSPAN)](./external-traffic-open-vswitch-rspan).

  ![](/images/KVM_Ext_RSPAN=GUID-b95f9008-d6cf-4091-ba27-c3674fd98c94.webp)

- **Open vSwitch (SPAN)**

  To configure your network using this scenario, see [Configure external network traffic with Open vSwitch (SPAN)](./network-traffic-vswitch-span).
...
- **PCI passthrough with KVM host**
  ...
  To configure your network using this scenario, see [Configure external network traffic with PCI passthrough (KVM host)](./-pci-passthrough-kvm-host).
