...
- [Choose or create separate network security groups](./create-security-group-vns-oci) for the Virtual Network Sensor data port and management port.
...
4.  Create an instance from the imported image.
    ...
    8.  In the shape details, change the number of OCPUs and amount of memory based on the network throughput you plan to monitor. For details, see [Virtual Network Sensor system requirements](../../../network-inventory/virtual-network-sensor/network-sensor-sys-reqs).
