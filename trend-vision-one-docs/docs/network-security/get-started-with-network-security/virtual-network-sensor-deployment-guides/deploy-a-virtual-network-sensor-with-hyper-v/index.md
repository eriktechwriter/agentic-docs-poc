...
- [Hyper-V network settings](./hyper-v-network-settings "After successfully deploying your Virtual Network Sensor, configure your network based on your requirements.")
- [Configure internal network traffic on Hyper-V host](./internal-traffic-hyper-v-host "Configure internal network traffic to allow Virtual Network Sensor to monitor data.")
- [Configure external network traffic on Hyper-V host](./external-traffic-hyper-v-host "Configure external network traffic to allow Virtual Network Sensor to monitor data.")
- [Configure external inter-VM traffic with ERSPAN (Hyper-V host)](./vm-traffic-erspan-hyper-v "Configure network settings to allow Virtual Network Sensor to monitor data.")
- [Configure external network traffic with PCI passthrough (Hyper-V host)](./pci-passthrough-hyper-v "Configure external network traffic with a PCI passthrough to allow Virtual Network Sensor to monitor data.")
