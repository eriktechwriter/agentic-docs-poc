...
For a full list of all FQDNs and firewall exceptions for Trend Vision One, see [Firewall exception requirements for Trend Vision One](../../../getting-started/getting-started-with-trend-vision-one/firewall-exception-requirements-for-trend-vision-one).
