...
<p>For more information, see <a href="trend-vision-one-configuring-ddi-connections">Configure Deep Discovery Inspector connections</a>.</p></td>
</tr>
</tbody>
</table>

:::note
The **Network Inventory** screen and available actions may vary if you have connected your Deep Discovery Inspector appliances to **Network Inventory** using Deep Discovery Director. For more information, see [Network Inventory with Deep Discovery Director](../network-inventory-with-deep-discovery-director).
:::

**Related information**

- [Appliance Details](./appliance-details "Review information about your Deep Discovery Inspector appliance.")
- [Appliance Plans](./appliance-plans "Create and manage appliance plans to automate tasks such as hotfix and critical patch deployment.")
- [Virtual Analyzer Image Source](./virtual-analyzer-image-source "Configure and manage the SFTP source for your Virtual Analyzer images.")
- [Ports and URLs used by Deep Discovery Inspector](./ports-urls-used-ddi "Use these settings to configure your firewall and connected products.")
