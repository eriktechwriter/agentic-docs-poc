...
- To configure advanced scanning settings and define your network topography, see [Network Analysis Configuration](../network-analysis-configuration).

- To configure intrusion prevention settings including deploying virtual patches, see [Intrusion Prevention Configuration](../intrusion-prevention-configuration).
...
- [Credit allocation for Network Security](./credit-network-inventory "Learn how to calculate your credit requirements based on your Network Inventory configuration.")
- [Virtual Network Sensor](./virtual-network-sensor "Check the Virtual Network Sensor status, deploy the Virtual Network Sensor, and configure settings in Network Inventory.")
- [Deep Discovery Inspector appliances](./deep-discovery-inspector-appliances "Monitor and configure connected Deep Discovery Inspector appliances from Network Inventory.")
- [TippingPoint devices](./tippingpoint-devices "View your TippingPoint devices managed by a connected TippingPoint Security Management System (SMS) console and configure the Network Sensor function.")
- [Network Inventory with Deep Discovery Director](./network-inventory-with-deep-discovery-director "Manage Deep Discovery Inspector appliances using a connected Deep Discovery Director appliance.")
