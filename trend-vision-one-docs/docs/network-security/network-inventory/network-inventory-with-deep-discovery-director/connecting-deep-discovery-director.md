...
For more information about Trend Vision One credits, see [Annual credits](../../../administration/credits-billing/annual-credits).
:::
...
11. (Optional) Configure the network sensor settings with Deep Discovery Director.
    ...
    For more information, see [Configure Network Sensors with Deep Discovery Director](./configuring-network-sensors-ddd).
